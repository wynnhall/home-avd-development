...
| ------- | -------- | ---------- | ----- |
| - | SM-CORE_MISC_FABRIC HSMDMZ100A | All | Enabled |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet49 |  [L]_DMZ-Router1_Eth0 | trunk | 100 | - | - | - |
| Ethernet50 |  [L]_DMZ-Router2_Eth0 | trunk | 100 | - | - | - |
| Ethernet51 |  [L]_ISMPAN98_Eth13 | trunk | 100 | - | - | - |
| Ethernet52 |  [L]_ISMPAN99_Eth13 | trunk | 100 | - | - | - |
| Ethernet55 | [L]_MLAG_PEER_HSMDMZ101A_Ethernet55 | *trunk | *- | *- | *['MLAG'] | 4094 |
| Ethernet56 | [L]_MLAG_PEER_HSMDMZ101A_Ethernet56 | *trunk | *- | *- | *['MLAG'] | 4094 |
...
interface Ethernet49
   description [L]_DMZ-Router1_Eth0
   no shutdown
   speed 10g
...
interface Ethernet50
   description [L]_DMZ-Router2_Eth0
   no shutdown
   speed 10g
   switchport trunk allowed vlan 100
   switchport mode trunk
...
interface Ethernet55
   description [L]_MLAG_PEER_HSMDMZ101A_Ethernet55
   no shutdown
   speed 25g
   channel-group 4094 mode active
!
interface Ethernet56
   description [L]_MLAG_PEER_HSMDMZ101A_Ethernet56
   no shutdown
   speed 25g
   channel-group 4094 mode active
```
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel4094 | [L]_MLAG_PEER_HSMDMZ101A_Po4094 | switched | trunk | - | - | ['MLAG'] | - | - | - | - |
...
interface Port-Channel4094
   description [L]_MLAG_PEER_HSMDMZ101A_Po4094
   no shutdown
   switchport
   switchport mode trunk
