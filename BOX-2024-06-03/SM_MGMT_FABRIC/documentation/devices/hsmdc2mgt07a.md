...
| ------- | -------- | ---------- | ----- |
| - | SM_MGMT_FABRIC hsmdc2mgt07a | All | Enabled |

#### SNMP EngineID Configuration

| Type | EngineID (Hex) | IP | Port |
| ---- | -------------- | -- | ---- |
| local | b80266ee6b8f8ab59bb7214505c724c5fc809a0a | - | - |
...
| ---- | ----- | ------- | -------------- | ------- | -------------- | ----------- | --------- |
| SNMPManager | network-admin | v3 | sha | aes | - | - | b80266ee6b8f8ab59bb7214505c724c5fc809a0a |

#### SNMP Device Configuration

```eos
!
snmp-server engineID local b80266ee6b8f8ab59bb7214505c724c5fc809a0a
snmp-server location SM_MGMT_FABRIC hsmdc2mgt07a
...
snmp-server user SNMPManager network-admin v3 localized b80266ee6b8f8ab59bb7214505c724c5fc809a0a auth sha <removed> priv aes <removed>
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet49 | [L]_HSMDC2MGTAGG01A_Ethernet7 | *trunk | *300 | *- | *- | 49 |
| Ethernet50 | [L]_HSMDC2MGTAGG02A_Ethernet7 | *trunk | *300 | *- | *- | 49 |
...
interface Ethernet49
   description [L]_HSMDC2MGTAGG01A_Ethernet7
   no shutdown
   channel-group 49 mode active
!
interface Ethernet50
   description [L]_HSMDC2MGTAGG02A_Ethernet7
   no shutdown
   channel-group 49 mode active
!
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel49 | [L]_DC2_MGMT_AGG_LEAFS_Po7 | switched | trunk | 300 | - | - | - | - | - | - |
...
interface Port-Channel49
   description [L]_DC2_MGMT_AGG_LEAFS_Po7
   no shutdown
   switchport
...
| --------- | --- | ---------- | ------------------ | ------------------------- | ---- | ------ | ------- |
| vlan300 |  default  |  10.210.80.121/21  |  -  |  -  |  -  |  -  |  -  |
