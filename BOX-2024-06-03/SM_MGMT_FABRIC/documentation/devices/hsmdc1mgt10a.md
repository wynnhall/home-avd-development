...
| ------- | -------- | ---------- | ----- |
| - | SM_MGMT_FABRIC hsmdc1mgt10a | All | Enabled |

#### SNMP EngineID Configuration

| Type | EngineID (Hex) | IP | Port |
| ---- | -------------- | -- | ---- |
| local | 226260660beafe7f40fa457820f2173093955e53 | - | - |
...
| ---- | ----- | ------- | -------------- | ------- | -------------- | ----------- | --------- |
| SNMPManager | network-admin | v3 | sha | aes | - | - | 226260660beafe7f40fa457820f2173093955e53 |

#### SNMP Device Configuration

```eos
!
snmp-server engineID local 226260660beafe7f40fa457820f2173093955e53
snmp-server location SM_MGMT_FABRIC hsmdc1mgt10a
...
snmp-server user SNMPManager network-admin v3 localized 226260660beafe7f40fa457820f2173093955e53 auth sha <removed> priv aes <removed>
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet49 | [L]_HSMDC1MGTAGG01A_Ethernet10 | *trunk | *300 | *- | *- | 49 |
| Ethernet50 | [L]_HSMDC1MGTAGG02A_Ethernet10 | *trunk | *300 | *- | *- | 49 |
...
interface Ethernet49
   description [L]_HSMDC1MGTAGG01A_Ethernet10
   no shutdown
   channel-group 49 mode active
!
interface Ethernet50
   description [L]_HSMDC1MGTAGG02A_Ethernet10
   no shutdown
   channel-group 49 mode active
!
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel49 | [L]_DC1_MGMT_AGG_LEAFS_Po10 | switched | trunk | 300 | - | - | - | - | - | - |
...
interface Port-Channel49
   description [L]_DC1_MGMT_AGG_LEAFS_Po10
   no shutdown
   switchport
...
| --------- | --- | ---------- | ------------------ | ------------------------- | ---- | ------ | ------- |
| vlan300 |  default  |  10.210.80.112/21  |  -  |  -  |  -  |  -  |  -  |
