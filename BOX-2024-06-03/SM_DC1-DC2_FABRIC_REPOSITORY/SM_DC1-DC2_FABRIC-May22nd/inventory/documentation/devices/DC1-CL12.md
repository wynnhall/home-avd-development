...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | mgmt | 10.210.80.26/21 | 10.210.80.1 |
...
| ------- | -------- | ---------- | ----- |
| - | SM_DC1-DC2_FABRIC SM_DC1_FABRIC DC1-CL12 | All | Enabled |

#### SNMP EngineID Configuration

| Type | EngineID (Hex) | IP | Port |
| ---- | -------------- | -- | ---- |
| local | ae6bb7d46aa59f3cf4557973e468b2bccd1f25dd | - | - |
...
| ---- | ----- | ------- | -------------- | ------- | -------------- | ----------- | --------- |
| SNMPManager | network-admin | v3 | sha | aes | - | - | ae6bb7d46aa59f3cf4557973e468b2bccd1f25dd |

#### SNMP Device Configuration

```eos
!
snmp-server engineID local ae6bb7d46aa59f3cf4557973e468b2bccd1f25dd
snmp-server location SM_DC1-DC2_FABRIC SM_DC1_FABRIC DC1-CL12
...
snmp-server user SNMPManager network-admin v3 localized ae6bb7d46aa59f3cf4557973e468b2bccd1f25dd auth sha <removed> priv aes <removed>
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet55/1 | [L]_MLAG_PEER_DC1-CL11_Ethernet55/1 | *trunk | *- | *- | *['MLAG'] | 4094 |
| Ethernet56/1 | [L]_MLAG_PEER_DC1-CL11_Ethernet56/1 | *trunk | *- | *- | *['MLAG'] | 4094 |
...
| --------- | ----------- | ---- | --------------| ------------ | --- | --- | -------- | -------------- | -------------------| ----------- | ------------ |
| Ethernet49/1 | [L]_P2P_LINK_TO_ISMDC1SP01A_Ethernet14/1 | routed | - | - | default | 9214 | False | - | - | - | - |
| Ethernet50/1 | [L]_P2P_LINK_TO_ISMDC1SP02A_Ethernet14/1 | routed | - | - | default | 9214 | False | - | - | - | - |
| Ethernet51/1 | [L]_P2P_LINK_TO_ISMDC1SP03A_Ethernet14/1 | routed | - | - | default | 9214 | False | - | - | - | - |
...
interface Ethernet49/1
   description [L]_P2P_LINK_TO_ISMDC1SP01A_Ethernet14/1
   no shutdown
   mtu 9214
   no switchport
   ipv6 enable
...
interface Ethernet50/1
   description [L]_P2P_LINK_TO_ISMDC1SP02A_Ethernet14/1
   no shutdown
   mtu 9214
   no switchport
   ipv6 enable
...
interface Ethernet51/1
   description [L]_P2P_LINK_TO_ISMDC1SP03A_Ethernet14/1
   no shutdown
   mtu 9214
   no switchport
   ipv6 enable
...
interface Ethernet55/1
   description [L]_MLAG_PEER_DC1-CL11_Ethernet55/1
   no shutdown
   channel-group 4094 mode active
!
interface Ethernet56/1
   description [L]_MLAG_PEER_DC1-CL11_Ethernet56/1
   no shutdown
   channel-group 4094 mode active
```
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel4094 | [L]_MLAG_PEER_DC1-CL11_Po551 | switched | trunk | - | - | ['MLAG'] | - | - | - | - |
...
interface Port-Channel4094
   description [L]_MLAG_PEER_DC1-CL11_Po551
   no shutdown
   switchport
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | EVPN_Overlay_Peering | default | 172.21.0.15/32 |
| Loopback1 | VTEP_VXLAN_Tunnel_Source | default | 10.210.224.14/32 |
...
interface Loopback0
   ...
   no shutdown
   ip address 172.21.0.15/32
!
interface Loopback1
   description VTEP_VXLAN_Tunnel_Source
   no shutdown
   ip address 10.210.224.14/32
```
...
| ------------------ | --- | ---------- | --------- | ----------- |
| Ethernet49/1 | default | IPv4-UNDERLAY-PEERS | 65120:11100 | - |
| Ethernet50/1 | default | IPv4-UNDERLAY-PEERS | 65120:11100 | - |
| Ethernet51/1 | default | IPv4-UNDERLAY-PEERS | 65120:11100 | - |
| Vlan4093 | default | MLAG-IPv4-UNDERLAY-PEER | 65120.11206 | - |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 238 | 172.21.0.15:10238 | 10238:10238 | - | - | learned |
| 316 | 172.21.0.15:10316 | 10316:10316 | - | - | learned |
| 321 | 172.21.0.15:10321 | 10321:10321 | - | - | learned |
| 323 | 172.21.0.15:10323 | 10323:10323 | - | - | learned |
| 355 | 172.21.0.15:10355 | 10355:10355 | - | - | learned |
| 451 | 172.21.0.15:10451 | 10451:10451 | - | - | learned |
| 1010 | 172.21.0.15:11010 | 11010:11010 | - | - | learned |
| 1012 | 172.21.0.15:11012 | 11012:11012 | - | - | learned |
| 1013 | 172.21.0.15:11013 | 11013:11013 | - | - | learned |
| 1014 | 172.21.0.15:11014 | 11014:11014 | - | - | learned |
| 1015 | 172.21.0.15:11015 | 11015:11015 | - | - | learned |
| 1016 | 172.21.0.15:11016 | 11016:11016 | - | - | learned |
| 1017 | 172.21.0.15:11017 | 11017:11017 | - | - | learned |
| 1018 | 172.21.0.15:11018 | 11018:11018 | - | - | learned |
| 1019 | 172.21.0.15:11019 | 11019:11019 | - | - | learned |
| 1020 | 172.21.0.15:11020 | 11020:11020 | - | - | learned |
| 1021 | 172.21.0.15:11021 | 11021:11021 | - | - | learned |
| 1023 | 172.21.0.15:11023 | 11023:11023 | - | - | learned |

#### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute |
| --- | ------------------- | ------------ |
| IT-DC | 172.21.0.15:5002 | connected |
| OT | 172.21.0.15:5001 | connected |

#### Router BGP Device Configuration

```eos
!
router bgp 65120.11206
   router-id 172.21.0.15
   maximum-paths 128 ecmp 128
   update wait-install
   no bgp default ipv4-unicast
   bgp asn notation asdot
   ...
   neighbor MLAG-IPv4-UNDERLAY-PEER remote-as 65120.11206
   neighbor MLAG-IPv4-UNDERLAY-PEER next-hop-self
   neighbor MLAG-IPv4-UNDERLAY-PEER description DC1-CL11
   neighbor MLAG-IPv4-UNDERLAY-PEER send-community
   neighbor MLAG-IPv4-UNDERLAY-PEER maximum-routes 12000
   neighbor MLAG-IPv4-UNDERLAY-PEER route-map RM-MLAG-PEER-IN in
   neighbor interface Ethernet49/1 peer-group IPv4-UNDERLAY-PEERS remote-as 65120:11100
   neighbor interface Ethernet50/1 peer-group IPv4-UNDERLAY-PEERS remote-as 65120:11100
   neighbor interface Ethernet51/1 peer-group IPv4-UNDERLAY-PEERS remote-as 65120:11100
   neighbor interface Vlan4093 peer-group MLAG-IPv4-UNDERLAY-PEER remote-as 65120.11206
