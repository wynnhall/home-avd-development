...
| --------- | --------------- | ------------ | --------- |
| DC1_BL1_2 | Vlan4094 | 172.16.0.13 | Port-Channel3 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet3 | MLAG_PEER_DC1-BL2_Ethernet3 | *trunk | *- | *- | *['LEAF_PEER_L3', 'MLAG'] | 3 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_LINK_TO_DC1-SP1_Ethernet7 | routed | - | 192.168.1.25/31 | default | 1500 | False | - | - |
| Ethernet2 | P2P_LINK_TO_DC1-SP2_Ethernet7 | routed | - | 192.168.1.27/31 | default | 1500 | False | - | - |
| Ethernet4 | P2P_LINK_TO_DC2-BL1_Ethernet4 | routed | - | 192.168.3.0/31 | default | 1500 | False | - | - |
...
!
interface Ethernet3
   description MLAG_PEER_DC1-BL2_Ethernet3
   no shutdown
   speed 100g
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel3 | MLAG_PEER_DC1-BL2_Po3 | switched | trunk | - | - | ['LEAF_PEER_L3', 'MLAG'] | - | - | - | - |
...
interface Port-Channel3
   description MLAG_PEER_DC1-BL2_Po3
   no shutdown
   switchport
...
| Loopback100 | RED_VTEP_DIAGNOSTICS | RED | 10.100.100.7/32 |
| Loopback101 | BLUE_VTEP_DIAGNOSTICS | BLUE | 10.100.101.7/32 |
...
| Vlan4000 |  RED  |  172.16.1.12/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan4001 |  BLUE  |  172.16.1.12/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan4093 |  default  |  172.16.1.12/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan4094 |  default  |  172.16.0.12/31  |  -  |  -  |  -  |  -  |  -  |
...
| -------- | --------- | --- | -------- | -------------- | -------------- | ---------- | --- | --------------------- | ---------------------- | ------- |
| 172.16.1.13 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | default | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - |
| 192.168.1.24 | 65000.0 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
| 192.168.1.26 | 65000.0 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
| 192.168.3.1 | 65001.5 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
...
| 172.16.1.13 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | BLUE | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - |
| 172.16.1.13 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | RED | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 10 | 192.168.100.7:10010 | 10010:10010<br>remote 10010:10010 | - | - | learned |
| 20 | 192.168.100.7:10020 | 10020:10020<br>remote 10020:10020 | - | - | learned |
| 30 | 192.168.100.7:10030 | 10030:10030<br>remote 10030:10030 | - | - | learned |
| 40 | 192.168.100.7:10040 | 10040:10040<br>remote 10040:10040 | - | - | learned |

#### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute |
| --- | ------------------- | ------------ |
| BLUE | 192.168.100.7:1002 | connected |
| RED | 192.168.100.7:1001 | connected |
...
router bgp 65000.7
   ...
   neighbor 172.16.1.13 peer group MLAG-IPv4-UNDERLAY-PEER
   neighbor 172.16.1.13 description DC1-BL2
   neighbor 192.168.1.24 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.1.24 remote-as 65000.0
   neighbor 192.168.1.24 description DC1-SP1_Ethernet7
   neighbor 192.168.1.26 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.1.26 remote-as 65000.0
   neighbor 192.168.1.26 description DC1-SP2_Ethernet7
   neighbor 192.168.3.1 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.3.1 remote-as 65001.5
   neighbor 192.168.3.1 description DC2-BL1
   ...
   !
   vlan 10
      rd 192.168.100.7:10010
      rd evpn domain remote 192.168.100.7:10010
      route-target both 10010:10010
      route-target import export evpn domain remote 10010:10010
      redistribute learned
   !
   vlan 20
      rd 192.168.100.7:10020
      rd evpn domain remote 192.168.100.7:10020
      route-target both 10020:10020
      route-target import export evpn domain remote 10020:10020
      redistribute learned
   !
   vlan 30
      rd 192.168.100.7:10030
      rd evpn domain remote 192.168.100.7:10030
      route-target both 10030:10030
      route-target import export evpn domain remote 10030:10030
      redistribute learned
   !
   vlan 40
      rd 192.168.100.7:10040
      rd evpn domain remote 192.168.100.7:10040
...
```eos
!
ip address virtual source-nat vrf BLUE address 10.100.101.7
ip address virtual source-nat vrf RED address 10.100.100.7
```
