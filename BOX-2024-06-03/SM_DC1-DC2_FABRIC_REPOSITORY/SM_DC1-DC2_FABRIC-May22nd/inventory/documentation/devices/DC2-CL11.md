...
| ------- | -------- | ---------- | ----- |
| - | SM_DC1-DC2_FABRIC SM_DC2_FABRIC DC2-CL11 | All | Enabled |

#### SNMP EngineID Configuration

| Type | EngineID (Hex) | IP | Port |
| ---- | -------------- | -- | ---- |
| local | 201187f78f868eda3c7faf13d0fbb552ee98f02f | - | - |
...
| ---- | ----- | ------- | -------------- | ------- | -------------- | ----------- | --------- |
| SNMPManager | network-admin | v3 | sha | aes | - | - | 201187f78f868eda3c7faf13d0fbb552ee98f02f |

#### SNMP Device Configuration

```eos
!
snmp-server engineID local 201187f78f868eda3c7faf13d0fbb552ee98f02f
snmp-server location SM_DC1-DC2_FABRIC SM_DC2_FABRIC DC2-CL11
...
snmp-server user SNMPManager network-admin v3 localized 201187f78f868eda3c7faf13d0fbb552ee98f02f auth sha <removed> priv aes <removed>
...
| 1024 | 10.210.113.0/24_NSX-WL-Edge-Net2 | - |
...
!
vlan 1024
   name 10.210.113.0/24_NSX-WL-Edge-Net2
!
vlan 4093
   name LEAF_PEER_L3
   trunk group MLAG
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet55/1 | [L]_MLAG_PEER_DC2-CL12_Ethernet55/1 | *trunk | *- | *- | *['MLAG'] | 4094 |
| Ethernet56/1 | [L]_MLAG_PEER_DC2-CL12_Ethernet56/1 | *trunk | *- | *- | *['MLAG'] | 4094 |
...
interface Ethernet55/1
   description [L]_MLAG_PEER_DC2-CL12_Ethernet55/1
   no shutdown
   channel-group 4094 mode active
!
interface Ethernet56/1
   description [L]_MLAG_PEER_DC2-CL12_Ethernet56/1
   no shutdown
   channel-group 4094 mode active
```
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel4094 | [L]_MLAG_PEER_DC2-CL12_Po551 | switched | trunk | - | - | ['MLAG'] | - | - | - | - |
...
interface Port-Channel4094
   description [L]_MLAG_PEER_DC2-CL12_Po551
   no shutdown
   switchport
...
| Vlan1024 | 10.210.113.0/24_NSX-WL-Edge-Net2 | OT | - | False |
...
!
interface Vlan1024
   description 10.210.113.0/24_NSX-WL-Edge-Net2
   no shutdown
   vrf OT
...
| 316 | 172.21.1.14:10316 | 10316:10316 | - | - | learned |
...
router bgp 65120.12206
   ...
   neighbor MLAG-IPv4-UNDERLAY-PEER description DC2-CL12
