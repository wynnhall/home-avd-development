...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | mgmt | 10.210.80.39/21 | 10.210.80.1 |
...
| ------- | -------- | ---------- | ----- |
| - | SHERMAN_FABRIC SM-DC2_FABRIC ISMDC2BL02A | All | Enabled |

#### SNMP EngineID Configuration

| Type | EngineID (Hex) | IP | Port |
| ---- | -------------- | -- | ---- |
| local | 9ae7b743da027459218269549bebf8b388f3dee4 | - | - |
...
| ---- | ----- | ------- | -------------- | ------- | -------------- | ----------- | --------- |
| SNMPManager | network-admin | v3 | sha | aes | - | - | 9ae7b743da027459218269549bebf8b388f3dee4 |

#### SNMP Device Configuration

```eos
!
snmp-server engineID local 9ae7b743da027459218269549bebf8b388f3dee4
snmp-server location SHERMAN_FABRIC SM-DC2_FABRIC ISMDC2BL02A
...
snmp-server user SNMPManager network-admin v3 localized 9ae7b743da027459218269549bebf8b388f3dee4 auth sha <removed> priv aes <removed>
...
##### SPANSession-to-BL-FilterSwitch

####### SPANSession-to-BL-FilterSwitch Sources

| Sources | Direction | Access Group Type | Access Group Name | Access Group Priority |
| ------- | --------- | ----------------- | ----------------- | --------------------- |
| Ethernet1-48 | both | - | - | - |

####### SPANSession-to-BL-FilterSwitch Destinations and Session Settings

| Settings | Values |
| -------- | ------ |
| Destinations | Ethernet29/1 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet31/1 | [L]_MLAG_PEER_ISMDC2BL01A_Ethernet31/1 | *trunk | *- | *- | *['LEAF_PEER_L3', 'MLAG'] | 4094 |
| Ethernet32/1 | [L]_MLAG_PEER_ISMDC2BL01A_Ethernet32/1 | *trunk | *- | *- | *['LEAF_PEER_L3', 'MLAG'] | 4094 |
...
| --------- | ----------- | -----| ------- | -------------- |
| Ethernet1/1.510 | [L]_ISMCR01A-Eth4/2/1-IT-DC-VRF | l3dot1q | - | 510 |
| Ethernet1/1.533 | CORE1-Eth4/2/1-OT-VRF | l3dot1q | - | 533 |
| Ethernet2/1.510 | [L]_ISMCR02A-Eth4/2/1-IT-DC-VRF | l3dot1q | - | 510 |
| Ethernet2/1.533 | CORE2-Eth4/2/1-OT-VRF | l3dot1q | - | 533 |
| Ethernet5/1.533 | SM1-OT-BL1-Eth4/1-OT-VRF | l3dot1q | - | 533 |
| Ethernet6/1.533 | SM1-OT-BL2-Eth4/1-OT-VRF | l3dot1q | - | 533 |

##### IPv4

| Interface | Description | Type | Channel Group | IP Address | VRF |  MTU | Shutdown | ACL In | ACL Out |
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1/1.510 | [L]_ISMCR01A-Eth4/2/1-IT-DC-VRF | l3dot1q | - | 10.210.234.21/31 | IT-DC | - | False | - | - |
| Ethernet1/1.533 | CORE1-Eth4/2/1-OT-VRF | l3dot1q | - | 10.210.234.5/31 | OT | - | False | - | - |
| Ethernet2/1.510 | [L]_ISMCR02A-Eth4/2/1-IT-DC-VRF | l3dot1q | - | 10.210.234.23/31 | IT-DC | - | False | - | - |
| Ethernet2/1.533 | CORE2-Eth4/2/1-OT-VRF | l3dot1q | - | 10.210.234.7/31 | OT | - | False | - | - |
| Ethernet3/1 | P2P_LINK_TO_ISMDC1BL01A_Ethernet4/1 | routed | - | 10.210.226.11/31 | default | 9214 | False | - | - |
| Ethernet4/1 | P2P_LINK_TO_ISMDC1BL02A_Ethernet4/1 | routed | - | 10.210.226.15/31 | default | 9214 | False | - | - |
| Ethernet5/1.533 | SM1-OT-BL1-Eth4/1-OT-VRF | l3dot1q | - | 10.210.234.13/31 | OT | - | False | - | - |
| Ethernet6/1.533 | SM1-OT-BL2-Eth4/1-OT-VRF | l3dot1q | - | 10.210.234.15/31 | OT | - | False | - | - |

##### IPv6

| Interface | Description | Type | Channel Group | IPv6 Address | VRF | MTU | Shutdown | ND RA Disabled | Managed Config Flag | IPv6 ACL In | IPv6 ACL Out |
| --------- | ----------- | ---- | --------------| ------------ | --- | --- | -------- | -------------- | -------------------| ----------- | ------------ |
| Ethernet25/1 | [L]_P2P_LINK_TO_ISMDC2SP01A_Ethernet2/1 | routed | - | - | default | 9214 | False | - | - | - | - |
| Ethernet26/1 | [L]_P2P_LINK_TO_ISMDC2SP02A_Ethernet2/1 | routed | - | - | default | 9214 | False | - | - | - | - |
| Ethernet27/1 | [L]_P2P_LINK_TO_ISMDC2SP03A_Ethernet2/1 | routed | - | - | default | 9214 | False | - | - | - | - |
...
interface Ethernet1/1.510
   description [L]_ISMCR01A-Eth4/2/1-IT-DC-VRF
   no shutdown
   encapsulation dot1q vlan 510
   vrf IT-DC
   ip address 10.210.234.21/31
!
interface Ethernet1/1.533
   description CORE1-Eth4/2/1-OT-VRF
   no shutdown
   encapsulation dot1q vlan 533
   vrf OT
   ip address 10.210.234.5/31
!
...
interface Ethernet2/1.510
   description [L]_ISMCR02A-Eth4/2/1-IT-DC-VRF
   no shutdown
   encapsulation dot1q vlan 510
   vrf IT-DC
   ip address 10.210.234.23/31
!
interface Ethernet2/1.533
   description CORE2-Eth4/2/1-OT-VRF
   no shutdown
   encapsulation dot1q vlan 533
   vrf OT
   ip address 10.210.234.7/31
!
interface Ethernet3/1
   description P2P_LINK_TO_ISMDC1BL01A_Ethernet4/1
   no shutdown
   mtu 9214
   speed 100g
   no switchport
   ip address 10.210.226.11/31
!
interface Ethernet4/1
   description P2P_LINK_TO_ISMDC1BL02A_Ethernet4/1
   no shutdown
   mtu 9214
   speed 100g
   no switchport
   ip address 10.210.226.15/31
!
...
interface Ethernet5/1.533
   description SM1-OT-BL1-Eth4/1-OT-VRF
   no shutdown
   encapsulation dot1q vlan 533
   vrf OT
   ip address 10.210.234.13/31
!
...
interface Ethernet6/1.533
   description SM1-OT-BL2-Eth4/1-OT-VRF
   no shutdown
   encapsulation dot1q vlan 533
   vrf OT
   ip address 10.210.234.15/31
!
interface Ethernet25/1
   description [L]_P2P_LINK_TO_ISMDC2SP01A_Ethernet2/1
   no shutdown
   mtu 9214
   no switchport
   ipv6 enable
...
interface Ethernet26/1
   description [L]_P2P_LINK_TO_ISMDC2SP02A_Ethernet2/1
   no shutdown
   mtu 9214
   no switchport
   ipv6 enable
...
interface Ethernet27/1
   description [L]_P2P_LINK_TO_ISMDC2SP03A_Ethernet2/1
   no shutdown
   mtu 9214
   no switchport
   ipv6 enable
...
interface Ethernet31/1
   description [L]_MLAG_PEER_ISMDC2BL01A_Ethernet31/1
   no shutdown
   channel-group 4094 mode active
!
interface Ethernet32/1
   description [L]_MLAG_PEER_ISMDC2BL01A_Ethernet32/1
   no shutdown
   channel-group 4094 mode active
```
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel4094 | [L]_MLAG_PEER_ISMDC2BL01A_Po311 | switched | trunk | - | - | ['LEAF_PEER_L3', 'MLAG'] | - | - | - | - |
...
interface Port-Channel4094
   description [L]_MLAG_PEER_ISMDC2BL01A_Po311
   no shutdown
   switchport
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | EVPN_Overlay_Peering | default | 172.21.1.25/32 |
...
| -------- | --------- | --- | -------- | -------------- | -------------- | ---------- | --- | --------------------- | ---------------------- | ------- | ------------ |
| 172.21.0.24 | 65120.11200 | default | - | Inherited from peer group EVPN-OVERLAY-CORE | Inherited from peer group EVPN-OVERLAY-CORE | - | Inherited from peer group EVPN-OVERLAY-CORE | - | - | - | - |
| 172.21.0.25 | 65120.11200 | default | - | Inherited from peer group EVPN-OVERLAY-CORE | Inherited from peer group EVPN-OVERLAY-CORE | - | Inherited from peer group EVPN-OVERLAY-CORE | - | - | - | - |
...
| 10.210.234.20 | Inherited from peer group CORES-EBGP-PEERS-IT-DC-VRF | IT-DC | - | - | Inherited from peer group CORES-EBGP-PEERS-IT-DC-VRF | - | - | - | - | - |
| 10.210.234.22 | Inherited from peer group CORES-EBGP-PEERS-IT-DC-VRF | IT-DC | - | - | Inherited from peer group CORES-EBGP-PEERS-IT-DC-VRF | - | - | - | - | - |
| 10.210.234.4 | Inherited from peer group CORES-EBGP-PEERS-OTVRF | OT | - | - | Inherited from peer group CORES-EBGP-PEERS-OTVRF | - | - | - | - | - |
| 10.210.234.6 | Inherited from peer group CORES-EBGP-PEERS-OTVRF | OT | - | - | Inherited from peer group CORES-EBGP-PEERS-OTVRF | - | - | - | - | - |
| 10.210.234.13 | Inherited from peer group SM1-OT-BL-EBGP-PEERS-OTVRF | OT | - | - | Inherited from peer group SM1-OT-BL-EBGP-PEERS-OTVRF | - | - | - | - | - |
| 10.210.234.15 | Inherited from peer group SM1-OT-BL-EBGP-PEERS-OTVRF | OT | - | - | Inherited from peer group SM1-OT-BL-EBGP-PEERS-OTVRF | - | - | - | - | - |

#### BGP Neighbor Interfaces

| Neighbor Interface | VRF | Peer Group | Remote AS | Peer Filter |
| ------------------ | --- | ---------- | --------- | ----------- |
| Ethernet25/1 | default | IPv4-UNDERLAY-PEERS | 65120.12100 | - |
| Ethernet26/1 | default | IPv4-UNDERLAY-PEERS | 65120.12100 | - |
| Ethernet27/1 | default | IPv4-UNDERLAY-PEERS | 65120.12100 | - |
| Vlan4093 | default | MLAG-IPv4-UNDERLAY-PEER | 65120.12200 | - |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 238 | 172.21.1.25:10238 | 10238:10238<br>remote 10238:10238 | - | - | learned |
| 316 | 172.21.1.25:10316 | 10316:10316<br>remote 10316:10316 | - | - | learned |
| 323 | 172.21.1.25:10323 | 10323:10323<br>remote 10323:10323 | - | - | learned |
| 355 | 172.21.1.25:10355 | 10355:10355<br>remote 10355:10355 | - | - | learned |
| 451 | 172.21.1.25:10451 | 10451:10451<br>remote 10451:10451 | - | - | learned |
| 1012 | 172.21.1.25:11012 | 11012:11012<br>remote 11012:11012 | - | - | learned |
| 1013 | 172.21.1.25:11013 | 11013:11013<br>remote 11013:11013 | - | - | learned |
| 1014 | 172.21.1.25:11014 | 11014:11014<br>remote 11014:11014 | - | - | learned |
| 1015 | 172.21.1.25:11015 | 11015:11015<br>remote 11015:11015 | - | - | learned |
| 1016 | 172.21.1.25:11016 | 11016:11016<br>remote 11016:11016 | - | - | learned |
| 1017 | 172.21.1.25:11017 | 11017:11017<br>remote 11017:11017 | - | - | learned |
| 1018 | 172.21.1.25:11018 | 11018:11018<br>remote 11018:11018 | - | - | learned |
| 1019 | 172.21.1.25:11019 | 11019:11019<br>remote 11019:11019 | - | - | learned |
| 1020 | 172.21.1.25:11020 | 11020:11020<br>remote 11020:11020 | - | - | learned |
| 1021 | 172.21.1.25:11021 | 11021:11021<br>remote 11021:11021 | - | - | learned |
| 1022 | 172.21.1.25:11022 | 11022:11022<br>remote 11022:11022 | - | - | learned |

#### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute |
| --- | ------------------- | ------------ |
| IT-DC | 172.21.1.25:5002 | connected |
| OT | 172.21.1.25:5001 | connected |
...
router bgp 65120.12200
   ...
   neighbor CORES-EBGP-PEERS-IT-DC-VRF password 7 <removed>
   ...
   neighbor CORES-EBGP-PEERS-OTVRF password 7 <removed>
   ...
   neighbor MLAG-IPv4-UNDERLAY-PEER description ISMDC2BL01A
   ...
   neighbor SM1-OT-BL-EBGP-PEERS-OTVRF password 7 <removed>
   ...
   vrf IT-DC
      ...
      router-id 172.21.1.25
      update wait-install
      neighbor 10.210.234.20 peer group CORES-EBGP-PEERS-IT-DC-VRF
      neighbor 10.210.234.20 description ISMCR01A-Eth4/2/1-IT-DC-VRF
      neighbor 10.210.234.22 peer group CORES-EBGP-PEERS-IT-DC-VRF
      neighbor 10.210.234.22 description ISMCR02A-Eth4/2/1-IT-DC-VRF
   ...
   vrf OT
      ...
      router-id 172.21.1.25
      update wait-install
      neighbor 10.210.234.4 peer group CORES-EBGP-PEERS-OTVRF
      neighbor 10.210.234.4 description CORE1-Eth4/2/1-OT-VRF
      neighbor 10.210.234.6 peer group CORES-EBGP-PEERS-OTVRF
      neighbor 10.210.234.6 description CORE2-Eth4/2/1-OT-VRF
      neighbor 10.210.234.13 peer group SM1-OT-BL-EBGP-PEERS-OTVRF
      neighbor 10.210.234.13 description SM1-OT-BL1-Eth4/1-OT-VRF
      neighbor 10.210.234.15 peer group SM1-OT-BL-EBGP-PEERS-OTVRF
      neighbor 10.210.234.15 description SM1-OT-BL2-Eth4/1-OT-VRF
      redistribute connected
      !
      address-family ipv4
         neighbor 10.210.234.4 activate
         neighbor 10.210.234.6 activate
         neighbor 10.210.234.13 activate
         neighbor 10.210.234.15 activate
```
