...
| ------- | -------- | ---------- | ----- |
| - | SHERMAN_FABRIC SM-DC1_FABRIC ISMDC1BL01A | All | Enabled |

#### SNMP EngineID Configuration

| Type | EngineID (Hex) | IP | Port |
| ---- | -------------- | -- | ---- |
| local | e2569b5b017fd53fe227b520d77f52f2cf07c5bd | - | - |
...
| ---- | ----- | ------- | -------------- | ------- | -------------- | ----------- | --------- |
| SNMPManager | network-admin | v3 | sha | aes | - | - | e2569b5b017fd53fe227b520d77f52f2cf07c5bd |

#### SNMP Device Configuration

```eos
!
snmp-server engineID local e2569b5b017fd53fe227b520d77f52f2cf07c5bd
snmp-server location SHERMAN_FABRIC SM-DC1_FABRIC ISMDC1BL01A
...
snmp-server user SNMPManager network-admin v3 localized e2569b5b017fd53fe227b520d77f52f2cf07c5bd auth sha <removed> priv aes <removed>
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet31/1 | [L]_MLAG_PEER_ISMDC1BL02A_Ethernet31/1 | *trunk | *- | *- | *['LEAF_PEER_L3', 'MLAG'] | 4094 |
| Ethernet32/1 | [L]_MLAG_PEER_ISMDC1BL02A_Ethernet32/1 | *trunk | *- | *- | *['LEAF_PEER_L3', 'MLAG'] | 4094 |
...
| --------- | ----------- | -----| ------- | -------------- |
| Ethernet1/1.510 | [L]_ISMCR01A-Eth3/1/1-IT-DC-VRF | l3dot1q | - | 510 |
| Ethernet1/1.533 | [L]_ISMCR01A-Eth3/1/1-OT-VRF | l3dot1q | - | 533 |
| Ethernet2/1.510 | [L]_ISMCR02A-Eth3/1/1-IT-DC-VRF | l3dot1q | - | 510 |
| Ethernet2/1.533 | [L]_ISMCR02A-Eth3/1/1-OT-VRF | l3dot1q | - | 533 |
| Ethernet5/1.533 | [L]_ISMS1OTBL01A-Eth1/1-OT-VRF | l3dot1q | - | 533 |
| Ethernet6/1.533 | [L]_ISMS1OTBL02A-Eth1/1-OT-VRF | l3dot1q | - | 533 |

##### IPv4

| Interface | Description | Type | Channel Group | IP Address | VRF |  MTU | Shutdown | ACL In | ACL Out |
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1/1.510 | [L]_ISMCR01A-Eth3/1/1-IT-DC-VRF | l3dot1q | - | 10.210.226.25/31 | IT-DC | - | False | - | - |
| Ethernet1/1.533 | [L]_ISMCR01A-Eth3/1/1-OT-VRF | l3dot1q | - | 10.210.226.1/31 | OT | - | False | - | - |
| Ethernet2/1.510 | [L]_ISMCR02A-Eth3/1/1-IT-DC-VRF | l3dot1q | - | 10.210.226.27/31 | IT-DC | - | False | - | - |
| Ethernet2/1.533 | [L]_ISMCR02A-Eth3/1/1-OT-VRF | l3dot1q | - | 10.210.226.3/31 | OT | - | False | - | - |
...
| Ethernet5/1.533 | [L]_ISMS1OTBL01A-Eth1/1-OT-VRF | l3dot1q | - | 10.210.226.17/31 | OT | - | False | - | - |
| Ethernet6/1.533 | [L]_ISMS1OTBL02A-Eth1/1-OT-VRF | l3dot1q | - | 10.210.226.19/31 | OT | - | False | - | - |
...
interface Ethernet1/1.510
   description [L]_ISMCR01A-Eth3/1/1-IT-DC-VRF
   no shutdown
...
interface Ethernet1/1.533
   description [L]_ISMCR01A-Eth3/1/1-OT-VRF
   no shutdown
...
interface Ethernet2/1.510
   description [L]_ISMCR02A-Eth3/1/1-IT-DC-VRF
   no shutdown
   encapsulation dot1q vlan 510
   vrf IT-DC
...
interface Ethernet2/1.533
   description [L]_ISMCR02A-Eth3/1/1-OT-VRF
   no shutdown
   encapsulation dot1q vlan 533
   vrf OT
...
interface Ethernet5/1.533
   description [L]_ISMS1OTBL01A-Eth1/1-OT-VRF
   no shutdown
   encapsulation dot1q vlan 533
   vrf OT
...
interface Ethernet6/1.533
   description [L]_ISMS1OTBL02A-Eth1/1-OT-VRF
   no shutdown
   encapsulation dot1q vlan 533
   vrf OT
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel4094 | [L]_MLAG_PEER_ISMDC1BL02A_Po311 | switched | trunk | - | - | ['LEAF_PEER_L3', 'MLAG'] | - | - | - | - |
...
| 10.210.226.24 | Inherited from peer group CORES-EBGP-PEERS-IT-DC-VRF | IT-DC | - | - | Inherited from peer group CORES-EBGP-PEERS-IT-DC-VRF | - | - | - | - | - |
| 10.210.226.26 | Inherited from peer group CORES-EBGP-PEERS-IT-DC-VRF | IT-DC | - | - | Inherited from peer group CORES-EBGP-PEERS-IT-DC-VRF | - | - | - | - | - |
...
| 1022 | 172.21.0.24:11022 | 11022:11022<br>remote 11022:11022 | - | - | learned |
...
router bgp 65120.11200
   ...
   neighbor S1-OT-BL-EBGP-PEERS-OTVRF password 7 <removed>
   ...
   !
   vlan 1022
      rd 172.21.0.24:11022
      rd evpn domain remote 172.21.0.24:11022
   ...
   vrf IT-DC
      ...
      router-id 172.21.0.24
      update wait-install
      neighbor 10.210.226.24 peer group CORES-EBGP-PEERS-IT-DC-VRF
      neighbor 10.210.226.24 description ISMCR01A-Eth3/1/1-IT-DC-VRF
      neighbor 10.210.226.26 peer group CORES-EBGP-PEERS-IT-DC-VRF
      neighbor 10.210.226.26 description ISMCR02A-Eth3/1/1-IT-DC-VRF
   ...
   vrf OT
      ...
      neighbor 10.210.226.0 description ISMCR01A-Eth3/1/1-OT-VRF
      neighbor 10.210.226.2 peer group CORES-EBGP-PEERS-OTVRF
      neighbor 10.210.226.2 description ISMCR02A-Eth3/1/1-OT-VRF
      neighbor 10.210.226.16 peer group S1-OT-BL-EBGP-PEERS-OTVRF
      neighbor 10.210.226.16 description ISMS1OTBL01A-Eth1/1-OT-VRF
      neighbor 10.210.226.18 peer group S1-OT-BL-EBGP-PEERS-OTVRF
      neighbor 10.210.226.18 description ISMS1OTBL02A-Eth1/1-OT-VRF
      redistribute connected
      !
      address-family ipv4
