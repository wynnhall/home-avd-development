...
| --------- | --------------- | ------------ | --------- |
| DC1_BL1_2 | Vlan4094 | 172.16.0.12 | Port-Channel3 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet3 | MLAG_PEER_DC1-BL1_Ethernet3 | *trunk | *- | *- | *['LEAF_PEER_L3', 'MLAG'] | 3 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_LINK_TO_DC1-SP1_Ethernet8 | routed | - | 192.168.1.29/31 | default | 1500 | False | - | - |
| Ethernet2 | P2P_LINK_TO_DC1-SP2_Ethernet8 | routed | - | 192.168.1.31/31 | default | 1500 | False | - | - |
| Ethernet4 | P2P_LINK_TO_DC2-BL2_Ethernet4 | routed | - | 192.168.3.2/31 | default | 1500 | False | - | - |
...
!
interface Ethernet3
   description MLAG_PEER_DC1-BL1_Ethernet3
   no shutdown
   speed 100g
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel3 | MLAG_PEER_DC1-BL1_Po3 | switched | trunk | - | - | ['LEAF_PEER_L3', 'MLAG'] | - | - | - | - |
...
interface Port-Channel3
   description MLAG_PEER_DC1-BL1_Po3
   no shutdown
   switchport
...
| Loopback100 | RED_VTEP_DIAGNOSTICS | RED | 10.100.100.8/32 |
| Loopback101 | BLUE_VTEP_DIAGNOSTICS | BLUE | 10.100.101.8/32 |
...
interface Loopback100
   ...
   no shutdown
   vrf RED
   ip address 10.100.100.8/32
!
interface Loopback101
   description BLUE_VTEP_DIAGNOSTICS
   no shutdown
   vrf BLUE
   ip address 10.100.101.8/32
```
...
| Vlan4000 |  RED  |  172.16.1.13/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan4001 |  BLUE  |  172.16.1.13/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan4093 |  default  |  172.16.1.13/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan4094 |  default  |  172.16.0.13/31  |  -  |  -  |  -  |  -  |  -  |
...
| -------- | --------- | --- | -------- | -------------- | -------------- | ---------- | --- | --------------------- | ---------------------- | ------- |
| 172.16.1.12 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | default | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - |
| 192.168.1.28 | 65000.0 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
| 192.168.1.30 | 65000.0 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
| 192.168.3.3 | 65001.5 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
...
| 192.168.101.5 | 65001.5 | default | - | Inherited from peer group EVPN-OVERLAY-CORE | Inherited from peer group EVPN-OVERLAY-CORE | - | Inherited from peer group EVPN-OVERLAY-CORE | - | - | - |
| 192.168.101.6 | 65001.5 | default | - | Inherited from peer group EVPN-OVERLAY-CORE | Inherited from peer group EVPN-OVERLAY-CORE | - | Inherited from peer group EVPN-OVERLAY-CORE | - | - | - |
| 172.16.1.12 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | BLUE | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - |
| 172.16.1.12 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | RED | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 10 | 192.168.100.8:10010 | 10010:10010<br>remote 10010:10010 | - | - | learned |
| 20 | 192.168.100.8:10020 | 10020:10020<br>remote 10020:10020 | - | - | learned |
| 30 | 192.168.100.8:10030 | 10030:10030<br>remote 10030:10030 | - | - | learned |
| 40 | 192.168.100.8:10040 | 10040:10040<br>remote 10040:10040 | - | - | learned |

#### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute |
| --- | ------------------- | ------------ |
| BLUE | 192.168.100.8:1002 | connected |
| RED | 192.168.100.8:1001 | connected |
...
router bgp 65000.7
   ...
   neighbor MLAG-IPv4-UNDERLAY-PEER remote-as 65000.7
   ...
   neighbor 172.16.1.12 peer group MLAG-IPv4-UNDERLAY-PEER
   neighbor 172.16.1.12 description DC1-BL1
   neighbor 192.168.1.28 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.1.28 remote-as 65000.0
   neighbor 192.168.1.28 description DC1-SP1_Ethernet8
   neighbor 192.168.1.30 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.1.30 remote-as 65000.0
   neighbor 192.168.1.30 description DC1-SP2_Ethernet8
   neighbor 192.168.3.3 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.3.3 remote-as 65001.5
   neighbor 192.168.3.3 description DC2-BL2
...
```eos
!
ip address virtual source-nat vrf BLUE address 10.100.101.8
ip address virtual source-nat vrf RED address 10.100.100.8
```
