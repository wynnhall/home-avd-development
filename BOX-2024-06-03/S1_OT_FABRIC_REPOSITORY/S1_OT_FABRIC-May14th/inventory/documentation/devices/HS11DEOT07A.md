...
| ---- | -------------- | -- | ---- |
| local | 651d2ba5c311e84939d03b1a325839568ec2c8a2 | - | - |
...
| ---- | ----- | ------- | -------------- | ------- | -------------- | ----------- | --------- |
| SNMPManager | network-admin | v3 | sha | aes | - | - | 651d2ba5c311e84939d03b1a325839568ec2c8a2 |

#### SNMP Device Configuration

```eos
!
snmp-server engineID local 651d2ba5c311e84939d03b1a325839568ec2c8a2
...
snmp-server user SNMPManager network-admin v3 localized 651d2ba5c311e84939d03b1a325839568ec2c8a2 auth sha <removed> priv aes <removed>
