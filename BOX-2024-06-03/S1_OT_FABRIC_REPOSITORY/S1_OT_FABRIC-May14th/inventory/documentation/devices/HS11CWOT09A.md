...
| ---- | -------------- | -- | ---- |
| local | f81d2e838ad55d4d7b512d8c2c055396454ff369 | - | - |
...
| ---- | ----- | ------- | -------------- | ------- | -------------- | ----------- | --------- |
| SNMPManager | network-admin | v3 | sha | aes | - | - | f81d2e838ad55d4d7b512d8c2c055396454ff369 |

#### SNMP Device Configuration

```eos
!
snmp-server engineID local f81d2e838ad55d4d7b512d8c2c055396454ff369
...
snmp-server user SNMPManager network-admin v3 localized f81d2e838ad55d4d7b512d8c2c055396454ff369 auth sha <removed> priv aes <removed>
