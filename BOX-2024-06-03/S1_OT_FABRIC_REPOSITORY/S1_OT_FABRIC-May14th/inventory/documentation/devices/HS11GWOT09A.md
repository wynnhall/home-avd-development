...
| ---- | -------------- | -- | ---- |
| local | 3a11db39237f0d0f14eef1564bf69e154df6f38f | - | - |
...
| ---- | ----- | ------- | -------------- | ------- | -------------- | ----------- | --------- |
| SNMPManager | network-admin | v3 | sha | aes | - | - | 3a11db39237f0d0f14eef1564bf69e154df6f38f |

#### SNMP Device Configuration

```eos
!
snmp-server engineID local 3a11db39237f0d0f14eef1564bf69e154df6f38f
...
snmp-server user SNMPManager network-admin v3 localized 3a11db39237f0d0f14eef1564bf69e154df6f38f auth sha <removed> priv aes <removed>
