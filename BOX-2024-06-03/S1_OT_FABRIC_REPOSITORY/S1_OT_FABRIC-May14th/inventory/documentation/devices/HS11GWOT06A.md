...
| ---- | -------------- | -- | ---- |
| local | 37da415bc149910f4db99804247598a66518f1c3 | - | - |
...
| ---- | ----- | ------- | -------------- | ------- | -------------- | ----------- | --------- |
| SNMPManager | network-admin | v3 | sha | aes | - | - | 37da415bc149910f4db99804247598a66518f1c3 |

#### SNMP Device Configuration

```eos
!
snmp-server engineID local 37da415bc149910f4db99804247598a66518f1c3
...
snmp-server user SNMPManager network-admin v3 localized 37da415bc149910f4db99804247598a66518f1c3 auth sha <removed> priv aes <removed>
