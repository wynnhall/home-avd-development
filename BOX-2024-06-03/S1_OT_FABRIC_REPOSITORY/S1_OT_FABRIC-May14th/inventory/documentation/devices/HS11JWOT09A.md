...
| ---- | -------------- | -- | ---- |
| local | bd5552bfcc20b7f2efacc5c82a3a834860968032 | - | - |
...
| ---- | ----- | ------- | -------------- | ------- | -------------- | ----------- | --------- |
| SNMPManager | network-admin | v3 | sha | aes | - | - | bd5552bfcc20b7f2efacc5c82a3a834860968032 |

#### SNMP Device Configuration

```eos
!
snmp-server engineID local bd5552bfcc20b7f2efacc5c82a3a834860968032
...
snmp-server user SNMPManager network-admin v3 localized bd5552bfcc20b7f2efacc5c82a3a834860968032 auth sha <removed> priv aes <removed>
