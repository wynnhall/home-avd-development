...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | mgmt | 10.211.240.150/22 | 10.211.240.1 |
...
| ------- | -------- | ---------- | ----- |
| - | S1_OT_FABRIC HS11AOT18A | All | Enabled |

#### SNMP EngineID Configuration

| Type | EngineID (Hex) | IP | Port |
| ---- | -------------- | -- | ---- |
| local | 2d585b4691bef6033e5f19bc54bd249a6191359e | - | - |
...
| ---- | ----- | ------- | -------------- | ------- | -------------- | ----------- | --------- |
| SNMPManager | network-admin | v3 | sha | aes | - | - | 2d585b4691bef6033e5f19bc54bd249a6191359e |

#### SNMP Device Configuration

```eos
!
snmp-server engineID local 2d585b4691bef6033e5f19bc54bd249a6191359e
snmp-server location S1_OT_FABRIC HS11AOT18A
...
snmp-server user SNMPManager network-admin v3 localized 2d585b4691bef6033e5f19bc54bd249a6191359e auth sha <removed> priv aes <removed>
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet49 | [L]_HS11AOTAGG03A_Ethernet5 | *trunk | *none | *- | *- | 49 |
| Ethernet50 | [L]_HS11AOTAGG04A_Ethernet5 | *trunk | *none | *- | *- | 49 |
...
interface Ethernet49
   description [L]_HS11AOTAGG03A_Ethernet5
   no shutdown
   channel-group 49 mode active
!
interface Ethernet50
   description [L]_HS11AOTAGG04A_Ethernet5
   no shutdown
   channel-group 49 mode active
```
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel49 | [L]_S1_OT_AGG_LF15_16_Po5 | switched | trunk | none | - | - | - | - | - | - |
...
interface Port-Channel49
   description [L]_S1_OT_AGG_LF15_16_Po5
   no shutdown
   switchport
