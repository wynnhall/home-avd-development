...
| ---- | -------------- | -- | ---- |
| local | cea834d3790299495287d8478b64a760b7cd3f32 | - | - |
...
| ---- | ----- | ------- | -------------- | ------- | -------------- | ----------- | --------- |
| SNMPManager | network-admin | v3 | sha | aes | - | - | cea834d3790299495287d8478b64a760b7cd3f32 |

#### SNMP Device Configuration

```eos
!
snmp-server engineID local cea834d3790299495287d8478b64a760b7cd3f32
...
snmp-server user SNMPManager network-admin v3 localized cea834d3790299495287d8478b64a760b7cd3f32 auth sha <removed> priv aes <removed>
