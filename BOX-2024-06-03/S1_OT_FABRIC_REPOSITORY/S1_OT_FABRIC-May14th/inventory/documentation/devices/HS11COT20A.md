...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | mgmt | 10.211.240.127/22 | 10.211.240.1 |
...
| ------- | -------- | ---------- | ----- |
| - | S1_OT_FABRIC HS11COT20A | All | Enabled |

#### SNMP EngineID Configuration

| Type | EngineID (Hex) | IP | Port |
| ---- | -------------- | -- | ---- |
| local | 6c9fb5d393e3e1ddd64f70f8bf359fd176a935b0 | - | - |
...
| ---- | ----- | ------- | -------------- | ------- | -------------- | ----------- | --------- |
| SNMPManager | network-admin | v3 | sha | aes | - | - | 6c9fb5d393e3e1ddd64f70f8bf359fd176a935b0 |

#### SNMP Device Configuration

```eos
!
snmp-server engineID local 6c9fb5d393e3e1ddd64f70f8bf359fd176a935b0
snmp-server location S1_OT_FABRIC HS11COT20A
...
snmp-server user SNMPManager network-admin v3 localized 6c9fb5d393e3e1ddd64f70f8bf359fd176a935b0 auth sha <removed> priv aes <removed>
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet49 | [L]_HS11COTAGG03A_Ethernet7 | *trunk | *none | *- | *- | 49 |
| Ethernet50 | [L]_HS11COTAGG04A_Ethernet7 | *trunk | *none | *- | *- | 49 |
...
interface Ethernet49
   description [L]_HS11COTAGG03A_Ethernet7
   no shutdown
   channel-group 49 mode active
!
interface Ethernet50
   description [L]_HS11COTAGG04A_Ethernet7
   no shutdown
   channel-group 49 mode active
```
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel49 | [L]_S1_OT_AGG_LF11_12_Po7 | switched | trunk | none | - | - | - | - | - | - |
...
interface Port-Channel49
   description [L]_S1_OT_AGG_LF11_12_Po7
   no shutdown
   switchport
