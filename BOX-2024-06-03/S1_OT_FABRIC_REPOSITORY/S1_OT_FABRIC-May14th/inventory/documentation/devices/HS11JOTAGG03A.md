...
| ------- | -------- | ---------- | ----- |
| - | S1_OT_FABRIC HS11JOTAGG03A | All | Enabled |

#### SNMP EngineID Configuration

| Type | EngineID (Hex) | IP | Port |
| ---- | -------------- | -- | ---- |
| local | 9e36945019325c326dcd4200a068e651d79db928 | - | - |
...
| ---- | ----- | ------- | -------------- | ------- | -------------- | ----------- | --------- |
| SNMPManager | network-admin | v3 | sha | aes | - | - | 9e36945019325c326dcd4200a068e651d79db928 |

#### SNMP Device Configuration

```eos
!
snmp-server engineID local 9e36945019325c326dcd4200a068e651d79db928
snmp-server location S1_OT_FABRIC HS11JOTAGG03A
...
snmp-server user SNMPManager network-admin v3 localized 9e36945019325c326dcd4200a068e651d79db928 auth sha <removed> priv aes <removed>
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet1 | [L]_HS11JOT14A_Ethernet49 | *trunk | *none | *- | *- | 1 |
| Ethernet2 | [L]_HS11JOT15A_Ethernet49 | *trunk | *none | *- | *- | 2 |
| Ethernet3 | [L]_HS11JOT16A_Ethernet49 | *trunk | *none | *- | *- | 3 |
| Ethernet4 | [L]_HS11JOT17A_Ethernet49 | *trunk | *none | *- | *- | 4 |
| Ethernet5 | [L]_HS11JOT18A_Ethernet49 | *trunk | *none | *- | *- | 5 |
| Ethernet6 | [L]_HS11JOT19A_Ethernet49 | *trunk | *none | *- | *- | 6 |
| Ethernet7 | [L]_HS11JOT20A_Ethernet49 | *trunk | *none | *- | *- | 7 |
| Ethernet8 | [L]_HS11JOT21A_Ethernet49 | *trunk | *none | *- | *- | 8 |
| Ethernet9 | [L]_HS11JOT22A_Ethernet49 | *trunk | *none | *- | *- | 9 |
| Ethernet10 | [L]_HS11JOT23A_Ethernet49 | *trunk | *none | *- | *- | 10 |
| Ethernet11 | [L]_HS11JOT24A_Ethernet49 | *trunk | *none | *- | *- | 11 |
| Ethernet12 | [L]_HS11JOT25A_Ethernet49 | *trunk | *none | *- | *- | 12 |
| Ethernet55/1 | [L]_MLAG_PEER_HS11JOTAGG04A_Ethernet55/1 | *trunk | *- | *- | *['MLAG'] | 4094 |
| Ethernet56/1 | [L]_MLAG_PEER_HS11JOTAGG04A_Ethernet56/1 | *trunk | *- | *- | *['MLAG'] | 4094 |
...
interface Ethernet55/1
   description [L]_MLAG_PEER_HS11JOTAGG04A_Ethernet55/1
   no shutdown
   channel-group 4094 mode active
!
interface Ethernet56/1
   description [L]_MLAG_PEER_HS11JOTAGG04A_Ethernet56/1
   no shutdown
   channel-group 4094 mode active
```
...
| Port-Channel4094 | [L]_MLAG_PEER_HS11JOTAGG04A_Po551 | switched | trunk | - | - | ['MLAG'] | - | - | - | - |
...
interface Port-Channel4094
   description [L]_MLAG_PEER_HS11JOTAGG04A_Po551
   no shutdown
   switchport
   switchport mode trunk
...
!
interface Vxlan1
   description HS11JOTAGG03A_VTEP
...
router bgp 65120.21202
   ...
   neighbor MLAG-IPv4-UNDERLAY-PEER description HS11JOTAGG04A
