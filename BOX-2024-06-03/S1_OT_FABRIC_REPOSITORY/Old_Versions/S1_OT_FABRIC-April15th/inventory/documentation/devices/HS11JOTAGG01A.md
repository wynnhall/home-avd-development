...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | mgmt | 10.211.240.26/22 | 10.211.240.26 |
...
| ------- | -------- | ---------- | ----- |
| - | S1-OT_FABRIC HS11JOTAGG01A | All | Enabled |

#### SNMP EngineID Configuration

| Type | EngineID (Hex) | IP | Port |
| ---- | -------------- | -- | ---- |
| local | 719a5cd86b403241a8dfedfe0458bfd3b6159953 | - | - |
...
| ---- | ----- | ------- | -------------- | ------- | -------------- | ----------- | --------- |
| SNMPManager | network-admin | v3 | sha | aes | - | - | 719a5cd86b403241a8dfedfe0458bfd3b6159953 |

#### SNMP Device Configuration

```eos
!
snmp-server engineID local 719a5cd86b403241a8dfedfe0458bfd3b6159953
snmp-server location S1-OT_FABRIC HS11JOTAGG01A
...
snmp-server user SNMPManager network-admin v3 localized 719a5cd86b403241a8dfedfe0458bfd3b6159953 auth sha <removed> priv aes <removed>
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet1 | [L]_HS11JOT01A_Ethernet49 | *trunk | *253,261,269,273,277,281,285,289,293,297,301,313,327,329,4020 | *- | *- | 1 |
| Ethernet2 | [L]_HS11JOT02A_Ethernet49 | *trunk | *253,261,269,273,277,281,285,289,293,297,301,313,327,329,4020 | *- | *- | 2 |
| Ethernet3 | [L]_HS11JOT03A_Ethernet49 | *trunk | *253,261,269,273,277,281,285,289,293,297,301,313,327,329,4020 | *- | *- | 3 |
| Ethernet4 | [L]_HS11JOT04A_Ethernet49 | *trunk | *253,261,269,273,277,281,285,289,293,297,301,313,327,329,4020 | *- | *- | 4 |
| Ethernet5 | [L]_HS11JOT05A_Ethernet49 | *trunk | *253,261,269,273,277,281,285,289,293,297,301,313,327,329,4020 | *- | *- | 5 |
| Ethernet6 | [L]_HS11JOT06A_Ethernet49 | *trunk | *253,261,269,273,277,281,285,289,293,297,301,313,327,329,4020 | *- | *- | 6 |
| Ethernet7 | [L]_HS11JOT07A_Ethernet49 | *trunk | *253,261,269,273,277,281,285,289,293,297,301,313,327,329,4020 | *- | *- | 7 |
| Ethernet8 | [L]_HS11JOT08A_Ethernet49 | *trunk | *253,261,269,273,277,281,285,289,293,297,301,313,327,329,4020 | *- | *- | 8 |
| Ethernet9 | [L]_HS11JOT09A_Ethernet49 | *trunk | *253,261,269,273,277,281,285,289,293,297,301,313,327,329,4020 | *- | *- | 9 |
| Ethernet10 | [L]_HS11JOT10A_Ethernet49 | *trunk | *253,261,269,273,277,281,285,289,293,297,301,313,327,329,4020 | *- | *- | 10 |
| Ethernet11 | [L]_HS11JOT11A_Ethernet49 | *trunk | *253,261,269,273,277,281,285,289,293,297,301,313,327,329,4020 | *- | *- | 11 |
| Ethernet12 | [L]_HS11JOT12A_Ethernet49 | *trunk | *253,261,269,273,277,281,285,289,293,297,301,313,327,329,4020 | *- | *- | 12 |
| Ethernet13 | [L]_HS11JOT13A_Ethernet49 | *trunk | *253,261,269,273,277,281,285,289,293,297,301,313,327,329,4020 | *- | *- | 13 |
| Ethernet55/1 | [L]_MLAG_PEER_HS11JOTAGG02A_Ethernet55/1 | *trunk | *- | *- | *['LEAF_PEER_L3', 'MLAG'] | 4094 |
| Ethernet56/1 | [L]_MLAG_PEER_HS11JOTAGG02A_Ethernet56/1 | *trunk | *- | *- | *['LEAF_PEER_L3', 'MLAG'] | 4094 |
...
| --------- | ----------- | ---- | --------------| ------------ | --- | --- | -------- | -------------- | -------------------| ----------- | ------------ |
| Ethernet49/1 | [L]_P2P_LINK_TO_ISMS1OTSP01A_Ethernet4/1/1 | routed | - | - | default | 9214 | False | - | - | - | - |
| Ethernet50/1 | [L]_P2P_LINK_TO_ISMS1OTSP02A_Ethernet4/1/1 | routed | - | - | default | 9214 | False | - | - | - | - |
| Ethernet51/1 | [L]_P2P_LINK_TO_ISMS1OTSP03A_Ethernet4/1/1 | routed | - | - | default | 9214 | False | - | - | - | - |
...
!
interface Ethernet1
   description [L]_HS11JOT01A_Ethernet49
   no shutdown
   channel-group 1 mode active
!
interface Ethernet2
   description [L]_HS11JOT02A_Ethernet49
   no shutdown
   channel-group 2 mode active
!
interface Ethernet3
   description [L]_HS11JOT03A_Ethernet49
   no shutdown
   channel-group 3 mode active
!
interface Ethernet4
   description [L]_HS11JOT04A_Ethernet49
   no shutdown
   channel-group 4 mode active
!
interface Ethernet5
   description [L]_HS11JOT05A_Ethernet49
   no shutdown
   channel-group 5 mode active
!
interface Ethernet6
   description [L]_HS11JOT06A_Ethernet49
   no shutdown
   channel-group 6 mode active
!
interface Ethernet7
   description [L]_HS11JOT07A_Ethernet49
   no shutdown
   channel-group 7 mode active
!
interface Ethernet8
   description [L]_HS11JOT08A_Ethernet49
   no shutdown
   channel-group 8 mode active
!
interface Ethernet9
   description [L]_HS11JOT09A_Ethernet49
   no shutdown
   channel-group 9 mode active
!
interface Ethernet10
   description [L]_HS11JOT10A_Ethernet49
   no shutdown
   channel-group 10 mode active
!
interface Ethernet11
   description [L]_HS11JOT11A_Ethernet49
   no shutdown
   channel-group 11 mode active
!
interface Ethernet12
   description [L]_HS11JOT12A_Ethernet49
   no shutdown
   channel-group 12 mode active
!
interface Ethernet13
   description [L]_HS11JOT13A_Ethernet49
   no shutdown
   channel-group 13 mode active
!
interface Ethernet49/1
   description [L]_P2P_LINK_TO_ISMS1OTSP01A_Ethernet4/1/1
   no shutdown
   mtu 9214
   no switchport
   ipv6 enable
...
interface Ethernet50/1
   description [L]_P2P_LINK_TO_ISMS1OTSP02A_Ethernet4/1/1
   no shutdown
   mtu 9214
   no switchport
   ipv6 enable
...
interface Ethernet51/1
   description [L]_P2P_LINK_TO_ISMS1OTSP03A_Ethernet4/1/1
   no shutdown
   mtu 9214
   no switchport
   ipv6 enable
...
interface Ethernet55/1
   description [L]_MLAG_PEER_HS11JOTAGG02A_Ethernet55/1
   no shutdown
   channel-group 4094 mode active
!
interface Ethernet56/1
   description [L]_MLAG_PEER_HS11JOTAGG02A_Ethernet56/1
   no shutdown
   channel-group 4094 mode active
```
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel1 | [L]_HS11JOT01A_Po49 | switched | trunk | 253,261,269,273,277,281,285,289,293,297,301,313,327,329,4020 | - | - | - | - | 1 | - |
| Port-Channel2 | [L]_HS11JOT02A_Po49 | switched | trunk | 253,261,269,273,277,281,285,289,293,297,301,313,327,329,4020 | - | - | - | - | 2 | - |
| Port-Channel3 | [L]_HS11JOT03A_Po49 | switched | trunk | 253,261,269,273,277,281,285,289,293,297,301,313,327,329,4020 | - | - | - | - | 3 | - |
| Port-Channel4 | [L]_HS11JOT04A_Po49 | switched | trunk | 253,261,269,273,277,281,285,289,293,297,301,313,327,329,4020 | - | - | - | - | 4 | - |
| Port-Channel5 | [L]_HS11JOT05A_Po49 | switched | trunk | 253,261,269,273,277,281,285,289,293,297,301,313,327,329,4020 | - | - | - | - | 5 | - |
| Port-Channel6 | [L]_HS11JOT06A_Po49 | switched | trunk | 253,261,269,273,277,281,285,289,293,297,301,313,327,329,4020 | - | - | - | - | 6 | - |
| Port-Channel7 | [L]_HS11JOT07A_Po49 | switched | trunk | 253,261,269,273,277,281,285,289,293,297,301,313,327,329,4020 | - | - | - | - | 7 | - |
| Port-Channel8 | [L]_HS11JOT08A_Po49 | switched | trunk | 253,261,269,273,277,281,285,289,293,297,301,313,327,329,4020 | - | - | - | - | 8 | - |
| Port-Channel9 | [L]_HS11JOT09A_Po49 | switched | trunk | 253,261,269,273,277,281,285,289,293,297,301,313,327,329,4020 | - | - | - | - | 9 | - |
| Port-Channel10 | [L]_HS11JOT10A_Po49 | switched | trunk | 253,261,269,273,277,281,285,289,293,297,301,313,327,329,4020 | - | - | - | - | 10 | - |
| Port-Channel11 | [L]_HS11JOT11A_Po49 | switched | trunk | 253,261,269,273,277,281,285,289,293,297,301,313,327,329,4020 | - | - | - | - | 11 | - |
| Port-Channel12 | [L]_HS11JOT12A_Po49 | switched | trunk | 253,261,269,273,277,281,285,289,293,297,301,313,327,329,4020 | - | - | - | - | 12 | - |
| Port-Channel13 | [L]_HS11JOT13A_Po49 | switched | trunk | 253,261,269,273,277,281,285,289,293,297,301,313,327,329,4020 | - | - | - | - | 13 | - |
| Port-Channel4094 | [L]_MLAG_PEER_HS11JOTAGG02A_Po551 | switched | trunk | - | - | ['LEAF_PEER_L3', 'MLAG'] | - | - | - | - |
...
interface Port-Channel4094
   description [L]_MLAG_PEER_HS11JOTAGG02A_Po551
   no shutdown
   switchport
   switchport mode trunk
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | EVPN_Overlay_Peering | default | 172.21.3.4/32 |
| Loopback1 | VTEP_VXLAN_Tunnel_Source | default | 10.210.248.4/32 |
...
interface Loopback0
   ...
   no shutdown
   ip address 172.21.3.4/32
!
interface Loopback1
   description VTEP_VXLAN_Tunnel_Source
   no shutdown
   ip address 10.210.248.4/32
```
...
!
interface Vxlan1
   description HS11JOTAGG01A_VTEP
...
| --- | ------------------ | ----------- | -------------- | ----------------------- | --- | ---------- | ------ |
| mgmt | 0.0.0.0/0 | 10.211.240.26 | - | 1 | - | - | - |

#### Static Routes Device Configuration

```eos
!
ip route vrf mgmt 0.0.0.0/0 10.211.240.26
```
...
| Vlan4093 | default | MLAG-IPv4-UNDERLAY-PEER | 65120.21201 | - |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 253 | 172.21.3.4:10253 | 10253:10253 | - | - | learned |
| 261 | 172.21.3.4:10261 | 10261:10261 | - | - | learned |
| 269 | 172.21.3.4:10269 | 10269:10269 | - | - | learned |
| 273 | 172.21.3.4:10273 | 10273:10273 | - | - | learned |
| 277 | 172.21.3.4:10277 | 10277:10277 | - | - | learned |
| 281 | 172.21.3.4:10281 | 10281:10281 | - | - | learned |
| 285 | 172.21.3.4:10285 | 10285:10285 | - | - | learned |
| 289 | 172.21.3.4:10289 | 10289:10289 | - | - | learned |
| 293 | 172.21.3.4:10293 | 10293:10293 | - | - | learned |
| 297 | 172.21.3.4:10297 | 10297:10297 | - | - | learned |
| 301 | 172.21.3.4:10301 | 10301:10301 | - | - | learned |
| 313 | 172.21.3.4:10313 | 10313:10313 | - | - | learned |
| 327 | 172.21.3.4:10327 | 10327:10327 | - | - | learned |
| 329 | 172.21.3.4:10329 | 10329:10329 | - | - | learned |
| 4020 | 172.21.3.4:14020 | 14020:14020 | - | - | learned |

#### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute |
| --- | ------------------- | ------------ |
| OT | 172.21.3.4:5001 | connected |

#### Router BGP Device Configuration

```eos
!
router bgp 65120.21201
   router-id 172.21.3.4
   maximum-paths 128 ecmp 128
   update wait-install
   no bgp default ipv4-unicast
   bgp asn notation asdot
   ...
   neighbor MLAG-IPv4-UNDERLAY-PEER remote-as 65120.21201
   neighbor MLAG-IPv4-UNDERLAY-PEER next-hop-self
   neighbor MLAG-IPv4-UNDERLAY-PEER description HS11JOTAGG02A
   ...
   neighbor interface Vlan4093 peer-group MLAG-IPv4-UNDERLAY-PEER remote-as 65120.21201
