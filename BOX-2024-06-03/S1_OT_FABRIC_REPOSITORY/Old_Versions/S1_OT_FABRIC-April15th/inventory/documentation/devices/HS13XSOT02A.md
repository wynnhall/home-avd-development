...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | mgmt | 10.211.240.239/22 | 10.211.240.239 |
...
| ------- | -------- | ---------- | ----- |
| - | S1-OT_FABRIC HS13XSOT02A | All | Enabled |

#### SNMP EngineID Configuration

| Type | EngineID (Hex) | IP | Port |
| ---- | -------------- | -- | ---- |
| local | d75ba3428cee590a1c1ac55e39278f029a9355c3 | - | - |
...
| ---- | ----- | ------- | -------------- | ------- | -------------- | ----------- | --------- |
| SNMPManager | network-admin | v3 | sha | aes | - | - | d75ba3428cee590a1c1ac55e39278f029a9355c3 |

#### SNMP Device Configuration

```eos
!
snmp-server engineID local d75ba3428cee590a1c1ac55e39278f029a9355c3
snmp-server location S1-OT_FABRIC HS13XSOT02A
...
snmp-server user SNMPManager network-admin v3 localized d75ba3428cee590a1c1ac55e39278f029a9355c3 auth sha <removed> priv aes <removed>
...
| --- | ------------------ | ----------- | -------------- | ----------------------- | --- | ---------- | ------ |
| mgmt | 0.0.0.0/0 | 10.211.240.239 | - | 1 | - | - | - |

#### Static Routes Device Configuration

```eos
!
ip route vrf mgmt 0.0.0.0/0 10.211.240.239
```
