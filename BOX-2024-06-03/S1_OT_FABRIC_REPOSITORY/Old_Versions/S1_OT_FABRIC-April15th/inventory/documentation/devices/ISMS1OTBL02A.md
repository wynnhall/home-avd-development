...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | mgmt | 10.210.80.71/21 | 10.210.80.71 |
...
| ------- | -------- | ---------- | ----- |
| - | S1-OT_FABRIC ISMS1OTBL02A | All | Enabled |

#### SNMP EngineID Configuration

| Type | EngineID (Hex) | IP | Port |
| ---- | -------------- | -- | ---- |
| local | c0bb31f2f99a071beb637b633bbfa63172b0d4b4 | - | - |
...
| ---- | ----- | ------- | -------------- | ------- | -------------- | ----------- | --------- |
| SNMPManager | network-admin | v3 | sha | aes | - | - | c0bb31f2f99a071beb637b633bbfa63172b0d4b4 |

#### SNMP Device Configuration

```eos
!
snmp-server engineID local c0bb31f2f99a071beb637b633bbfa63172b0d4b4
snmp-server location S1-OT_FABRIC ISMS1OTBL02A
...
snmp-server user SNMPManager network-admin v3 localized c0bb31f2f99a071beb637b633bbfa63172b0d4b4 auth sha <removed> priv aes <removed>
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet31/1 | [L]_MLAG_PEER_ISMS1OTBL01A_Ethernet31/1 | *trunk | *- | *- | *['LEAF_PEER_L3', 'MLAG'] | 4094 |
| Ethernet32/1 | [L]_MLAG_PEER_ISMS1OTBL01A_Ethernet32/1 | *trunk | *- | *- | *['LEAF_PEER_L3', 'MLAG'] | 4094 |
...
| --------- | ----------- | -----| ------- | -------------- |
| Ethernet1/1.533 | [L]_ISMDC1BL01A-Eth6/1-OT-VRF | l3dot1q | - | 533 |
| Ethernet2/1.533 | [L]_ISMDC1BL02A-Eth6/1-OT-VRF | l3dot1q | - | 533 |
| Ethernet3/1.533 | [L]_ISMDC2BL01A-Eth6/1-OT-VRF | l3dot1q | - | 533 |
| Ethernet4/1.533 | [L]_ISMDC2BL02A-Eth6/1-OT-VRF | l3dot1q | - | 533 |

##### IPv4

| Interface | Description | Type | Channel Group | IP Address | VRF |  MTU | Shutdown | ACL In | ACL Out |
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1/1.533 | [L]_ISMDC1BL01A-Eth6/1-OT-VRF | l3dot1q | - | 10.210.226.18/31 | OT | - | False | - | - |
| Ethernet2/1.533 | [L]_ISMDC1BL02A-Eth6/1-OT-VRF | l3dot1q | - | 10.210.226.22/31 | OT | - | False | - | - |
| Ethernet3/1.533 | [L]_ISMDC2BL01A-Eth6/1-OT-VRF | l3dot1q | - | 10.210.234.10/31 | OT | - | False | - | - |
| Ethernet4/1.533 | [L]_ISMDC2BL02A-Eth6/1-OT-VRF | l3dot1q | - | 10.210.234.14/31 | OT | - | False | - | - |

##### IPv6

| Interface | Description | Type | Channel Group | IPv6 Address | VRF | MTU | Shutdown | ND RA Disabled | Managed Config Flag | IPv6 ACL In | IPv6 ACL Out |
| --------- | ----------- | ---- | --------------| ------------ | --- | --- | -------- | -------------- | -------------------| ----------- | ------------ |
| Ethernet25/1 | [L]_P2P_LINK_TO_ISMS1OTSP01A_Ethernet3/1/1 | routed | - | - | default | 9214 | False | - | - | - | - |
| Ethernet26/1 | [L]_P2P_LINK_TO_ISMS1OTSP02A_Ethernet3/1/1 | routed | - | - | default | 9214 | False | - | - | - | - |
| Ethernet27/1 | [L]_P2P_LINK_TO_ISMS1OTSP03A_Ethernet3/1/1 | routed | - | - | default | 9214 | False | - | - | - | - |
...
interface Ethernet1/1.533
   description [L]_ISMDC1BL01A-Eth6/1-OT-VRF
   no shutdown
   encapsulation dot1q vlan 533
   vrf OT
   ip address 10.210.226.18/31
!
...
interface Ethernet2/1.533
   description [L]_ISMDC1BL02A-Eth6/1-OT-VRF
   no shutdown
   encapsulation dot1q vlan 533
   vrf OT
   ip address 10.210.226.22/31
!
interface Ethernet3/1
   no shutdown
   no switchport
!
interface Ethernet3/1.533
   description [L]_ISMDC2BL01A-Eth6/1-OT-VRF
   no shutdown
   encapsulation dot1q vlan 533
   vrf OT
   ip address 10.210.234.10/31
!
interface Ethernet4/1
   no shutdown
   no switchport
!
interface Ethernet4/1.533
   description [L]_ISMDC2BL02A-Eth6/1-OT-VRF
   no shutdown
   encapsulation dot1q vlan 533
   vrf OT
   ip address 10.210.234.14/31
!
interface Ethernet25/1
   description [L]_P2P_LINK_TO_ISMS1OTSP01A_Ethernet3/1/1
   no shutdown
   mtu 9214
   no switchport
   ipv6 enable
...
interface Ethernet26/1
   description [L]_P2P_LINK_TO_ISMS1OTSP02A_Ethernet3/1/1
   no shutdown
   mtu 9214
   no switchport
   ipv6 enable
...
interface Ethernet27/1
   description [L]_P2P_LINK_TO_ISMS1OTSP03A_Ethernet3/1/1
   no shutdown
   mtu 9214
   no switchport
   ipv6 enable
...
interface Ethernet31/1
   description [L]_MLAG_PEER_ISMS1OTBL01A_Ethernet31/1
   no shutdown
   channel-group 4094 mode active
!
interface Ethernet32/1
   description [L]_MLAG_PEER_ISMS1OTBL01A_Ethernet32/1
   no shutdown
   channel-group 4094 mode active
```
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel4094 | [L]_MLAG_PEER_ISMS1OTBL01A_Po311 | switched | trunk | - | - | ['LEAF_PEER_L3', 'MLAG'] | - | - | - | - |
...
interface Port-Channel4094
   description [L]_MLAG_PEER_ISMS1OTBL01A_Po311
   no shutdown
   switchport
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | EVPN_Overlay_Peering | default | 172.21.3.41/32 |
| Loopback1 | VTEP_VXLAN_Tunnel_Source | default | 10.210.248.40/32 |
...
interface Loopback0
   ...
   no shutdown
   ip address 172.21.3.41/32
!
interface Loopback1
   description VTEP_VXLAN_Tunnel_Source
   no shutdown
   ip address 10.210.248.40/32
```
...
| --- | ------------------ | ----------- | -------------- | ----------------------- | --- | ---------- | ------ |
| mgmt | 0.0.0.0/0 | 10.210.80.71 | - | 1 | - | - | - |

#### Static Routes Device Configuration

```eos
!
ip route vrf mgmt 0.0.0.0/0 10.210.80.71
```
...
| 10.210.226.19 | Inherited from peer group DC1-BL-EBGP-PEERS-OTVRF | OT | - | - | Inherited from peer group DC1-BL-EBGP-PEERS-OTVRF | - | - | - | - | - |
| 10.210.226.23 | Inherited from peer group DC1-BL-EBGP-PEERS-OTVRF | OT | - | - | Inherited from peer group DC1-BL-EBGP-PEERS-OTVRF | - | - | - | - | - |
| 10.210.234.11 | Inherited from peer group DC2-BL-EBGP-PEERS-OTVRF | OT | - | - | Inherited from peer group DC2-BL-EBGP-PEERS-OTVRF | - | - | - | - | - |
| 10.210.234.15 | Inherited from peer group DC2-BL-EBGP-PEERS-OTVRF | OT | - | - | Inherited from peer group DC2-BL-EBGP-PEERS-OTVRF | - | - | - | - | - |

#### BGP Neighbor Interfaces

| Neighbor Interface | VRF | Peer Group | Remote AS | Peer Filter |
| ------------------ | --- | ---------- | --------- | ----------- |
| Ethernet25/1 | default | IPv4-UNDERLAY-PEERS | 65120.21100 | - |
| Ethernet26/1 | default | IPv4-UNDERLAY-PEERS | 65120.21100 | - |
| Ethernet27/1 | default | IPv4-UNDERLAY-PEERS | 65120.21100 | - |
| Vlan4093 | default | MLAG-IPv4-UNDERLAY-PEER | 65120.21200 | - |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 253 | 172.21.3.41:10253 | 10253:10253 | - | - | learned |
| 261 | 172.21.3.41:10261 | 10261:10261 | - | - | learned |
| 269 | 172.21.3.41:10269 | 10269:10269 | - | - | learned |
| 273 | 172.21.3.41:10273 | 10273:10273 | - | - | learned |
| 277 | 172.21.3.41:10277 | 10277:10277 | - | - | learned |
| 281 | 172.21.3.41:10281 | 10281:10281 | - | - | learned |
| 285 | 172.21.3.41:10285 | 10285:10285 | - | - | learned |
| 289 | 172.21.3.41:10289 | 10289:10289 | - | - | learned |
| 293 | 172.21.3.41:10293 | 10293:10293 | - | - | learned |
| 297 | 172.21.3.41:10297 | 10297:10297 | - | - | learned |
| 301 | 172.21.3.41:10301 | 10301:10301 | - | - | learned |
| 313 | 172.21.3.41:10313 | 10313:10313 | - | - | learned |
| 327 | 172.21.3.41:10327 | 10327:10327 | - | - | learned |
| 329 | 172.21.3.41:10329 | 10329:10329 | - | - | learned |
| 4020 | 172.21.3.41:14020 | 14020:14020 | - | - | learned |

#### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute |
| --- | ------------------- | ------------ |
| OT | 172.21.3.41:5001 | connected |

#### Router BGP Device Configuration

```eos
!
router bgp 65120.21200
   router-id 172.21.3.41
   maximum-paths 128 ecmp 128
   update wait-install
   no bgp default ipv4-unicast
   bgp asn notation asdot
   ...
   neighbor DC1-BL-EBGP-PEERS-OTVRF password 7 <removed>
   ...
   neighbor DC2-BL-EBGP-PEERS-OTVRF password 7 <removed>
   ...
   neighbor MLAG-IPv4-UNDERLAY-PEER remote-as 65120.21200
   neighbor MLAG-IPv4-UNDERLAY-PEER next-hop-self
   neighbor MLAG-IPv4-UNDERLAY-PEER description ISMS1OTBL01A
   neighbor MLAG-IPv4-UNDERLAY-PEER password 7 <removed>
   neighbor MLAG-IPv4-UNDERLAY-PEER send-community
   neighbor MLAG-IPv4-UNDERLAY-PEER maximum-routes 12000
   neighbor MLAG-IPv4-UNDERLAY-PEER route-map RM-MLAG-PEER-IN in
   neighbor interface Ethernet25/1 peer-group IPv4-UNDERLAY-PEERS remote-as 65120.21100
   neighbor interface Ethernet26/1 peer-group IPv4-UNDERLAY-PEERS remote-as 65120.21100
   neighbor interface Ethernet27/1 peer-group IPv4-UNDERLAY-PEERS remote-as 65120.21100
   neighbor interface Vlan4093 peer-group MLAG-IPv4-UNDERLAY-PEER remote-as 65120.21200
   ...
   vrf OT
      ...
      router-id 172.21.3.41
      update wait-install
      neighbor 10.210.226.19 peer group DC1-BL-EBGP-PEERS-OTVRF
      neighbor 10.210.226.19 description ISMDC1BL01A-Eth5/1-OT-VRF
      neighbor 10.210.226.23 peer group DC1-BL-EBGP-PEERS-OTVRF
      neighbor 10.210.226.23 description ISMDC1BL02A-Eth5/1-OT-VRF
      neighbor 10.210.234.11 peer group DC2-BL-EBGP-PEERS-OTVRF
      neighbor 10.210.234.11 description ISMDC2BL01A-Eth6/1-OT-VRF
      neighbor 10.210.234.15 peer group DC2-BL-EBGP-PEERS-OTVRF
      neighbor 10.210.234.15 description ISMDC2BL02A-Eth6/1-OT-VRF
      redistribute connected
      !
      address-family ipv4
         neighbor 10.210.226.19 activate
         neighbor 10.210.226.23 activate
