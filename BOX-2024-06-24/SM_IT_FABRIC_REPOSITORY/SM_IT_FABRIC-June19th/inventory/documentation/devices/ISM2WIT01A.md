...
| ---- | -------------- | -- | ---- |
| local | 967653f581c32913ec05448d1e0bfea6a3a22096 | - | - |
...
| ---- | ----- | ------- | -------------- | ------- | -------------- | ----------- | --------- |
| SNMPManager | network-admin | v3 | sha | aes | - | - | 967653f581c32913ec05448d1e0bfea6a3a22096 |

#### SNMP Device Configuration

```eos
!
snmp-server engineID local 967653f581c32913ec05448d1e0bfea6a3a22096
...
snmp-server user SNMPManager network-admin v3 localized 967653f581c32913ec05448d1e0bfea6a3a22096 auth sha <removed> priv aes <removed>
...
| 311 | 172.21.2.22:10311 | 10311:10311 | - | - | learned |
...
| IT-Tenant-inband-mgmt | 172.21.2.22:5005 | connected |
