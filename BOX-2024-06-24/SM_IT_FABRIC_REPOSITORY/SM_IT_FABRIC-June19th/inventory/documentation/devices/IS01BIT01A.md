...
| ---- | -------------- | -- | ---- |
| local | e3ec939453482a56f7965fb77e75c4d3aecea52a | - | - |
...
| ---- | ----- | ------- | -------------- | ------- | -------------- | ----------- | --------- |
| SNMPManager | network-admin | v3 | sha | aes | - | - | e3ec939453482a56f7965fb77e75c4d3aecea52a |

#### SNMP Device Configuration

```eos
!
snmp-server engineID local e3ec939453482a56f7965fb77e75c4d3aecea52a
...
snmp-server user SNMPManager network-admin v3 localized e3ec939453482a56f7965fb77e75c4d3aecea52a auth sha <removed> priv aes <removed>
