...
| ---- | -------------- | -- | ---- |
| local | 3b0f6046f72a948702f7c870695e97543b4ac1cd | - | - |
...
| ---- | ----- | ------- | -------------- | ------- | -------------- | ----------- | --------- |
| SNMPManager | network-admin | v3 | sha | aes | - | - | 3b0f6046f72a948702f7c870695e97543b4ac1cd |

#### SNMP Device Configuration

```eos
!
snmp-server engineID local 3b0f6046f72a948702f7c870695e97543b4ac1cd
...
snmp-server user SNMPManager network-admin v3 localized 3b0f6046f72a948702f7c870695e97543b4ac1cd auth sha <removed> priv aes <removed>
