...
| ---- | -------------- | -- | ---- |
| local | dfd1cbb5e55099b4df6ecf6a95138e3097398eb7 | - | - |
...
| ---- | ----- | ------- | -------------- | ------- | -------------- | ----------- | --------- |
| SNMPManager | network-admin | v3 | sha | aes | - | - | dfd1cbb5e55099b4df6ecf6a95138e3097398eb7 |

#### SNMP Device Configuration

```eos
!
snmp-server engineID local dfd1cbb5e55099b4df6ecf6a95138e3097398eb7
...
snmp-server user SNMPManager network-admin v3 localized dfd1cbb5e55099b4df6ecf6a95138e3097398eb7 auth sha <removed> priv aes <removed>
