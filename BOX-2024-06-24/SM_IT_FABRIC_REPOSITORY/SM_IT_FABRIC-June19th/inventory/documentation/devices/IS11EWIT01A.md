...
| ---- | -------------- | -- | ---- |
| local | 6ec5b926d0e7add1574064df636a599768272de0 | - | - |
...
| ---- | ----- | ------- | -------------- | ------- | -------------- | ----------- | --------- |
| SNMPManager | network-admin | v3 | sha | aes | - | - | 6ec5b926d0e7add1574064df636a599768272de0 |

#### SNMP Device Configuration

```eos
!
snmp-server engineID local 6ec5b926d0e7add1574064df636a599768272de0
...
snmp-server user SNMPManager network-admin v3 localized 6ec5b926d0e7add1574064df636a599768272de0 auth sha <removed> priv aes <removed>
