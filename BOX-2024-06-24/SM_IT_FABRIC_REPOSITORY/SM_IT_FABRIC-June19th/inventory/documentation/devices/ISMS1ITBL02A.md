...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | mgmt | 10.210.80.64/21 | 10.210.80.1 |
...
| ------- | -------- | ---------- | ----- |
| - | SM_IT_FABRIC isms1itbl02a | All | Enabled |

#### SNMP EngineID Configuration

| Type | EngineID (Hex) | IP | Port |
| ---- | -------------- | -- | ---- |
| local | 62c8034cf823c5a6061aee6fc2901a265b4f7a69 | - | - |
...
| ---- | ----- | ------- | -------------- | ------- | -------------- | ----------- | --------- |
| SNMPManager | network-admin | v3 | sha | aes | - | - | 62c8034cf823c5a6061aee6fc2901a265b4f7a69 |

#### SNMP Device Configuration

```eos
!
snmp-server engineID local 62c8034cf823c5a6061aee6fc2901a265b4f7a69
snmp-server location SM_IT_FABRIC isms1itbl02a
...
snmp-server user SNMPManager network-admin v3 localized 62c8034cf823c5a6061aee6fc2901a265b4f7a69 auth sha <removed> priv aes <removed>
...
| --------- | --------------- | ------------ | --------- |
| IT_BLEAFS | Vlan4094 | 192.168.0.0 | Port-Channel4094 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet31/1 | [L]_MLAG_PEER_isms1itbl01a_Ethernet31/1 | *trunk | *- | *- | *['MLAG'] | 4094 |
| Ethernet32/1 | [L]_MLAG_PEER_isms1itbl01a_Ethernet32/1 | *trunk | *- | *- | *['MLAG'] | 4094 |
...
| --------- | ----------- | -----| ------- | -------------- |
| Ethernet1/1.311 | [L]_ismcr01a-Eth4/3/1-inband-mgmtVRF | l3dot1q | - | 311 |
| Ethernet1/1.525 | [L]_ismcr01a-Eth4/3/1-IT-VRF | l3dot1q | - | 525 |
| Ethernet1/1.633 | [L]_ismcr01a-Eth4/3/1-IoTVRF | l3dot1q | - | 633 |
| Ethernet2/1.311 | [L]_ismcr02a-Eth4/3/1-inband-mgmtVRF | l3dot1q | - | 311 |
| Ethernet2/1.525 | [L]_ismcr02a-Eth4/3/1-IT-VRF | l3dot1q | - | 525 |
| Ethernet2/1.633 | [L]_ismcr02a-Eth4/3/1-IoTVRF | l3dot1q | - | 633 |

##### IPv4

| Interface | Description | Type | Channel Group | IP Address | VRF |  MTU | Shutdown | ACL In | ACL Out |
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1/1.311 | [L]_ismcr01a-Eth4/3/1-inband-mgmtVRF | l3dot1q | - | 10.210.241.53/31 | IT-Tenant-inband-mgmt | - | False | - | - |
| Ethernet1/1.525 | [L]_ismcr01a-Eth4/3/1-IT-VRF | l3dot1q | - | 10.210.241.5/31 | IT | - | False | - | - |
| Ethernet1/1.633 | [L]_ismcr01a-Eth4/3/1-IoTVRF | l3dot1q | - | 10.210.241.13/31 | IoT | - | False | - | - |
| Ethernet2/1.311 | [L]_ismcr02a-Eth4/3/1-inband-mgmtVRF | l3dot1q | - | 10.210.241.55/31 | IT-Tenant-inband-mgmt | - | False | - | - |
| Ethernet2/1.525 | [L]_ismcr02a-Eth4/3/1-IT-VRF | l3dot1q | - | 10.210.241.7/31 | IT | - | False | - | - |
| Ethernet2/1.633 | [L]_ismcr02a-Eth4/3/1-IoTVRF | l3dot1q | - | 10.210.241.15/31 | IoT | - | False | - | - |

##### IPv6

| Interface | Description | Type | Channel Group | IPv6 Address | VRF | MTU | Shutdown | ND RA Disabled | Managed Config Flag | IPv6 ACL In | IPv6 ACL Out |
| --------- | ----------- | ---- | --------------| ------------ | --- | --- | -------- | -------------- | -------------------| ----------- | ------------ |
| Ethernet25/1 | [L]_P2P_LINK_TO_ISMS1ITSP01A_Ethernet4/1/1 | routed | - | - | default | 9214 | False | - | - | - | - |
| Ethernet26/1 | [L]_P2P_LINK_TO_ISMS1ITSP02A_Ethernet4/1/1 | routed | - | - | default | 9214 | False | - | - | - | - |
| Ethernet27/1 | [L]_P2P_LINK_TO_ISMS1ITSP03A_Ethernet4/1/1 | routed | - | - | default | 9214 | False | - | - | - | - |
...
interface Ethernet1/1
   ...
   no switchport
!
interface Ethernet1/1.311
   description [L]_ismcr01a-Eth4/3/1-inband-mgmtVRF
   no shutdown
   encapsulation dot1q vlan 311
   vrf IT-Tenant-inband-mgmt
   ip address 10.210.241.53/31
!
interface Ethernet1/1.525
   description [L]_ismcr01a-Eth4/3/1-IT-VRF
   no shutdown
...
interface Ethernet1/1.633
   description [L]_ismcr01a-Eth4/3/1-IoTVRF
   no shutdown
...
interface Ethernet2/1
   ...
   no switchport
!
interface Ethernet2/1.311
   description [L]_ismcr02a-Eth4/3/1-inband-mgmtVRF
   no shutdown
   encapsulation dot1q vlan 311
   vrf IT-Tenant-inband-mgmt
   ip address 10.210.241.55/31
!
interface Ethernet2/1.525
   description [L]_ismcr02a-Eth4/3/1-IT-VRF
   no shutdown
   encapsulation dot1q vlan 525
   vrf IT
   ip address 10.210.241.7/31
!
interface Ethernet2/1.633
   description [L]_ismcr02a-Eth4/3/1-IoTVRF
   no shutdown
   encapsulation dot1q vlan 633
   vrf IoT
   ip address 10.210.241.15/31
!
interface Ethernet25/1
   description [L]_P2P_LINK_TO_ISMS1ITSP01A_Ethernet4/1/1
   no shutdown
   mtu 9214
   no switchport
   ipv6 enable
...
interface Ethernet26/1
   description [L]_P2P_LINK_TO_ISMS1ITSP02A_Ethernet4/1/1
   no shutdown
   mtu 9214
   no switchport
   ipv6 enable
...
interface Ethernet27/1
   description [L]_P2P_LINK_TO_ISMS1ITSP03A_Ethernet4/1/1
   no shutdown
   mtu 9214
   no switchport
   ipv6 enable
...
interface Ethernet31/1
   description [L]_MLAG_PEER_isms1itbl01a_Ethernet31/1
   no shutdown
   channel-group 4094 mode active
!
interface Ethernet32/1
   description [L]_MLAG_PEER_isms1itbl01a_Ethernet32/1
   no shutdown
   channel-group 4094 mode active
```
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel4094 | [L]_MLAG_PEER_isms1itbl01a_Po311 | switched | trunk | - | - | ['MLAG'] | - | - | - | - |
...
interface Port-Channel4094
   description [L]_MLAG_PEER_isms1itbl01a_Po311
   no shutdown
   switchport
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | EVPN_Overlay_Peering | default | 172.21.2.5/32 |
...
##### CORES-EBGP-PEERS-inband-mgmtVRF
...
| 10.210.241.14 | Inherited from peer group CORES-EBGP-PEERS-IoTVRF | IoT | - | - | Inherited from peer group CORES-EBGP-PEERS-IoTVRF | - | - | - | - | - | - |
| 10.210.241.4 | Inherited from peer group CORES-EBGP-PEERS-IT-VRF | IT | - | - | Inherited from peer group CORES-EBGP-PEERS-IT-VRF | - | - | - | - | - | - |
| 10.210.241.6 | Inherited from peer group CORES-EBGP-PEERS-IT-VRF | IT | - | - | Inherited from peer group CORES-EBGP-PEERS-IT-VRF | - | - | - | - | - | - |
| 10.210.241.53 | Inherited from peer group CORES-EBGP-PEERS-inband-mgmtVRF | IT-Tenant-inband-mgmt | - | - | Inherited from peer group CORES-EBGP-PEERS-inband-mgmtVRF | - | - | - | - | - | - |
| 10.210.241.55 | Inherited from peer group CORES-EBGP-PEERS-inband-mgmtVRF | IT-Tenant-inband-mgmt | - | - | Inherited from peer group CORES-EBGP-PEERS-inband-mgmtVRF | - | - | - | - | - | - |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 224 | 172.21.2.5:10224 | 10224:10224 | - | - | learned |
| 227 | 172.21.2.5:10227 | 10227:10227 | - | - | learned |
| 237 | 172.21.2.5:10237 | 10237:10237 | - | - | learned |
| 243 | 172.21.2.5:10243 | 10243:10243 | - | - | learned |
| 245 | 172.21.2.5:10245 | 10245:10245 | - | - | learned |
| 247 | 172.21.2.5:10247 | 10247:10247 | - | - | learned |
| 250 | 172.21.2.5:10250 | 10250:10250 | - | - | learned |
| 305 | 172.21.2.5:10305 | 10305:10305 | - | - | learned |
| 307 | 172.21.2.5:10307 | 10307:10307 | - | - | learned |
| 309 | 172.21.2.5:10309 | 10309:10309 | - | - | learned |
| 311 | 172.21.2.5:10311 | 10311:10311 | - | - | learned |
| 337 | 172.21.2.5:10337 | 10337:10337 | - | - | learned |
| 951 | 172.21.2.5:10951 | 10951:10951 | - | - | learned |
...
| IoT | 172.21.2.5:5004 | connected |
| IT | 172.21.2.5:5003 | connected |
| IT-Tenant-inband-mgmt | 172.21.2.5:5005 | connected |
...
router bgp 65120.31200
   ...
   timers bgp 5 15
   neighbor default send-community
   neighbor CORES-EBGP-PEERS-inband-mgmtVRF peer group
   neighbor CORES-EBGP-PEERS-inband-mgmtVRF remote-as 65120.1
   neighbor CORES-EBGP-PEERS-inband-mgmtVRF maximum-routes 0
   ...
   neighbor MLAG-IPv4-UNDERLAY-PEER description isms1itbl01a
   ...
   vrf IoT
      ...
      neighbor 10.210.241.12 description ismcr01a-Eth4/3/1-IoTVRF
      neighbor 10.210.241.14 peer group CORES-EBGP-PEERS-IoTVRF
      neighbor 10.210.241.14 description ismcr02a-Eth4/3/1-IoTVRF
      redistribute connected route-map RM-LOCAL-NETWORKS
      !
      address-family ipv4
   ...
   vrf IT
      ...
      neighbor 10.210.241.4 description ismcr01a-Eth4/3/1-IT-VRF
      neighbor 10.210.241.6 peer group CORES-EBGP-PEERS-IT-VRF
      neighbor 10.210.241.6 description ismcr02a-Eth4/3/1-IT-VRF
      redistribute connected route-map RM-LOCAL-NETWORKS
      !
      address-family ipv4
   ...
   vrf IT-Tenant-inband-mgmt
      ...
      router-id 172.21.2.5
      update wait-install
      neighbor 10.210.241.53 peer group CORES-EBGP-PEERS-inband-mgmtVRF
      neighbor 10.210.241.53 description ismcr01a-Eth3/3/1-inband-mgmtVRF
      neighbor 10.210.241.55 peer group CORES-EBGP-PEERS-inband-mgmtVRF
      neighbor 10.210.241.55 description ismcr02a-Eth4/3/1-inband-mgmtVRF
      redistribute connected
      !
      address-family ipv4
         neighbor 10.210.241.53 activate
         neighbor 10.210.241.55 activate
```
