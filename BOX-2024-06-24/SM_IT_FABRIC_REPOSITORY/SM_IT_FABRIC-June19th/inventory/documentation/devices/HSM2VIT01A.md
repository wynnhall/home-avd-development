...
| ---- | -------------- | -- | ---- |
| local | b8fd8c7e329a892fc53bdf08c962a32be9d073c0 | - | - |
...
| ---- | ----- | ------- | -------------- | ------- | -------------- | ----------- | --------- |
| SNMPManager | network-admin | v3 | sha | aes | - | - | b8fd8c7e329a892fc53bdf08c962a32be9d073c0 |

#### SNMP Device Configuration

```eos
!
snmp-server engineID local b8fd8c7e329a892fc53bdf08c962a32be9d073c0
...
snmp-server user SNMPManager network-admin v3 localized b8fd8c7e329a892fc53bdf08c962a32be9d073c0 auth sha <removed> priv aes <removed>
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet49 | [L]_ISMITAGG01AA_Ethernet1 | *trunk | *305,307,309,311,337 | *- | *- | 49 |
| Ethernet50 | [L]_ISMITAGG01BA_Ethernet1 | *trunk | *305,307,309,311,337 | *- | *- | 49 |
...
interface Ethernet49
   description [L]_ISMITAGG01AA_Ethernet1
   no shutdown
   channel-group 49 mode active
!
interface Ethernet50
   description [L]_ISMITAGG01BA_Ethernet1
   no shutdown
   channel-group 49 mode active
```
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel49 | [L]_IT_AGG_LEAFS_Po1 | switched | trunk | 305,307,309,311,337 | - | - | - | - | - | - |
