...
| ---- | -------------- | -- | ---- |
| local | 94c3e048fb1f8160b35e53436f834d7efab70c2e | - | - |
...
| ---- | ----- | ------- | -------------- | ------- | -------------- | ----------- | --------- |
| SNMPManager | network-admin | v3 | sha | aes | - | - | 94c3e048fb1f8160b35e53436f834d7efab70c2e |

#### SNMP Device Configuration

```eos
!
snmp-server engineID local 94c3e048fb1f8160b35e53436f834d7efab70c2e
...
snmp-server user SNMPManager network-admin v3 localized 94c3e048fb1f8160b35e53436f834d7efab70c2e auth sha <removed> priv aes <removed>
