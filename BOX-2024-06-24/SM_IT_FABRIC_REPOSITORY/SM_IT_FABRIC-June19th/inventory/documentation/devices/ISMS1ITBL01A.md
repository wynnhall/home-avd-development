...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | mgmt | 10.210.80.63/21 | 10.210.80.1 |
...
| ------- | -------- | ---------- | ----- |
| - | SM_IT_FABRIC isms1itbl01a | All | Enabled |

#### SNMP EngineID Configuration

| Type | EngineID (Hex) | IP | Port |
| ---- | -------------- | -- | ---- |
| local | 1740362c600df25c9f3f05cb46c7f7b99ddaa4ac | - | - |
...
| ---- | ----- | ------- | -------------- | ------- | -------------- | ----------- | --------- |
| SNMPManager | network-admin | v3 | sha | aes | - | - | 1740362c600df25c9f3f05cb46c7f7b99ddaa4ac |

#### SNMP Device Configuration

```eos
!
snmp-server engineID local 1740362c600df25c9f3f05cb46c7f7b99ddaa4ac
snmp-server location SM_IT_FABRIC isms1itbl01a
...
snmp-server user SNMPManager network-admin v3 localized 1740362c600df25c9f3f05cb46c7f7b99ddaa4ac auth sha <removed> priv aes <removed>
...
| --------- | --------------- | ------------ | --------- |
| IT_BLEAFS | Vlan4094 | 192.168.0.1 | Port-Channel4094 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet31/1 | [L]_MLAG_PEER_isms1itbl02a_Ethernet31/1 | *trunk | *- | *- | *['MLAG'] | 4094 |
| Ethernet32/1 | [L]_MLAG_PEER_isms1itbl02a_Ethernet32/1 | *trunk | *- | *- | *['MLAG'] | 4094 |
...
| --------- | ----------- | -----| ------- | -------------- |
| Ethernet1/1.311 | [L]_ismcr01a-Eth3/3/1-inband-mgmtVRF | l3dot1q | - | 311 |
| Ethernet1/1.525 | [L]_ismcr01a-Eth3/3/1-IT-VRF | l3dot1q | - | 525 |
| Ethernet1/1.633 | [L]_ismcr01a-Eth3/3/1-IoTVRF | l3dot1q | - | 633 |
| Ethernet2/1.311 | [L]_ismcr02a-Eth3/3/1-inband-mgmtVRF | l3dot1q | - | 311 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1/1.311 | [L]_ismcr01a-Eth3/3/1-inband-mgmtVRF | l3dot1q | - | 10.210.241.49/31 | IT-Tenant-inband-mgmt | - | False | - | - |
...
| Ethernet2/1.311 | [L]_ismcr02a-Eth3/3/1-inband-mgmtVRF | l3dot1q | - | 10.210.241.51/31 | IT-Tenant-inband-mgmt | - | False | - | - |
| Ethernet2/1.525 | [L]_ismcr02a-Eth3/3/1-IT-VRF | l3dot1q | - | 10.210.241.3/31 | IT | - | False | - | - |
| Ethernet2/1.633 | [L]_ismcr02a-Eth3/3/1-IoTVRF | l3dot1q | - | 10.210.241.11/31 | IoT | - | False | - | - |
...
interface Ethernet1/1.311
   description [L]_ismcr01a-Eth3/3/1-inband-mgmtVRF
   no shutdown
   encapsulation dot1q vlan 311
   vrf IT-Tenant-inband-mgmt
   ip address 10.210.241.49/31
!
...
interface Ethernet2/1.311
   description [L]_ismcr02a-Eth3/3/1-inband-mgmtVRF
   no shutdown
   encapsulation dot1q vlan 311
   vrf IT-Tenant-inband-mgmt
   ip address 10.210.241.51/31
!
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel4094 | [L]_MLAG_PEER_isms1itbl02a_Po311 | switched | trunk | - | - | ['MLAG'] | - | - | - | - |
...
| 10.210.241.49 | Inherited from peer group CORES-EBGP-PEERS-inband-mgmtVRF | IT-Tenant-inband-mgmt | - | - | Inherited from peer group CORES-EBGP-PEERS-inband-mgmtVRF | - | - | - | - | - | - |
| 10.210.241.51 | Inherited from peer group CORES-EBGP-PEERS-inband-mgmtVRF | IT-Tenant-inband-mgmt | - | - | Inherited from peer group CORES-EBGP-PEERS-inband-mgmtVRF | - | - | - | - | - | - |
...
| 311 | 172.21.2.4:10311 | 10311:10311 | - | - | learned |
...
| IT-Tenant-inband-mgmt | 172.21.2.4:5005 | connected |
...
router bgp 65120.31200
   ...
   vrf IoT
      ...
      neighbor 10.210.241.10 description ismcr02a-Eth3/3/1-IoTVRF
      redistribute connected route-map RM-LOCAL-NETWORKS
      !
      address-family ipv4
   ...
   vrf IT
      ...
      neighbor 10.210.241.2 description ismcr02a-Eth3/3/1-IT-VRF
      redistribute connected route-map RM-LOCAL-NETWORKS
      !
      address-family ipv4
   ...
   vrf IT-Tenant-inband-mgmt
      ...
      router-id 172.21.2.4
      update wait-install
      neighbor 10.210.241.49 peer group CORES-EBGP-PEERS-inband-mgmtVRF
      neighbor 10.210.241.49 description ismcr01a-Eth3/3/1-inband-mgmtVRF
      neighbor 10.210.241.51 peer group CORES-EBGP-PEERS-inband-mgmtVRF
      neighbor 10.210.241.51 description ismcr01a-Eth3/3/1-inband-mgmtVRF
      redistribute connected
      !
      address-family ipv4
         neighbor 10.210.241.49 activate
         neighbor 10.210.241.51 activate
```
