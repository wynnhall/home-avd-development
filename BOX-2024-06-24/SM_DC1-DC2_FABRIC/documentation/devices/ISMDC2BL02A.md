...
| ------- | -------- | ---------- | ----- |
| - | SM_DC1-DC2_FABRIC SM_DC2_FABRIC ismdc2bl02a | All | Enabled |

#### SNMP EngineID Configuration

| Type | EngineID (Hex) | IP | Port |
| ---- | -------------- | -- | ---- |
| local | 1c1a5b5b6839de7dfea845c818199aebda9f1607 | - | - |
...
| ---- | ----- | ------- | -------------- | ------- | -------------- | ----------- | --------- |
| SNMPManager | network-admin | v3 | sha | aes | - | - | 1c1a5b5b6839de7dfea845c818199aebda9f1607 |

#### SNMP Device Configuration

```eos
!
snmp-server engineID local 1c1a5b5b6839de7dfea845c818199aebda9f1607
snmp-server location SM_DC1-DC2_FABRIC SM_DC2_FABRIC ismdc2bl02a
...
snmp-server user SNMPManager network-admin v3 localized 1c1a5b5b6839de7dfea845c818199aebda9f1607 auth sha <removed> priv aes <removed>
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet31/1 | [L]_MLAG_PEER_ismdc2bl01a_Ethernet31/1 | *trunk | *- | *- | *['MLAG'] | 4094 |
| Ethernet32/1 | [L]_MLAG_PEER_ismdc2bl01a_Ethernet32/1 | *trunk | *- | *- | *['MLAG'] | 4094 |
...
| Ethernet5/1.533 | [L]_isms1otbl01a-Eth4/1-OTVRF | l3dot1q | - | 533 |
| Ethernet6/1.533 | [L]_isms1otbl02a-Eth4/1-OTVRF | l3dot1q | - | 533 |
...
| Ethernet5/1.533 | [L]_isms1otbl01a-Eth4/1-OTVRF | l3dot1q | - | 10.210.234.13/31 | OT | - | False | - | - |
| Ethernet6/1.533 | [L]_isms1otbl02a-Eth4/1-OTVRF | l3dot1q | - | 10.210.234.15/31 | OT | - | False | - | - |
...
interface Ethernet5/1.533
   description [L]_isms1otbl01a-Eth4/1-OTVRF
   no shutdown
   encapsulation dot1q vlan 533
   vrf OT
...
interface Ethernet6/1.533
   description [L]_isms1otbl02a-Eth4/1-OTVRF
   no shutdown
   encapsulation dot1q vlan 533
   vrf OT
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel4094 | [L]_MLAG_PEER_ismdc2bl01a_Po311 | switched | trunk | - | - | ['MLAG'] | - | - | - | - |
...
router bgp 65120.12200
   ...
   vrf OT
      ...
      neighbor 10.210.234.12 description isms1otbl01a-Eth4/1-OTVRF
      neighbor 10.210.234.14 peer group S1-OT-BL-EBGP-PEERS-OTVRF
      neighbor 10.210.234.14 description isms1otbl02a-Eth4/1-OTVRF
      redistribute connected route-map RM-LOCAL-NETWORKS
      !
      address-family ipv4
