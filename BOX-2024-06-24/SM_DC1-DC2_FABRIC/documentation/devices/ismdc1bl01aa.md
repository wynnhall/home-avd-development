...
| ------- | -------- | ---------- | ----- |
| - | SM_DC1-DC2_FABRIC SM_DC1_FABRIC ismdc1bl01aa | All | Enabled |

#### SNMP EngineID Configuration

| Type | EngineID (Hex) | IP | Port |
| ---- | -------------- | -- | ---- |
| local | 256818749d4db4b7d2b8e643136b8ef7764f0e7b | - | - |
...
| ---- | ----- | ------- | -------------- | ------- | -------------- | ----------- | --------- |
| SNMPManager | network-admin | v3 | sha | aes | - | - | 256818749d4db4b7d2b8e643136b8ef7764f0e7b |

#### SNMP Device Configuration

```eos
!
snmp-server engineID local 256818749d4db4b7d2b8e643136b8ef7764f0e7b
snmp-server location SM_DC1-DC2_FABRIC SM_DC1_FABRIC ismdc1bl01aa
...
snmp-server user SNMPManager network-admin v3 localized 256818749d4db4b7d2b8e643136b8ef7764f0e7b auth sha <removed> priv aes <removed>
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet31/1 | [L]_MLAG_PEER_ismdc1bl01ba_Ethernet31/1 | *trunk | *- | *- | *['MLAG'] | 4094 |
| Ethernet32/1 | [L]_MLAG_PEER_ismdc1bl01ba_Ethernet32/1 | *trunk | *- | *- | *['MLAG'] | 4094 |
...
| Ethernet5/1.533 | [L]_isms1otbl01aa-Eth1/1-OTVRF | l3dot1q | - | 533 |
| Ethernet6/1.533 | [L]_isms1otbl01ba-Eth1/1-OTVRF | l3dot1q | - | 533 |
...
| Ethernet3/1 | P2P_LINK_TO_ismdc2bl01aa_Ethernet3/1 | routed | - | 10.210.226.8/31 | default | 9214 | False | - | - |
| Ethernet4/1 | P2P_LINK_TO_ismdc2bl01ba_Ethernet3/1 | routed | - | 10.210.226.10/31 | default | 9214 | False | - | - |
| Ethernet5/1.533 | [L]_isms1otbl01aa-Eth1/1-OTVRF | l3dot1q | - | 10.210.226.17/31 | OT | - | False | - | - |
| Ethernet6/1.533 | [L]_isms1otbl01ba-Eth1/1-OTVRF | l3dot1q | - | 10.210.226.19/31 | OT | - | False | - | - |
...
interface Ethernet3/1
   description P2P_LINK_TO_ismdc2bl01aa_Ethernet3/1
   no shutdown
   mtu 9214
   no switchport
...
interface Ethernet4/1
   description P2P_LINK_TO_ismdc2bl01ba_Ethernet3/1
   no shutdown
   mtu 9214
   no switchport
...
interface Ethernet5/1.533
   description [L]_isms1otbl01aa-Eth1/1-OTVRF
   no shutdown
   encapsulation dot1q vlan 533
   vrf OT
...
interface Ethernet6/1.533
   description [L]_isms1otbl01ba-Eth1/1-OTVRF
   no shutdown
   encapsulation dot1q vlan 533
   vrf OT
...
interface Ethernet31/1
   description [L]_MLAG_PEER_ismdc1bl01ba_Ethernet31/1
   no shutdown
   channel-group 4094 mode active
!
interface Ethernet32/1
   description [L]_MLAG_PEER_ismdc1bl01ba_Ethernet32/1
   no shutdown
   channel-group 4094 mode active
```
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel4094 | [L]_MLAG_PEER_ismdc1bl01ba_Po311 | switched | trunk | - | - | ['MLAG'] | - | - | - | - |
...
interface Port-Channel4094
   description [L]_MLAG_PEER_ismdc1bl01ba_Po311
   no shutdown
   switchport
...
| 239 | 172.21.0.24:10239 | 10239:10239<br>remote 10239:10239 | - | - | learned |
...
router bgp 65120.11200
   ...
   neighbor MLAG-IPv4-UNDERLAY-PEER description ismdc1bl01ba
   ...
   !
   vlan 239
      rd 172.21.0.24:10239
      rd evpn domain remote 172.21.0.24:10239
   ...
   vrf OT
      ...
      neighbor 10.210.226.16 description isms1otbl01aa-Eth1/1-OTVRF
      neighbor 10.210.226.18 peer group S1-OT-BL-EBGP-PEERS-OTVRF
      neighbor 10.210.226.18 description isms1otbl01ba-Eth1/1-OTVRF
      redistribute connected route-map RM-LOCAL-NETWORKS
      !
      address-family ipv4
