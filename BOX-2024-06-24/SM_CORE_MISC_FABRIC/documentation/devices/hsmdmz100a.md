...
| ------- | -------- | ---------- | ----- |
| - | SM_CORE_MISC_FABRIC [SM_CORE_MISC_FABRIC] hsmdmz100a | All | Enabled |

#### SNMP EngineID Configuration

| Type | EngineID (Hex) | IP | Port |
| ---- | -------------- | -- | ---- |
| local | 0494effa524a31f605d4856a9cd218b9ff3709e3 | - | - |
...
| ---- | ----- | ------- | -------------- | ------- | -------------- | ----------- | --------- |
| SNMPManager | network-admin | v3 | sha | aes | - | - | 0494effa524a31f605d4856a9cd218b9ff3709e3 |

#### SNMP Device Configuration

```eos
!
snmp-server engineID local 0494effa524a31f605d4856a9cd218b9ff3709e3
snmp-server location SM_CORE_MISC_FABRIC [SM_CORE_MISC_FABRIC] hsmdmz100a
...
snmp-server user SNMPManager network-admin v3 localized 0494effa524a31f605d4856a9cd218b9ff3709e3 auth sha <removed> priv aes <removed>
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet49 |  [L]_CSMISP02_ISP#1 Circuit | access | 1997 | - | - | - |
| Ethernet51 |  [L]_ismpan98_Eth13 | access | 1997 | - | - | - |
| Ethernet52 |  [L]_ismpan99_Eth13 | access | 1997 | - | - | - |
...
interface Ethernet49
   description [L]_CSMISP02_ISP#1 Circuit
   no shutdown
   switchport access vlan 1997
