...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | mgmt | 10.211.240.209/22 | 10.211.240.209 |
...
| ------- | -------- | ---------- | ----- |
| - | S1-OT_FABRIC HS11HEOT02A | All | Enabled |

#### SNMP EngineID Configuration

| Type | EngineID (Hex) | IP | Port |
| ---- | -------------- | -- | ---- |
| local | 2f288055a91d8c9b7fd838d8ed744d15ef7a6de2 | - | - |
...
| ---- | ----- | ------- | -------------- | ------- | -------------- | ----------- | --------- |
| SNMPManager | network-admin | v3 | sha | aes | - | - | 2f288055a91d8c9b7fd838d8ed744d15ef7a6de2 |

#### SNMP Device Configuration

```eos
!
snmp-server engineID local 2f288055a91d8c9b7fd838d8ed744d15ef7a6de2
snmp-server location S1-OT_FABRIC HS11HEOT02A
...
snmp-server user SNMPManager network-admin v3 localized 2f288055a91d8c9b7fd838d8ed744d15ef7a6de2 auth sha <removed> priv aes <removed>
...
| --- | ------------------ | ----------- | -------------- | ----------------------- | --- | ---------- | ------ |
| mgmt | 0.0.0.0/0 | 10.211.240.209 | - | 1 | - | - | - |

#### Static Routes Device Configuration

```eos
!
ip route vrf mgmt 0.0.0.0/0 10.211.240.209
```
