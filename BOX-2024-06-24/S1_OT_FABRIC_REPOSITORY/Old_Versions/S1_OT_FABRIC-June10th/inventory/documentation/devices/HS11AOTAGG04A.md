...
| ------- | -------- | ---------- | ----- |
| - | S1_OT_FABRIC hs11aotagg04a | All | Enabled |

#### SNMP EngineID Configuration

| Type | EngineID (Hex) | IP | Port |
| ---- | -------------- | -- | ---- |
| local | b5d4a96834f1f4bd617c92f21037e9b897ca7a5a | - | - |
...
| ---- | ----- | ------- | -------------- | ------- | -------------- | ----------- | --------- |
| SNMPManager | network-admin | v3 | sha | aes | - | - | b5d4a96834f1f4bd617c92f21037e9b897ca7a5a |

#### SNMP Device Configuration

```eos
!
snmp-server engineID local b5d4a96834f1f4bd617c92f21037e9b897ca7a5a
snmp-server location S1_OT_FABRIC hs11aotagg04a
...
snmp-server user SNMPManager network-admin v3 localized b5d4a96834f1f4bd617c92f21037e9b897ca7a5a auth sha <removed> priv aes <removed>
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet1 | [L]_HS11AOT14A_Ethernet50 | *trunk | *none | *- | *- | 1 |
| Ethernet2 | [L]_HS11AOT15A_Ethernet50 | *trunk | *none | *- | *- | 2 |
| Ethernet3 | [L]_HS11AOT16A_Ethernet50 | *trunk | *none | *- | *- | 3 |
| Ethernet4 | [L]_HS11AOT17A_Ethernet50 | *trunk | *none | *- | *- | 4 |
| Ethernet5 | [L]_HS11AOT18A_Ethernet50 | *trunk | *none | *- | *- | 5 |
| Ethernet6 | [L]_HS11AOT19A_Ethernet50 | *trunk | *none | *- | *- | 6 |
| Ethernet7 | [L]_HS11AOT20A_Ethernet50 | *trunk | *none | *- | *- | 7 |
| Ethernet8 | [L]_HS11AOT21A_Ethernet50 | *trunk | *none | *- | *- | 8 |
| Ethernet9 | [L]_HS11AOT22A_Ethernet50 | *trunk | *none | *- | *- | 9 |
| Ethernet10 | [L]_HS11AOT23A_Ethernet50 | *trunk | *none | *- | *- | 10 |
| Ethernet11 | [L]_HS11AOT24A_Ethernet50 | *trunk | *none | *- | *- | 11 |
| Ethernet12 | [L]_HS11AOT25A_Ethernet50 | *trunk | *none | *- | *- | 12 |
| Ethernet55/1 | [L]_MLAG_PEER_hs11aotagg03a_Ethernet55/1 | *trunk | *- | *- | *['MLAG'] | 4094 |
| Ethernet56/1 | [L]_MLAG_PEER_hs11aotagg03a_Ethernet56/1 | *trunk | *- | *- | *['MLAG'] | 4094 |
...
interface Ethernet55/1
   description [L]_MLAG_PEER_hs11aotagg03a_Ethernet55/1
   no shutdown
   channel-group 4094 mode active
!
interface Ethernet56/1
   description [L]_MLAG_PEER_hs11aotagg03a_Ethernet56/1
   no shutdown
   channel-group 4094 mode active
```
...
| Port-Channel4094 | [L]_MLAG_PEER_hs11aotagg03a_Po551 | switched | trunk | - | - | ['MLAG'] | - | - | - | - |
...
interface Port-Channel4094
   description [L]_MLAG_PEER_hs11aotagg03a_Po551
   no shutdown
   switchport
   switchport mode trunk
...
!
interface Vxlan1
   description hs11aotagg04a_VTEP
...
router bgp 65120.21208
   ...
   neighbor MLAG-IPv4-UNDERLAY-PEER description hs11aotagg03a
