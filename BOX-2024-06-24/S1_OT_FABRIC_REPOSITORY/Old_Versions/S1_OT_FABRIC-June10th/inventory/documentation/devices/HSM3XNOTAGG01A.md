...
| ---- | -------------- | -- | ---- |
| local | 62818994ebaf4edbcefe3ebf383b3d6162668bed | - | - |
...
| ---- | ----- | ------- | -------------- | ------- | -------------- | ----------- | --------- |
| SNMPManager | network-admin | v3 | sha | aes | - | - | 62818994ebaf4edbcefe3ebf383b3d6162668bed |

#### SNMP Device Configuration

```eos
!
snmp-server engineID local 62818994ebaf4edbcefe3ebf383b3d6162668bed
...
snmp-server user SNMPManager network-admin v3 localized 62818994ebaf4edbcefe3ebf383b3d6162668bed auth sha <removed> priv aes <removed>
