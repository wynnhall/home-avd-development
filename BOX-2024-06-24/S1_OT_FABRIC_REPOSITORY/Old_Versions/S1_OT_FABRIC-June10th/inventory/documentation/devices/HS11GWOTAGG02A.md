...
| ---- | -------------- | -- | ---- |
| local | 6988ab7b7b8221a9fcabbe74be0d77695c7f567b | - | - |
...
| ---- | ----- | ------- | -------------- | ------- | -------------- | ----------- | --------- |
| SNMPManager | network-admin | v3 | sha | aes | - | - | 6988ab7b7b8221a9fcabbe74be0d77695c7f567b |

#### SNMP Device Configuration

```eos
!
snmp-server engineID local 6988ab7b7b8221a9fcabbe74be0d77695c7f567b
...
snmp-server user SNMPManager network-admin v3 localized 6988ab7b7b8221a9fcabbe74be0d77695c7f567b auth sha <removed> priv aes <removed>
