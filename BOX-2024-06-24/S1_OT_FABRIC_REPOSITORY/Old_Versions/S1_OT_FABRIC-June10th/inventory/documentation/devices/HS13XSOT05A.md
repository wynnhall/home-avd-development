...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | mgmt | 10.215.242.49/23 | 10.211.240.1 |
...
| ---- | -------------- | -- | ---- |
| local | af68c69cd3b4a2cbceefac58d2d7d109d3bbdbec | - | - |
...
| ---- | ----- | ------- | -------------- | ------- | -------------- | ----------- | --------- |
| SNMPManager | network-admin | v3 | sha | aes | - | - | af68c69cd3b4a2cbceefac58d2d7d109d3bbdbec |

#### SNMP Device Configuration

```eos
!
snmp-server engineID local af68c69cd3b4a2cbceefac58d2d7d109d3bbdbec
...
snmp-server user SNMPManager network-admin v3 localized af68c69cd3b4a2cbceefac58d2d7d109d3bbdbec auth sha <removed> priv aes <removed>
