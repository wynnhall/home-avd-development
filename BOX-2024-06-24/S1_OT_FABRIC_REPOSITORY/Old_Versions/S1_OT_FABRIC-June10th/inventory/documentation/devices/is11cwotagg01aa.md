...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | mgmt | 10.211.240.48/22 | 10.211.240.1 |
...
| ------- | -------- | ---------- | ----- |
| - | S1_OT_FABRIC is11cwotagg01aa | All | Enabled |

#### SNMP EngineID Configuration

| Type | EngineID (Hex) | IP | Port |
| ---- | -------------- | -- | ---- |
| local | 24d395188e376bc8b199fe1669d3f0c146f49f3a | - | - |
...
| ---- | ----- | ------- | -------------- | ------- | -------------- | ----------- | --------- |
| SNMPManager | network-admin | v3 | sha | aes | - | - | 24d395188e376bc8b199fe1669d3f0c146f49f3a |

#### SNMP Device Configuration

```eos
!
snmp-server engineID local 24d395188e376bc8b199fe1669d3f0c146f49f3a
snmp-server location S1_OT_FABRIC is11cwotagg01aa
...
snmp-server user SNMPManager network-admin v3 localized 24d395188e376bc8b199fe1669d3f0c146f49f3a auth sha <removed> priv aes <removed>
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet1 | [L]_HS11CWOT01A_Ethernet49 | *trunk | *349 | *- | *- | 1 |
| Ethernet2 | [L]_HS11CWOT02A_Ethernet49 | *trunk | *349 | *- | *- | 2 |
| Ethernet3 | [L]_HS11CWOT03A_Ethernet49 | *trunk | *349 | *- | *- | 3 |
| Ethernet4 | [L]_HS11CWOT04A_Ethernet49 | *trunk | *349 | *- | *- | 4 |
| Ethernet5 | [L]_HS11CWOT05A_Ethernet49 | *trunk | *349 | *- | *- | 5 |
| Ethernet6 | [L]_HS11CWOT06A_Ethernet49 | *trunk | *349 | *- | *- | 6 |
| Ethernet7 | [L]_HS11CWOT07A_Ethernet49 | *trunk | *349 | *- | *- | 7 |
| Ethernet8 | [L]_HS11CWOT08A_Ethernet49 | *trunk | *349 | *- | *- | 8 |
| Ethernet9 | [L]_HS11CWOT09A_Ethernet49 | *trunk | *349 | *- | *- | 9 |
| Ethernet10 | [L]_HS11CWOT10A_Ethernet49 | *trunk | *349 | *- | *- | 10 |
| Ethernet55/1 | [L]_MLAG_PEER_is11cwotagg01ba_Ethernet55/1 | *trunk | *- | *- | *['MLAG'] | 4094 |
| Ethernet56/1 | [L]_MLAG_PEER_is11cwotagg01ba_Ethernet56/1 | *trunk | *- | *- | *['MLAG'] | 4094 |
...
!
interface Ethernet1
   description [L]_HS11CWOT01A_Ethernet49
   no shutdown
   channel-group 1 mode active
!
interface Ethernet2
   description [L]_HS11CWOT02A_Ethernet49
   no shutdown
   channel-group 2 mode active
!
interface Ethernet3
   description [L]_HS11CWOT03A_Ethernet49
   no shutdown
   channel-group 3 mode active
!
interface Ethernet4
   description [L]_HS11CWOT04A_Ethernet49
   no shutdown
   channel-group 4 mode active
!
interface Ethernet5
   description [L]_HS11CWOT05A_Ethernet49
   no shutdown
   channel-group 5 mode active
!
interface Ethernet6
   description [L]_HS11CWOT06A_Ethernet49
   no shutdown
   channel-group 6 mode active
!
interface Ethernet7
   description [L]_HS11CWOT07A_Ethernet49
   no shutdown
   channel-group 7 mode active
!
interface Ethernet8
   description [L]_HS11CWOT08A_Ethernet49
   no shutdown
   channel-group 8 mode active
!
interface Ethernet9
   description [L]_HS11CWOT09A_Ethernet49
   no shutdown
   channel-group 9 mode active
!
interface Ethernet10
   description [L]_HS11CWOT10A_Ethernet49
   no shutdown
...
interface Ethernet55/1
   description [L]_MLAG_PEER_is11cwotagg01ba_Ethernet55/1
   no shutdown
   channel-group 4094 mode active
!
interface Ethernet56/1
   description [L]_MLAG_PEER_is11cwotagg01ba_Ethernet56/1
   no shutdown
   channel-group 4094 mode active
```
...
| Port-Channel4094 | [L]_MLAG_PEER_is11cwotagg01ba_Po551 | switched | trunk | - | - | ['MLAG'] | - | - | - | - |
...
interface Port-Channel4094
   description [L]_MLAG_PEER_is11cwotagg01ba_Po551
   no shutdown
   switchport
   switchport mode trunk
...
!
interface Vxlan1
   description is11cwotagg01aa_VTEP
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 349 | 172.21.3.26:10349 | 10349:10349 | - | - | learned |
...
router bgp 65120.21212
   ...
   neighbor MLAG-IPv4-UNDERLAY-PEER description is11cwotagg01ba
