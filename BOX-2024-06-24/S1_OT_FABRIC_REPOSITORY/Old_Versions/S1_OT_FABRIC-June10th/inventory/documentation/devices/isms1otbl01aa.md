...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | mgmt | 10.210.80.70/21 | 10.210.80.1 |
...
| ------- | -------- | ---------- | ----- |
| - | S1_OT_FABRIC isms1otbl01aa | All | Enabled |

#### SNMP EngineID Configuration

| Type | EngineID (Hex) | IP | Port |
| ---- | -------------- | -- | ---- |
| local | 2eee7c8c24414033b03818fe28cd61d9c5b19649 | - | - |
...
| ---- | ----- | ------- | -------------- | ------- | -------------- | ----------- | --------- |
| SNMPManager | network-admin | v3 | sha | aes | - | - | 2eee7c8c24414033b03818fe28cd61d9c5b19649 |

#### SNMP Device Configuration

```eos
!
snmp-server engineID local 2eee7c8c24414033b03818fe28cd61d9c5b19649
snmp-server location S1_OT_FABRIC isms1otbl01aa
...
snmp-server user SNMPManager network-admin v3 localized 2eee7c8c24414033b03818fe28cd61d9c5b19649 auth sha <removed> priv aes <removed>
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet31/1 | [L]_MLAG_PEER_isms1otbl01ba_Ethernet31/1 | *trunk | *- | *- | *['MLAG'] | 4094 |
| Ethernet32/1 | [L]_MLAG_PEER_isms1otbl01ba_Ethernet32/1 | *trunk | *- | *- | *['MLAG'] | 4094 |
...
| --------- | ----------- | -----| ------- | -------------- |
| Ethernet1/1.533 | [L]_ismdc1bl01aa-Eth5/1-OT-VRF | l3dot1q | - | 533 |
| Ethernet2/1.533 | [L]_ismdc1bl01ba-Eth5/1-OT-VRF | l3dot1q | - | 533 |
| Ethernet3/1.533 | [L]_ismdc2bl01aa-Eth5/1-OT-VRF | l3dot1q | - | 533 |
| Ethernet4/1.533 | [L]_ismdc2bl01ba-Eth5/1-OT-VRF | l3dot1q | - | 533 |

##### IPv4

| Interface | Description | Type | Channel Group | IP Address | VRF |  MTU | Shutdown | ACL In | ACL Out |
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1/1.533 | [L]_ismdc1bl01aa-Eth5/1-OT-VRF | l3dot1q | - | 10.210.226.16/31 | OT | - | False | - | - |
| Ethernet2/1.533 | [L]_ismdc1bl01ba-Eth5/1-OT-VRF | l3dot1q | - | 10.210.226.20/31 | OT | - | False | - | - |
| Ethernet3/1.533 | [L]_ismdc2bl01aa-Eth5/1-OT-VRF | l3dot1q | - | 10.210.234.8/31 | OT | - | False | - | - |
| Ethernet4/1.533 | [L]_ismdc2bl01ba-Eth5/1-OT-VRF | l3dot1q | - | 10.210.234.12/31 | OT | - | False | - | - |
...
interface Ethernet1/1.533
   description [L]_ismdc1bl01aa-Eth5/1-OT-VRF
   no shutdown
...
interface Ethernet2/1.533
   description [L]_ismdc1bl01ba-Eth5/1-OT-VRF
   no shutdown
   encapsulation dot1q vlan 533
   vrf OT
...
interface Ethernet3/1.533
   description [L]_ismdc2bl01aa-Eth5/1-OT-VRF
   no shutdown
   encapsulation dot1q vlan 533
   vrf OT
...
interface Ethernet4/1.533
   description [L]_ismdc2bl01ba-Eth5/1-OT-VRF
   no shutdown
   encapsulation dot1q vlan 533
   vrf OT
...
interface Ethernet31/1
   description [L]_MLAG_PEER_isms1otbl01ba_Ethernet31/1
   no shutdown
   channel-group 4094 mode active
!
interface Ethernet32/1
   description [L]_MLAG_PEER_isms1otbl01ba_Ethernet32/1
   no shutdown
   channel-group 4094 mode active
```
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel4094 | [L]_MLAG_PEER_isms1otbl01ba_Po311 | switched | trunk | - | - | ['MLAG'] | - | - | - | - |
...
interface Port-Channel4094
   description [L]_MLAG_PEER_isms1otbl01ba_Po311
   no shutdown
   switchport
...
!
interface Vxlan1
   description isms1otbl01aa_VTEP
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 349 | 172.21.3.40:10349 | 10349:10349 | - | - | learned |
...
router bgp 65120.21200
   ...
   neighbor MLAG-IPv4-UNDERLAY-PEER description isms1otbl01ba
   ...
   vrf OT
      ...
      neighbor 10.210.226.17 description ismdc1bl01aa-Eth5/1-OT-VRF
      neighbor 10.210.226.21 peer group DC1-BL-EBGP-PEERS-OTVRF
      neighbor 10.210.226.21 description ismdc1bl01ba-Eth5/1-OT-VRF
      neighbor 10.210.234.9 peer group DC2-BL-EBGP-PEERS-OTVRF
      neighbor 10.210.234.9 description ismdc2bl01aa-Eth5/1-OT-VRF
      neighbor 10.210.234.13 peer group DC2-BL-EBGP-PEERS-OTVRF
      neighbor 10.210.234.13 description ismdc2bl01ba-Eth5/1-OT-VRF
