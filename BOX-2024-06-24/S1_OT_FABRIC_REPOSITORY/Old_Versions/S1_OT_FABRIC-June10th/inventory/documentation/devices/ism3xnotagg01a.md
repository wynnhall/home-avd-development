...
| ------- | -------- | ---------- | ----- |
| - | S1_OT_FABRIC ism3xnotagg01a | All | Enabled |

#### SNMP EngineID Configuration

| Type | EngineID (Hex) | IP | Port |
| ---- | -------------- | -- | ---- |
| local | 6cdc6f09342a67058cca777df3637ecabc5562d1 | - | - |
...
| ---- | ----- | ------- | -------------- | ------- | -------------- | ----------- | --------- |
| SNMPManager | network-admin | v3 | sha | aes | - | - | 6cdc6f09342a67058cca777df3637ecabc5562d1 |

#### SNMP Device Configuration

```eos
!
snmp-server engineID local 6cdc6f09342a67058cca777df3637ecabc5562d1
snmp-server location S1_OT_FABRIC ism3xnotagg01a
...
snmp-server user SNMPManager network-admin v3 localized 6cdc6f09342a67058cca777df3637ecabc5562d1 auth sha <removed> priv aes <removed>
...
| Ethernet55/1 | [L]_MLAG_PEER_ism3xnotagg02a_Ethernet55/1 | *trunk | *- | *- | *['MLAG'] | 4094 |
| Ethernet56/1 | [L]_MLAG_PEER_ism3xnotagg02a_Ethernet56/1 | *trunk | *- | *- | *['MLAG'] | 4094 |
...
interface Ethernet55/1
   description [L]_MLAG_PEER_ism3xnotagg02a_Ethernet55/1
   no shutdown
   channel-group 4094 mode active
!
interface Ethernet56/1
   description [L]_MLAG_PEER_ism3xnotagg02a_Ethernet56/1
   no shutdown
   channel-group 4094 mode active
```
...
| Port-Channel4094 | [L]_MLAG_PEER_ism3xnotagg02a_Po551 | switched | trunk | - | - | ['MLAG'] | - | - | - | - |
...
interface Port-Channel4094
   description [L]_MLAG_PEER_ism3xnotagg02a_Po551
   no shutdown
   switchport
   switchport mode trunk
...
!
interface Vxlan1
   description ism3xnotagg01a_VTEP
...
router bgp 65120.21217
   ...
   neighbor MLAG-IPv4-UNDERLAY-PEER description ism3xnotagg02a
