...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | mgmt | 10.211.240.47/22 | 10.211.240.1 |
...
| ------- | -------- | ---------- | ----- |
| - | S1_OT_FABRIC is11ewotagg01ba | All | Enabled |

#### SNMP EngineID Configuration

| Type | EngineID (Hex) | IP | Port |
| ---- | -------------- | -- | ---- |
| local | 8b96f82554f120bf6800640cd34152d9cb3f4b2f | - | - |
...
| ---- | ----- | ------- | -------------- | ------- | -------------- | ----------- | --------- |
| SNMPManager | network-admin | v3 | sha | aes | - | - | 8b96f82554f120bf6800640cd34152d9cb3f4b2f |

#### SNMP Device Configuration

```eos
!
snmp-server engineID local 8b96f82554f120bf6800640cd34152d9cb3f4b2f
snmp-server location S1_OT_FABRIC is11ewotagg01ba
...
snmp-server user SNMPManager network-admin v3 localized 8b96f82554f120bf6800640cd34152d9cb3f4b2f auth sha <removed> priv aes <removed>
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet1 | [L]_HS11EWOT01A_Ethernet50 | *trunk | *349 | *- | *- | 1 |
| Ethernet2 | [L]_HS11EWOT02A_Ethernet50 | *trunk | *349 | *- | *- | 2 |
| Ethernet3 | [L]_HS11EWOT03A_Ethernet50 | *trunk | *349 | *- | *- | 3 |
| Ethernet4 | [L]_HS11EWOT04A_Ethernet50 | *trunk | *349 | *- | *- | 4 |
| Ethernet5 | [L]_HS11EWOT05A_Ethernet50 | *trunk | *349 | *- | *- | 5 |
| Ethernet6 | [L]_HS11EWOT06A_Ethernet50 | *trunk | *349 | *- | *- | 6 |
| Ethernet7 | [L]_HS11EWOT07A_Ethernet50 | *trunk | *349 | *- | *- | 7 |
| Ethernet8 | [L]_HS11EWOT08A_Ethernet50 | *trunk | *349 | *- | *- | 8 |
| Ethernet9 | [L]_HS11EWOT09A_Ethernet50 | *trunk | *349 | *- | *- | 9 |
| Ethernet10 | [L]_HS11EWOT10A_Ethernet50 | *trunk | *349 | *- | *- | 10 |
| Ethernet55/1 | [L]_MLAG_PEER_is11ewotagg01aa_Ethernet55/1 | *trunk | *- | *- | *['MLAG'] | 4094 |
| Ethernet56/1 | [L]_MLAG_PEER_is11ewotagg01aa_Ethernet56/1 | *trunk | *- | *- | *['MLAG'] | 4094 |
...
| --------- | ----------- | ---- | --------------| ------------ | --- | --- | -------- | -------------- | -------------------| ----------- | ------------ |
| Ethernet49/1 | [L]_P2P_LINK_TO_ISMS1OTSP01A_Ethernet9/3/1 | routed | - | - | default | 9214 | False | - | - | - | - |
| Ethernet50/1 | [L]_P2P_LINK_TO_ISMS1OTSP02A_Ethernet9/3/1 | routed | - | - | default | 9214 | False | - | - | - | - |
| Ethernet51/1 | [L]_P2P_LINK_TO_ISMS1OTSP03A_Ethernet9/3/1 | routed | - | - | default | 9214 | False | - | - | - | - |
...
!
interface Ethernet1
   description [L]_HS11EWOT01A_Ethernet50
   no shutdown
   channel-group 1 mode active
!
interface Ethernet2
   description [L]_HS11EWOT02A_Ethernet50
   no shutdown
   channel-group 2 mode active
!
interface Ethernet3
   description [L]_HS11EWOT03A_Ethernet50
   no shutdown
   channel-group 3 mode active
!
interface Ethernet4
   description [L]_HS11EWOT04A_Ethernet50
   no shutdown
   channel-group 4 mode active
!
interface Ethernet5
   description [L]_HS11EWOT05A_Ethernet50
   no shutdown
   channel-group 5 mode active
!
interface Ethernet6
   description [L]_HS11EWOT06A_Ethernet50
   no shutdown
   channel-group 6 mode active
!
interface Ethernet7
   description [L]_HS11EWOT07A_Ethernet50
   no shutdown
   channel-group 7 mode active
!
interface Ethernet8
   description [L]_HS11EWOT08A_Ethernet50
   no shutdown
   channel-group 8 mode active
!
interface Ethernet9
   description [L]_HS11EWOT09A_Ethernet50
   no shutdown
   channel-group 9 mode active
!
interface Ethernet10
   description [L]_HS11EWOT10A_Ethernet50
   no shutdown
   channel-group 10 mode active
!
interface Ethernet49/1
   description [L]_P2P_LINK_TO_ISMS1OTSP01A_Ethernet9/3/1
   no shutdown
   mtu 9214
   no switchport
   ipv6 enable
...
interface Ethernet50/1
   description [L]_P2P_LINK_TO_ISMS1OTSP02A_Ethernet9/3/1
   no shutdown
   mtu 9214
   no switchport
   ipv6 enable
...
interface Ethernet51/1
   description [L]_P2P_LINK_TO_ISMS1OTSP03A_Ethernet9/3/1
   no shutdown
   mtu 9214
   no switchport
   ipv6 enable
...
interface Ethernet55/1
   description [L]_MLAG_PEER_is11ewotagg01aa_Ethernet55/1
   no shutdown
   channel-group 4094 mode active
!
interface Ethernet56/1
   description [L]_MLAG_PEER_is11ewotagg01aa_Ethernet56/1
   no shutdown
   channel-group 4094 mode active
```
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel1 | [L]_HS11EWOT01A_Po49 | switched | trunk | 349 | - | - | - | - | 1 | - |
| Port-Channel2 | [L]_HS11EWOT02A_Po49 | switched | trunk | 349 | - | - | - | - | 2 | - |
| Port-Channel3 | [L]_HS11EWOT03A_Po49 | switched | trunk | 349 | - | - | - | - | 3 | - |
| Port-Channel4 | [L]_HS11EWOT04A_Po49 | switched | trunk | 349 | - | - | - | - | 4 | - |
| Port-Channel5 | [L]_HS11EWOT05A_Po49 | switched | trunk | 349 | - | - | - | - | 5 | - |
| Port-Channel6 | [L]_HS11EWOT06A_Po49 | switched | trunk | 349 | - | - | - | - | 6 | - |
| Port-Channel7 | [L]_HS11EWOT07A_Po49 | switched | trunk | 349 | - | - | - | - | 7 | - |
| Port-Channel8 | [L]_HS11EWOT08A_Po49 | switched | trunk | 349 | - | - | - | - | 8 | - |
| Port-Channel9 | [L]_HS11EWOT09A_Po49 | switched | trunk | 349 | - | - | - | - | 9 | - |
| Port-Channel10 | [L]_HS11EWOT10A_Po49 | switched | trunk | 349 | - | - | - | - | 10 | - |
| Port-Channel4094 | [L]_MLAG_PEER_is11ewotagg01aa_Po551 | switched | trunk | - | - | ['MLAG'] | - | - | - | - |
...
interface Port-Channel1
   description [L]_HS11EWOT01A_Po49
   no shutdown
   switchport
...
interface Port-Channel2
   description [L]_HS11EWOT02A_Po49
   no shutdown
   switchport
   switchport trunk allowed vlan 349
   switchport mode trunk
...
interface Port-Channel3
   description [L]_HS11EWOT03A_Po49
   no shutdown
   switchport
   switchport trunk allowed vlan 349
   switchport mode trunk
...
interface Port-Channel4
   description [L]_HS11EWOT04A_Po49
   no shutdown
   switchport
   switchport trunk allowed vlan 349
   switchport mode trunk
...
interface Port-Channel5
   description [L]_HS11EWOT05A_Po49
   no shutdown
   switchport
   switchport trunk allowed vlan 349
   switchport mode trunk
...
interface Port-Channel6
   description [L]_HS11EWOT06A_Po49
   no shutdown
   switchport
   switchport trunk allowed vlan 349
   switchport mode trunk
...
interface Port-Channel7
   description [L]_HS11EWOT07A_Po49
   no shutdown
   switchport
   switchport trunk allowed vlan 349
   switchport mode trunk
...
interface Port-Channel8
   description [L]_HS11EWOT08A_Po49
   no shutdown
   switchport
   switchport trunk allowed vlan 349
   switchport mode trunk
...
interface Port-Channel9
   description [L]_HS11EWOT09A_Po49
   no shutdown
   switchport
   switchport trunk allowed vlan 349
   switchport mode trunk
...
interface Port-Channel10
   description [L]_HS11EWOT10A_Po49
   no shutdown
   switchport
   switchport trunk allowed vlan 349
   switchport mode trunk
...
interface Port-Channel4094
   description [L]_MLAG_PEER_is11ewotagg01aa_Po551
   no shutdown
   switchport
   switchport mode trunk
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | EVPN_Overlay_Peering | default | 172.21.3.25/32 |
| Loopback1 | VTEP_VXLAN_Tunnel_Source | default | 10.210.248.24/32 |
...
interface Loopback0
   ...
   no shutdown
   ip address 172.21.3.25/32
!
interface Loopback1
   description VTEP_VXLAN_Tunnel_Source
   no shutdown
   ip address 10.210.248.24/32
```
...
!
interface Vxlan1
   description is11ewotagg01ba_VTEP
...
| Vlan4093 | default | MLAG-IPv4-UNDERLAY-PEER | 65120.21211 | - |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 349 | 172.21.3.25:10349 | 10349:10349 | - | - | learned |

#### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute |
| --- | ------------------- | ------------ |
| OT | 172.21.3.25:5001 | connected |

#### Router BGP Device Configuration

```eos
!
router bgp 65120.21211
   router-id 172.21.3.25
   maximum-paths 128 ecmp 128
   update wait-install
   no bgp default ipv4-unicast
   bgp asn notation asdot
   ...
   neighbor MLAG-IPv4-UNDERLAY-PEER remote-as 65120.21211
   neighbor MLAG-IPv4-UNDERLAY-PEER next-hop-self
   neighbor MLAG-IPv4-UNDERLAY-PEER description is11ewotagg01aa
   ...
   neighbor interface Vlan4093 peer-group MLAG-IPv4-UNDERLAY-PEER remote-as 65120.21211
