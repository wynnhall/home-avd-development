...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | mgmt | 10.211.240.41/22 | 10.211.240.1 |
...
| ------- | -------- | ---------- | ----- |
| - | S1_OT_FABRIC is11aotagg02ba | All | Enabled |

#### SNMP EngineID Configuration

| Type | EngineID (Hex) | IP | Port |
| ---- | -------------- | -- | ---- |
| local | f5a5ac41bac0c6ef2562f7856151ca22a287c28a | - | - |
...
| ---- | ----- | ------- | -------------- | ------- | -------------- | ----------- | --------- |
| SNMPManager | network-admin | v3 | sha | aes | - | - | f5a5ac41bac0c6ef2562f7856151ca22a287c28a |

#### SNMP Device Configuration

```eos
!
snmp-server engineID local f5a5ac41bac0c6ef2562f7856151ca22a287c28a
snmp-server location S1_OT_FABRIC is11aotagg02ba
...
snmp-server user SNMPManager network-admin v3 localized f5a5ac41bac0c6ef2562f7856151ca22a287c28a auth sha <removed> priv aes <removed>
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet1 | [L]_HS11AOT14A_Ethernet50 | *trunk | *349 | *- | *- | 1 |
| Ethernet2 | [L]_HS11AOT15A_Ethernet50 | *trunk | *349 | *- | *- | 2 |
| Ethernet3 | [L]_HS11AOT16A_Ethernet50 | *trunk | *349 | *- | *- | 3 |
| Ethernet4 | [L]_HS11AOT17A_Ethernet50 | *trunk | *349 | *- | *- | 4 |
| Ethernet5 | [L]_HS11AOT18A_Ethernet50 | *trunk | *349 | *- | *- | 5 |
| Ethernet6 | [L]_HS11AOT19A_Ethernet50 | *trunk | *349 | *- | *- | 6 |
| Ethernet7 | [L]_HS11AOT20A_Ethernet50 | *trunk | *349 | *- | *- | 7 |
| Ethernet8 | [L]_HS11AOT21A_Ethernet50 | *trunk | *349 | *- | *- | 8 |
| Ethernet9 | [L]_HS11AOT22A_Ethernet50 | *trunk | *349 | *- | *- | 9 |
| Ethernet10 | [L]_HS11AOT23A_Ethernet50 | *trunk | *349 | *- | *- | 10 |
| Ethernet11 | [L]_HS11AOT24A_Ethernet50 | *trunk | *349 | *- | *- | 11 |
| Ethernet12 | [L]_HS11AOT25A_Ethernet50 | *trunk | *349 | *- | *- | 12 |
| Ethernet55/1 | [L]_MLAG_PEER_is11aotagg02aa_Ethernet55/1 | *trunk | *- | *- | *['MLAG'] | 4094 |
| Ethernet56/1 | [L]_MLAG_PEER_is11aotagg02aa_Ethernet56/1 | *trunk | *- | *- | *['MLAG'] | 4094 |
...
| --------- | ----------- | ---- | --------------| ------------ | --- | --- | -------- | -------------- | -------------------| ----------- | ------------ |
| Ethernet49/1 | [L]_P2P_LINK_TO_ISMS1OTSP01A_Ethernet3/3/1 | routed | - | - | default | 9214 | False | - | - | - | - |
| Ethernet50/1 | [L]_P2P_LINK_TO_ISMS1OTSP02A_Ethernet3/3/1 | routed | - | - | default | 9214 | False | - | - | - | - |
| Ethernet51/1 | [L]_P2P_LINK_TO_ISMS1OTSP03A_Ethernet3/3/1 | routed | - | - | default | 9214 | False | - | - | - | - |
...
!
interface Ethernet1
   description [L]_HS11AOT14A_Ethernet50
   no shutdown
   channel-group 1 mode active
!
interface Ethernet2
   description [L]_HS11AOT15A_Ethernet50
   no shutdown
   channel-group 2 mode active
!
interface Ethernet3
   description [L]_HS11AOT16A_Ethernet50
   no shutdown
   channel-group 3 mode active
!
interface Ethernet4
   description [L]_HS11AOT17A_Ethernet50
   no shutdown
   channel-group 4 mode active
!
interface Ethernet5
   description [L]_HS11AOT18A_Ethernet50
   no shutdown
   channel-group 5 mode active
!
interface Ethernet6
   description [L]_HS11AOT19A_Ethernet50
   no shutdown
   channel-group 6 mode active
!
interface Ethernet7
   description [L]_HS11AOT20A_Ethernet50
   no shutdown
   channel-group 7 mode active
!
interface Ethernet8
   description [L]_HS11AOT21A_Ethernet50
   no shutdown
   channel-group 8 mode active
!
interface Ethernet9
   description [L]_HS11AOT22A_Ethernet50
   no shutdown
   channel-group 9 mode active
!
interface Ethernet10
   description [L]_HS11AOT23A_Ethernet50
   no shutdown
   channel-group 10 mode active
!
interface Ethernet11
   description [L]_HS11AOT24A_Ethernet50
   no shutdown
   channel-group 11 mode active
!
interface Ethernet12
   description [L]_HS11AOT25A_Ethernet50
   no shutdown
   channel-group 12 mode active
!
interface Ethernet49/1
   description [L]_P2P_LINK_TO_ISMS1OTSP01A_Ethernet3/3/1
   no shutdown
   mtu 9214
   no switchport
   ipv6 enable
...
interface Ethernet50/1
   description [L]_P2P_LINK_TO_ISMS1OTSP02A_Ethernet3/3/1
   no shutdown
   mtu 9214
   no switchport
   ipv6 enable
...
interface Ethernet51/1
   description [L]_P2P_LINK_TO_ISMS1OTSP03A_Ethernet3/3/1
   no shutdown
   mtu 9214
   no switchport
   ipv6 enable
...
interface Ethernet55/1
   description [L]_MLAG_PEER_is11aotagg02aa_Ethernet55/1
   no shutdown
   channel-group 4094 mode active
!
interface Ethernet56/1
   description [L]_MLAG_PEER_is11aotagg02aa_Ethernet56/1
   no shutdown
   channel-group 4094 mode active
```
...
| Port-Channel4094 | [L]_MLAG_PEER_is11aotagg02aa_Po551 | switched | trunk | - | - | ['MLAG'] | - | - | - | - |
...
interface Port-Channel4094
   description [L]_MLAG_PEER_is11aotagg02aa_Po551
   no shutdown
   switchport
   switchport mode trunk
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | EVPN_Overlay_Peering | default | 172.21.3.19/32 |
...
!
interface Vxlan1
   description is11aotagg02ba_VTEP
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 349 | 172.21.3.19:10349 | 10349:10349 | - | - | learned |

#### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute |
| --- | ------------------- | ------------ |
| OT | 172.21.3.19:5001 | connected |
...
router bgp 65120.21208
   ...
   neighbor MLAG-IPv4-UNDERLAY-PEER description is11aotagg02aa
