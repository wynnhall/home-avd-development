...
| ---- | -------------- | -- | ---- |
| local | af34d09016d5fc3c65a42dbc7402036986851273 | - | - |
...
| ---- | ----- | ------- | -------------- | ------- | -------------- | ----------- | --------- |
| SNMPManager | network-admin | v3 | sha | aes | - | - | af34d09016d5fc3c65a42dbc7402036986851273 |

#### SNMP Device Configuration

```eos
!
snmp-server engineID local af34d09016d5fc3c65a42dbc7402036986851273
...
snmp-server user SNMPManager network-admin v3 localized af34d09016d5fc3c65a42dbc7402036986851273 auth sha <removed> priv aes <removed>
