...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | mgmt | 10.215.242.52/23 | 10.211.240.1 |
...
| ---- | -------------- | -- | ---- |
| local | 0ffefea4e7280895a033bf5903ca7070a8bd7ea4 | - | - |
...
| ---- | ----- | ------- | -------------- | ------- | -------------- | ----------- | --------- |
| SNMPManager | network-admin | v3 | sha | aes | - | - | 0ffefea4e7280895a033bf5903ca7070a8bd7ea4 |

#### SNMP Device Configuration

```eos
!
snmp-server engineID local 0ffefea4e7280895a033bf5903ca7070a8bd7ea4
...
snmp-server user SNMPManager network-admin v3 localized 0ffefea4e7280895a033bf5903ca7070a8bd7ea4 auth sha <removed> priv aes <removed>
