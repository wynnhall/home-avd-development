...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | mgmt | 10.211.240.221/22 | 10.211.240.1 |
...
| ------- | -------- | ---------- | ----- |
| - | S1_OT_FABRIC hs11deot04a | All | Enabled |

#### SNMP EngineID Configuration

| Type | EngineID (Hex) | IP | Port |
| ---- | -------------- | -- | ---- |
| local | ab67ca6c87cb1d71edb800120010a08bd75cac14 | - | - |
...
| ---- | ----- | ------- | -------------- | ------- | -------------- | ----------- | --------- |
| SNMPManager | network-admin | v3 | sha | aes | - | - | ab67ca6c87cb1d71edb800120010a08bd75cac14 |

#### SNMP Device Configuration

```eos
!
snmp-server engineID local ab67ca6c87cb1d71edb800120010a08bd75cac14
snmp-server location S1_OT_FABRIC hs11deot04a
...
snmp-server user SNMPManager network-admin v3 localized ab67ca6c87cb1d71edb800120010a08bd75cac14 auth sha <removed> priv aes <removed>
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet49 | [L]_IS11DEOTAGG01AA_Ethernet4 | *trunk | *349 | *- | *- | 49 |
| Ethernet50 | [L]_IS11DEOTAGG01BA_Ethernet4 | *trunk | *349 | *- | *- | 49 |
...
interface Ethernet49
   description [L]_IS11DEOTAGG01AA_Ethernet4
   no shutdown
   channel-group 49 mode active
!
interface Ethernet50
   description [L]_IS11DEOTAGG01BA_Ethernet4
   no shutdown
   channel-group 49 mode active
```
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel49 | [L]_S1_VTEP_1DEOT_01_Po4 | switched | trunk | 349 | - | - | - | - | - | - |
...
interface Port-Channel49
   description [L]_S1_VTEP_1DEOT_01_Po4
   no shutdown
   switchport
