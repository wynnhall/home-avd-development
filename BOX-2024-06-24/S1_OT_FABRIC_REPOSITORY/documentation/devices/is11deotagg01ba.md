...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | mgmt | 10.211.240.55/22 | 10.211.240.1 |
...
| ------- | -------- | ---------- | ----- |
| - | S1_OT_FABRIC is11deotagg01ba | All | Enabled |

#### SNMP EngineID Configuration

| Type | EngineID (Hex) | IP | Port |
| ---- | -------------- | -- | ---- |
| local | 01b2659af80b88ce13df5a1ae15e9d537c08777e | - | - |
...
| ---- | ----- | ------- | -------------- | ------- | -------------- | ----------- | --------- |
| SNMPManager | network-admin | v3 | sha | aes | - | - | 01b2659af80b88ce13df5a1ae15e9d537c08777e |

#### SNMP Device Configuration

```eos
!
snmp-server engineID local 01b2659af80b88ce13df5a1ae15e9d537c08777e
snmp-server location S1_OT_FABRIC is11deotagg01ba
...
snmp-server user SNMPManager network-admin v3 localized 01b2659af80b88ce13df5a1ae15e9d537c08777e auth sha <removed> priv aes <removed>
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet1 | [L]_HS11DEOT01A_Ethernet50 | *trunk | *349 | *- | *- | 1 |
| Ethernet2 | [L]_HS11DEOT02A_Ethernet50 | *trunk | *349 | *- | *- | 2 |
| Ethernet3 | [L]_HS11DEOT03A_Ethernet50 | *trunk | *349 | *- | *- | 3 |
| Ethernet4 | [L]_HS11DEOT04A_Ethernet50 | *trunk | *349 | *- | *- | 4 |
| Ethernet5 | [L]_HS11DEOT05A_Ethernet50 | *trunk | *349 | *- | *- | 5 |
| Ethernet6 | [L]_HS11DEOT06A_Ethernet50 | *trunk | *349 | *- | *- | 6 |
| Ethernet7 | [L]_HS11DEOT07A_Ethernet50 | *trunk | *349 | *- | *- | 7 |
| Ethernet8 | [L]_HS11DEOT08A_Ethernet50 | *trunk | *349 | *- | *- | 8 |
| Ethernet9 | [L]_HS11DEOT09A_Ethernet50 | *trunk | *349 | *- | *- | 9 |
| Ethernet10 | [L]_HS11DEOT10A_Ethernet50 | *trunk | *349 | *- | *- | 10 |
| Ethernet55/1 | [L]_MLAG_PEER_is11deotagg01aa_Ethernet55/1 | *trunk | *- | *- | *['MLAG'] | 4094 |
| Ethernet56/1 | [L]_MLAG_PEER_is11deotagg01aa_Ethernet56/1 | *trunk | *- | *- | *['MLAG'] | 4094 |
...
| --------- | ----------- | ---- | --------------| ------------ | --- | --- | -------- | -------------- | -------------------| ----------- | ------------ |
| Ethernet49/1 | [L]_P2P_LINK_TO_ISMS1OTSP01A_Ethernet9/4/1 | routed | - | - | default | 9214 | False | - | - | - | - |
| Ethernet50/1 | [L]_P2P_LINK_TO_ISMS1OTSP02A_Ethernet9/4/1 | routed | - | - | default | 9214 | False | - | - | - | - |
| Ethernet51/1 | [L]_P2P_LINK_TO_ISMS1OTSP03A_Ethernet9/4/1 | routed | - | - | default | 9214 | False | - | - | - | - |
...
!
interface Ethernet1
   description [L]_HS11DEOT01A_Ethernet50
   no shutdown
   channel-group 1 mode active
!
interface Ethernet2
   description [L]_HS11DEOT02A_Ethernet50
   no shutdown
   channel-group 2 mode active
!
interface Ethernet3
   description [L]_HS11DEOT03A_Ethernet50
   no shutdown
   channel-group 3 mode active
!
interface Ethernet4
   description [L]_HS11DEOT04A_Ethernet50
   no shutdown
   channel-group 4 mode active
!
interface Ethernet5
   description [L]_HS11DEOT05A_Ethernet50
   no shutdown
   channel-group 5 mode active
!
interface Ethernet6
   description [L]_HS11DEOT06A_Ethernet50
   no shutdown
   channel-group 6 mode active
!
interface Ethernet7
   description [L]_HS11DEOT07A_Ethernet50
   no shutdown
   channel-group 7 mode active
!
interface Ethernet8
   description [L]_HS11DEOT08A_Ethernet50
   no shutdown
   channel-group 8 mode active
!
interface Ethernet9
   description [L]_HS11DEOT09A_Ethernet50
   no shutdown
   channel-group 9 mode active
!
interface Ethernet10
   description [L]_HS11DEOT10A_Ethernet50
   no shutdown
   channel-group 10 mode active
!
interface Ethernet49/1
   description [L]_P2P_LINK_TO_ISMS1OTSP01A_Ethernet9/4/1
   no shutdown
   mtu 9214
   no switchport
   ipv6 enable
...
interface Ethernet50/1
   description [L]_P2P_LINK_TO_ISMS1OTSP02A_Ethernet9/4/1
   no shutdown
   mtu 9214
   no switchport
   ipv6 enable
...
interface Ethernet51/1
   description [L]_P2P_LINK_TO_ISMS1OTSP03A_Ethernet9/4/1
   no shutdown
   mtu 9214
   no switchport
   ipv6 enable
...
interface Ethernet55/1
   description [L]_MLAG_PEER_is11deotagg01aa_Ethernet55/1
   no shutdown
   channel-group 4094 mode active
!
interface Ethernet56/1
   description [L]_MLAG_PEER_is11deotagg01aa_Ethernet56/1
   no shutdown
   channel-group 4094 mode active
```
...
| Port-Channel4094 | [L]_MLAG_PEER_is11deotagg01aa_Po551 | switched | trunk | - | - | ['MLAG'] | - | - | - | - |
...
interface Port-Channel4094
   description [L]_MLAG_PEER_is11deotagg01aa_Po551
   no shutdown
   switchport
   switchport mode trunk
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | EVPN_Overlay_Peering | default | 172.21.3.33/32 |
...
!
interface Vxlan1
   description is11deotagg01ba_VTEP
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 349 | 172.21.3.33:10349 | 10349:10349 | - | - | learned |

#### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute |
| --- | ------------------- | ------------ |
| OT | 172.21.3.33:5001 | connected |
...
router bgp 65120.21215
   ...
   neighbor MLAG-IPv4-UNDERLAY-PEER description is11deotagg01aa
