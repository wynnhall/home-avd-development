...
| ------- | -------- | ---------- | ----- |
| - | SM_MGMT_FABRIC [DC2 Rack G4] hsmdc2mgt01a | All | Enabled |
...
snmp-server location SM_MGMT_FABRIC [DC2 Rack G4] hsmdc2mgt01a
...
| Ethernet47 |  [L]_HSMDC2G401AA_MGMT1 | access | 300 | - | - | - |
| Ethernet48 |  [L]_HSMDC2G401BA_MGMT1 | access | 300 | - | - | - |
| Ethernet49 | [L]_HSMDC2MGTAGG01A_Ethernet1 | *trunk | *240,300,316,1000 | *1000 | *- | 49 |
| Ethernet50 | [L]_HSMDC2MGTAGG02A_Ethernet1 | *trunk | *240,300,316,1000 | *1000 | *- | 49 |
...
interface Ethernet47
   description [L]_HSMDC2G401AA_MGMT1
   no shutdown
   switchport access vlan 300
   switchport mode access
   switchport
...
interface Ethernet48
   description [L]_HSMDC2G401BA_MGMT1
   no shutdown
   switchport access vlan 300
   switchport mode access
   switchport
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel49 | [L]_DC2_MGMT_AGG_LEAFS_Po1 | switched | trunk | 240,300,316,1000 | 1000 | - | - | - | - | - |
