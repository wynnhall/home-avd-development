...
| ------- | -------- | ---------- | ----- |
| - | SM_MGMT_FABRIC hsmdc1mgt05a | All | Enabled |

#### SNMP EngineID Configuration

| Type | EngineID (Hex) | IP | Port |
| ---- | -------------- | -- | ---- |
| local | 220dc029cefdbddea58cf0957991e1dd35df1467 | - | - |
...
| ---- | ----- | ------- | -------------- | ------- | -------------- | ----------- | --------- |
| SNMPManager | network-admin | v3 | sha | aes | - | - | 220dc029cefdbddea58cf0957991e1dd35df1467 |

#### SNMP Device Configuration

```eos
!
snmp-server engineID local 220dc029cefdbddea58cf0957991e1dd35df1467
snmp-server location SM_MGMT_FABRIC hsmdc1mgt05a
...
snmp-server user SNMPManager network-admin v3 localized 220dc029cefdbddea58cf0957991e1dd35df1467 auth sha <removed> priv aes <removed>
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet49 | [L]_HSMDC1MGTAGG01A_Ethernet5 | *trunk | *240,300,316,1000 | *1000 | *- | 49 |
| Ethernet50 | [L]_HSMDC1MGTAGG02A_Ethernet5 | *trunk | *240,300,316,1000 | *1000 | *- | 49 |
...
interface Ethernet49
   description [L]_HSMDC1MGTAGG01A_Ethernet5
   no shutdown
   channel-group 49 mode active
!
interface Ethernet50
   description [L]_HSMDC1MGTAGG02A_Ethernet5
   no shutdown
   channel-group 49 mode active
!
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel49 | [L]_DC1_MGMT_AGG_LEAFS_Po5 | switched | trunk | 240,300,316,1000 | 1000 | - | - | - | - | - |
...
interface Port-Channel49
   description [L]_DC1_MGMT_AGG_LEAFS_Po5
   no shutdown
   switchport
...
| --------- | --- | ---------- | ------------------ | ------------------------- | ---- | ------ | ------- |
| vlan300 |  default  |  10.210.80.107/21  |  -  |  -  |  -  |  -  |  -  |
