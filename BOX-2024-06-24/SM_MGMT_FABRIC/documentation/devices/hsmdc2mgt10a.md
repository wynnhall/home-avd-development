...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet1 |  [L]_HSMDC2G501AA_NMGT | access | 300 | - | - | - |
| Ethernet2 |  [L]_HSMDC2G501BA_NMGT | access | 300 | - | - | - |
...
| Ethernet47 |  [L]_VL300-DC1/DC2/MDF-Mgmt_ | access | 300 | - | - | - |
| Ethernet48 |  [L]_VL300-DC1/DC2/MDF-Mgmt_ | access | 300 | - | - | - |
| Ethernet49 | [L]_HSMDC2MGTAGG01A_Ethernet10 | *trunk | *240,300,316,1000 | *1000 | *- | 49 |
| Ethernet50 | [L]_HSMDC2MGTAGG02A_Ethernet10 | *trunk | *240,300,316,1000 | *1000 | *- | 49 |
...
!
interface Ethernet1
   description [L]_HSMDC2G501AA_NMGT
   no shutdown
...
!
interface Ethernet2
   description [L]_HSMDC2G501BA_NMGT
   no shutdown
   switchport access vlan 300
   switchport mode access
   switchport
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel49 | [L]_DC2_MGMT_AGG_LEAFS_Po10 | switched | trunk | 240,300,316,1000 | 1000 | - | - | - | - | - |
