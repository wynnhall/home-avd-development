...
| ------- | -------- | ---------- | ----- |
| - | SM_MGMT_FABRIC hs00bmgt01a | All | Enabled |

#### SNMP EngineID Configuration

| Type | EngineID (Hex) | IP | Port |
| ---- | -------------- | -- | ---- |
| local | d87413ee108b60300a3d717214862a29ab8bdd28 | - | - |
...
| ---- | ----- | ------- | -------------- | ------- | -------------- | ----------- | --------- |
| SNMPManager | network-admin | v3 | sha | aes | - | - | d87413ee108b60300a3d717214862a29ab8bdd28 |

#### SNMP Device Configuration

```eos
!
snmp-server engineID local d87413ee108b60300a3d717214862a29ab8bdd28
snmp-server location SM_MGMT_FABRIC hs00bmgt01a
...
snmp-server user SNMPManager network-admin v3 localized d87413ee108b60300a3d717214862a29ab8bdd28 auth sha <removed> priv aes <removed>
...
| Ethernet49 | [L]_ISMMGTSP01A_Ethernet6/5 | *trunk | *462,1000 | *1000 | *- | 49 |
| Ethernet50 | [L]_ISMMGTSP02A_Ethernet6/5 | *trunk | *462,1000 | *1000 | *- | 49 |
...
interface Ethernet49
   description [L]_ISMMGTSP01A_Ethernet6/5
   no shutdown
   channel-group 49 mode active
!
interface Ethernet50
   description [L]_ISMMGTSP02A_Ethernet6/5
   no shutdown
   channel-group 49 mode active
```
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel49 | [L]_MGMT_SPINES_Po65 | switched | trunk | 462,1000 | 1000 | - | - | - | - | - |
...
interface Port-Channel49
   description [L]_MGMT_SPINES_Po65
   no shutdown
   switchport
...
| --------- | --- | ---------- | ------------------ | ------------------------- | ---- | ------ | ------- |
| vlan462 |  default  |  10.215.241.23/24  |  -  |  -  |  -  |  -  |  -  |
