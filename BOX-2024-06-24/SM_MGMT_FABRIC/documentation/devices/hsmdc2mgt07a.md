...
| ------- | -------- | ---------- | ----- |
| - | SM_MGMT_FABRIC [DC2 Rack F4] hsmdc2mgt07a | All | Enabled |
...
snmp-server location SM_MGMT_FABRIC [DC2 Rack F4] hsmdc2mgt07a
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet1 |  [L]_S2VHNMS01_NMGT | access | 316 | - | - | - |
| Ethernet2 |  [L]_S2VHNMS02_NMGT | access | 316 | - | - | - |
| Ethernet3 |  [L]_OSMIBSD02_MGMT | access | 316 | - | - | - |
| Ethernet4 |  [L]_SMVHCVPTEMP_P1 | access | 300 | - | - | - |
| Ethernet5 |  [L]_SMVHCVPTEMP_P2 | access | 300 | - | - | - |
| Ethernet6 | [L]_S2VHNMS01_P1 | *trunk | *240,300,316 | *240 | *- | 6 |
| Ethernet7 | [L]_S2VHNMS02_P1 | *trunk | *240,300,316 | *240 | *- | 7 |
| Ethernet8 | [L]_S2VHNMS01_P2 | *trunk | *240,300,316 | *240 | *- | 6 |
| Ethernet9 | [L]_S2VHNMS02_P2 | *trunk | *240,300,316 | *240 | *- | 7 |
| Ethernet10 |  [L]_OSMIBSD02_IPMI | access | 316 | - | - | - |
...
| Ethernet40 |  [L]_TEMP_SENSOR_2_LAN | access | 300 | - | - | - |
...
| Ethernet47 |  [L]_HSMDC2MGTF401A_MGMT1 | access | 300 | - | - | - |
| Ethernet48 |  [L]_HSMDC2MGTF402A_MGMT1 | access | 300 | - | - | - |
| Ethernet49 | [L]_HSMDC2MGTAGG01A_Ethernet7 | *trunk | *240,300,316,1000 | *1000 | *- | 49 |
| Ethernet50 | [L]_HSMDC2MGTAGG02A_Ethernet7 | *trunk | *240,300,316,1000 | *1000 | *- | 49 |
...
!
interface Ethernet6
   description [L]_S2VHNMS01_P1
   no shutdown
   channel-group 6 mode active
!
interface Ethernet7
   description [L]_S2VHNMS02_P1
   no shutdown
   channel-group 7 mode active
!
interface Ethernet8
   description [L]_S2VHNMS01_P2
   no shutdown
   channel-group 6 mode active
!
interface Ethernet9
   description [L]_S2VHNMS02_P2
   no shutdown
   channel-group 7 mode active
!
interface Ethernet10
   description [L]_OSMIBSD02_IPMI
   no shutdown
   switchport access vlan 316
   switchport mode access
   switchport
...
interface Ethernet40
   description [L]_TEMP_SENSOR_2_LAN
   no shutdown
   switchport access vlan 300
   switchport mode access
   switchport
...
interface Ethernet47
   description [L]_HSMDC2MGTF401A_MGMT1
   no shutdown
   switchport access vlan 300
   switchport mode access
   switchport
...
interface Ethernet48
   description [L]_HSMDC2MGTF402A_MGMT1
   no shutdown
   switchport access vlan 300
   switchport mode access
   switchport
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel6 | [L]_S2VHNMS01_Po | switched | trunk | 240,300,316 | 240 | - | - | - | - | - |
| Port-Channel7 | [L]_S2VHNMS02_Po | switched | trunk | 240,300,316 | 240 | - | - | - | - | - |
| Port-Channel49 | [L]_DC2_MGMT_AGG_LEAFS_Po7 | switched | trunk | 240,300,316,1000 | 1000 | - | - | - | - | - |
...
interface Port-Channel6
   description [L]_S2VHNMS01_Po
   no shutdown
   switchport
   switchport trunk allowed vlan 240,300,316
   switchport trunk native vlan 240
   switchport mode trunk
!
interface Port-Channel7
   description [L]_S2VHNMS02_Po
   no shutdown
   switchport
   switchport trunk allowed vlan 240,300,316
   switchport trunk native vlan 240
