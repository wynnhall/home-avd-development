...
| ------- | -------- | ---------- | ----- |
| - | SM_MGMT_FABRIC [DC2 Rack F5] hsmdc2mgt08a | All | Enabled |
...
snmp-server location SM_MGMT_FABRIC [DC2 Rack F5] hsmdc2mgt08a
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet1 |  [L]_VL300-DC1/DC2/MDF-Mgmt_ | access | 300 | - | - | - |
| Ethernet2 |  [L]_VL300-DC1/DC2/MDF-Mgmt_ | access | 300 | - | - | - |
| Ethernet3 |  [L]_VL300-DC1/DC2/MDF-Mgmt_ | access | 300 | - | - | - |
| Ethernet4 |  [L]_VL300-DC1/DC2/MDF-Mgmt_ | access | 300 | - | - | - |
...
| Ethernet47 |  [L]_HSMDC2F501AA_MGMT1 | access | 300 | - | - | - |
| Ethernet48 |  [L]_HSMDC2F501BA_MGMT1 | access | 300 | - | - | - |
| Ethernet49 | [L]_HSMDC2MGTAGG01A_Ethernet8 | *trunk | *240,300,316,1000 | *1000 | *- | 49 |
| Ethernet50 | [L]_HSMDC2MGTAGG02A_Ethernet8 | *trunk | *240,300,316,1000 | *1000 | *- | 49 |
...
interface Ethernet47
   description [L]_HSMDC2F501AA_MGMT1
   no shutdown
   switchport access vlan 300
   switchport mode access
   switchport
...
interface Ethernet48
   description [L]_HSMDC2F501BA_MGMT1
   no shutdown
   switchport access vlan 300
   switchport mode access
   switchport
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel49 | [L]_DC2_MGMT_AGG_LEAFS_Po8 | switched | trunk | 240,300,316,1000 | 1000 | - | - | - | - | - |
