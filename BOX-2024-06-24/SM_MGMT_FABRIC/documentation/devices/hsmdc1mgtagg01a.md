...
| ------- | -------- | ---------- | ----- |
| - | SM_MGMT_FABRIC hsmdc1mgtagg01a | All | Enabled |
...
| ---- | ----- | ------- | -------------- | ------- | -------------- | ----------- | --------- |
| SNMPManager | network-admin | v3 | sha | aes | - | - | 150ed0e11af54e026fd39c24a8406b480dfccee2 |

#### SNMP Device Configuration

```eos
!
snmp-server engineID local 150ed0e11af54e026fd39c24a8406b480dfccee2
snmp-server location SM_MGMT_FABRIC hsmdc1mgtagg01a
...
snmp-server user SNMPManager network-admin v3 localized 150ed0e11af54e026fd39c24a8406b480dfccee2 auth sha <removed> priv aes <removed>
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet1 | [L]_HSMDC1MGT01A_Ethernet49 | *trunk | *240,300,316,1000 | *1000 | *- | 1 |
| Ethernet2 | [L]_HSMDC1MGT02A_Ethernet49 | *trunk | *240,300,316,1000 | *1000 | *- | 2 |
| Ethernet3 | [L]_HSMDC1MGT03A_Ethernet49 | *trunk | *240,300,316,1000 | *1000 | *- | 3 |
| Ethernet4 | [L]_HSMDC1MGT04A_Ethernet49 | *trunk | *240,300,316,1000 | *1000 | *- | 4 |
| Ethernet5 | [L]_HSMDC1MGT05A_Ethernet49 | *trunk | *240,300,316,1000 | *1000 | *- | 5 |
| Ethernet6 | [L]_HSMDC1MGT06A_Ethernet49 | *trunk | *240,300,316,1000 | *1000 | *- | 6 |
| Ethernet7 | [L]_HSMDC1MGT07A_Ethernet49 | *trunk | *240,300,316,1000 | *1000 | *- | 7 |
| Ethernet8 | [L]_HSMDC1MGT08A_Ethernet49 | *trunk | *240,300,316,1000 | *1000 | *- | 8 |
| Ethernet9 | [L]_HSMDC1MGT09A_Ethernet49 | *trunk | *240,300,316,1000 | *1000 | *- | 9 |
| Ethernet94 |  [L]_ISMDC1BL01A_Ma1 | access | 300 | - | - | - |
| Ethernet95 |  [L]_ISMDC1SP01A_Ma1 | access | 300 | - | - | - |
| Ethernet96 |  [L]_ISMDC1SP03A_Ma1 | access | 300 | - | - | - |
| Ethernet97/1 | [L]_ISMMGTSP01A_Ethernet3/49/1 | *trunk | *240,300,316,1000 | *1000 | *- | 971 |
| Ethernet98/1 | [L]_ISMMGTSP02A_Ethernet3/49/1 | *trunk | *240,300,316,1000 | *1000 | *- | 971 |
| Ethernet103/1 | [L]_MLAG_PEER_hsmdc1mgtagg02a_Ethernet103/1 | *trunk | *- | *- | *['MLAG'] | 4094 |
| Ethernet104/1 | [L]_MLAG_PEER_hsmdc1mgtagg02a_Ethernet104/1 | *trunk | *- | *- | *['MLAG'] | 4094 |
...
interface Ethernet94
   description [L]_ISMDC1BL01A_Ma1
   no shutdown
   switchport access vlan 300
   switchport mode access
   switchport
...
interface Ethernet95
   description [L]_ISMDC1SP01A_Ma1
   no shutdown
   switchport access vlan 300
   switchport mode access
   switchport
...
interface Ethernet96
   description [L]_ISMDC1SP03A_Ma1
   no shutdown
   switchport access vlan 300
   switchport mode access
   switchport
...
| Port-Channel4094 | [L]_MLAG_PEER_hsmdc1mgtagg02a_Po1031 | switched | trunk | - | - | ['MLAG'] | 30 | individual | - | - |
...
| --------- | --- | ---------- | ------------------ | ------------------------- | ---- | ------ | ------- |
| vlan300 |  default  |  10.210.80.101/21  |  -  |  -  |  -  |  -  |  -  |
