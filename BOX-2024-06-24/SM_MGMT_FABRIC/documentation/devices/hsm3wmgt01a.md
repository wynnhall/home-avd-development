...
| ------- | -------- | ---------- | ----- |
| - | SM_MGMT_FABRIC hsm3wmgt01a | All | Enabled |

#### SNMP EngineID Configuration

| Type | EngineID (Hex) | IP | Port |
| ---- | -------------- | -- | ---- |
| local | 6ecea32b81979a97fdd96260c682a6eeec1924b1 | - | - |
...
| ---- | ----- | ------- | -------------- | ------- | -------------- | ----------- | --------- |
| SNMPManager | network-admin | v3 | sha | aes | - | - | 6ecea32b81979a97fdd96260c682a6eeec1924b1 |

#### SNMP Device Configuration

```eos
!
snmp-server engineID local 6ecea32b81979a97fdd96260c682a6eeec1924b1
snmp-server location SM_MGMT_FABRIC hsm3wmgt01a
...
snmp-server user SNMPManager network-admin v3 localized 6ecea32b81979a97fdd96260c682a6eeec1924b1 auth sha <removed> priv aes <removed>
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet49 | [L]_ISMMGTSP01A_Ethernet4/5 | *trunk | *463,1000 | *1000 | *- | 49 |
| Ethernet50 | [L]_ISMMGTSP02A_Ethernet4/5 | *trunk | *463,1000 | *1000 | *- | 49 |
...
interface Ethernet49
   description [L]_ISMMGTSP01A_Ethernet4/5
   no shutdown
   channel-group 49 mode active
!
interface Ethernet50
   description [L]_ISMMGTSP02A_Ethernet4/5
   no shutdown
   channel-group 49 mode active
!
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel49 | [L]_MGMT_SPINES_Po45 | switched | trunk | 463,1000 | 1000 | - | - | - | - | - |
...
interface Port-Channel49
   description [L]_MGMT_SPINES_Po45
   no shutdown
   switchport
...
| --------- | --- | ---------- | ------------------ | ------------------------- | ---- | ------ | ------- |
| vlan463 |  default  |  10.215.242.44/23  |  -  |  -  |  -  |  -  |  -  |
