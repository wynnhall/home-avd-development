...
| ------- | -------- | ---------- | ----- |
| - | SM_MGMT_FABRIC hsmdc1mgtagg02a | All | Enabled |

#### SNMP EngineID Configuration

| Type | EngineID (Hex) | IP | Port |
| ---- | -------------- | -- | ---- |
| local | 02b7b4b49c41d5cc8b711b0b63dc2a7f2e06b41a | - | - |
...
| ---- | ----- | ------- | -------------- | ------- | -------------- | ----------- | --------- |
| SNMPManager | network-admin | v3 | sha | aes | - | - | 02b7b4b49c41d5cc8b711b0b63dc2a7f2e06b41a |

#### SNMP Device Configuration

```eos
!
snmp-server engineID local 02b7b4b49c41d5cc8b711b0b63dc2a7f2e06b41a
snmp-server location SM_MGMT_FABRIC hsmdc1mgtagg02a
...
snmp-server user SNMPManager network-admin v3 localized 02b7b4b49c41d5cc8b711b0b63dc2a7f2e06b41a auth sha <removed> priv aes <removed>
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet1 | [L]_HSMDC1MGT01A_Ethernet50 | *trunk | *240,300,316,1000 | *1000 | *- | 1 |
| Ethernet2 | [L]_HSMDC1MGT02A_Ethernet50 | *trunk | *240,300,316,1000 | *1000 | *- | 2 |
| Ethernet3 | [L]_HSMDC1MGT03A_Ethernet50 | *trunk | *240,300,316,1000 | *1000 | *- | 3 |
| Ethernet4 | [L]_HSMDC1MGT04A_Ethernet50 | *trunk | *240,300,316,1000 | *1000 | *- | 4 |
| Ethernet5 | [L]_HSMDC1MGT05A_Ethernet50 | *trunk | *240,300,316,1000 | *1000 | *- | 5 |
| Ethernet6 | [L]_HSMDC1MGT06A_Ethernet50 | *trunk | *240,300,316,1000 | *1000 | *- | 6 |
| Ethernet7 | [L]_HSMDC1MGT07A_Ethernet50 | *trunk | *240,300,316,1000 | *1000 | *- | 7 |
| Ethernet8 | [L]_HSMDC1MGT08A_Ethernet50 | *trunk | *240,300,316,1000 | *1000 | *- | 8 |
| Ethernet9 | [L]_HSMDC1MGT09A_Ethernet50 | *trunk | *240,300,316,1000 | *1000 | *- | 9 |
| Ethernet94 |  [L]_ISMDC1BL02A_Ma1 | access | 300 | - | - | - |
| Ethernet95 |  [L]_ISMDC1SP02A_Ma1 | access | 300 | - | - | - |
| Ethernet97/1 | [L]_ISMMGTSP01A_Ethernet4/49/1 | *trunk | *240,300,316,1000 | *1000 | *- | 971 |
| Ethernet98/1 | [L]_ISMMGTSP02A_Ethernet4/49/1 | *trunk | *240,300,316,1000 | *1000 | *- | 971 |
| Ethernet103/1 | [L]_MLAG_PEER_hsmdc1mgtagg01a_Ethernet103/1 | *trunk | *- | *- | *['MLAG'] | 4094 |
| Ethernet104/1 | [L]_MLAG_PEER_hsmdc1mgtagg01a_Ethernet104/1 | *trunk | *- | *- | *['MLAG'] | 4094 |
...
!
interface Ethernet1
   description [L]_HSMDC1MGT01A_Ethernet50
   no shutdown
...
!
interface Ethernet2
   description [L]_HSMDC1MGT02A_Ethernet50
   no shutdown
   switchport access vlan 300
   switchport mode access
...
!
interface Ethernet3
   description [L]_HSMDC1MGT03A_Ethernet50
   no shutdown
   switchport access vlan 300
   switchport mode access
...
!
interface Ethernet4
   description [L]_HSMDC1MGT04A_Ethernet50
   no shutdown
   switchport access vlan 300
   switchport mode access
...
!
interface Ethernet5
   description [L]_HSMDC1MGT05A_Ethernet50
   no shutdown
   switchport access vlan 300
   switchport mode access
...
!
interface Ethernet6
   description [L]_HSMDC1MGT06A_Ethernet50
   no shutdown
   switchport access vlan 300
   switchport mode access
...
!
interface Ethernet7
   description [L]_HSMDC1MGT07A_Ethernet50
   no shutdown
   switchport access vlan 300
   switchport mode access
...
!
interface Ethernet8
   description [L]_HSMDC1MGT08A_Ethernet50
   no shutdown
   switchport access vlan 300
   switchport mode access
...
!
interface Ethernet9
   description [L]_HSMDC1MGT09A_Ethernet50
   no shutdown
   switchport access vlan 300
   switchport mode access
...
interface Ethernet94
   description [L]_ISMDC1BL02A_Ma1
   no shutdown
   switchport access vlan 300
   switchport mode access
   switchport
...
interface Ethernet95
   description [L]_ISMDC1SP02A_Ma1
   no shutdown
   switchport access vlan 300
   switchport mode access
   switchport
...
interface Ethernet97/1
   description [L]_ISMMGTSP01A_Ethernet4/49/1
   no shutdown
   channel-group 971 mode active
!
interface Ethernet98/1
   description [L]_ISMMGTSP02A_Ethernet4/49/1
   no shutdown
   channel-group 971 mode active
!
interface Ethernet103/1
   description [L]_MLAG_PEER_hsmdc1mgtagg01a_Ethernet103/1
   no shutdown
   switchport access vlan 300
   switchport mode access
...
interface Ethernet104/1
   description [L]_MLAG_PEER_hsmdc1mgtagg01a_Ethernet104/1
   no shutdown
   switchport access vlan 300
   switchport mode access
   channel-group 4094 mode active
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel1 | [L]_HSMDC1MGT01A_Po49 | switched | trunk | 240,300,316,1000 | 1000 | - | 30 | individual | 1 | - |
| Port-Channel2 | [L]_HSMDC1MGT02A_Po49 | switched | trunk | 240,300,316,1000 | 1000 | - | 30 | individual | 2 | - |
| Port-Channel3 | [L]_HSMDC1MGT03A_Po49 | switched | trunk | 240,300,316,1000 | 1000 | - | 30 | individual | 3 | - |
| Port-Channel4 | [L]_HSMDC1MGT04A_Po49 | switched | trunk | 240,300,316,1000 | 1000 | - | 30 | individual | 4 | - |
| Port-Channel5 | [L]_HSMDC1MGT05A_Po49 | switched | trunk | 240,300,316,1000 | 1000 | - | 30 | individual | 5 | - |
| Port-Channel6 | [L]_HSMDC1MGT06A_Po49 | switched | trunk | 240,300,316,1000 | 1000 | - | 30 | individual | 6 | - |
| Port-Channel7 | [L]_HSMDC1MGT07A_Po49 | switched | trunk | 240,300,316,1000 | 1000 | - | 30 | individual | 7 | - |
| Port-Channel8 | [L]_HSMDC1MGT08A_Po49 | switched | trunk | 240,300,316,1000 | 1000 | - | 30 | individual | 8 | - |
| Port-Channel9 | [L]_HSMDC1MGT09A_Po49 | switched | trunk | 240,300,316,1000 | 1000 | - | 30 | individual | 9 | - |
| Port-Channel971 | [L]_MGMT_SPINES_Po349 | switched | trunk | 240,300,316,1000 | 1000 | - | - | - | 971 | - |
| Port-Channel4094 | [L]_MLAG_PEER_hsmdc1mgtagg01a_Po1031 | switched | trunk | - | - | ['MLAG'] | 30 | individual | - | - |
...
interface Port-Channel4094
   description [L]_MLAG_PEER_hsmdc1mgtagg01a_Po1031
   no shutdown
   switchport
   switchport mode trunk
...
| --------- | --- | ---------- | ------------------ | ------------------------- | ---- | ------ | ------- |
| vlan300 |  default  |  10.210.80.102/21  |  -  |  -  |  -  |  -  |  -  |
