...
| ------- | -------- | ---------- | ----- |
| - | DC1_FABRIC LEAF4 | All | Enabled |

#### SNMP EngineID Configuration

| Type | EngineID (Hex) | IP | Port |
| ---- | -------------- | -- | ---- |
| local | c87c4adf6eda6c3d570ac68496086598fce36401 | - | - |
...
| ---- | ----- | ------- | -------------- | ------- | -------------- | ----------- | --------- |
| SNMPManager | network-admin | v3 | sha | aes | - | - | c87c4adf6eda6c3d570ac68496086598fce36401 |

#### SNMP Device Configuration

```eos
!
snmp-server engineID local c87c4adf6eda6c3d570ac68496086598fce36401
snmp-server location DC1_FABRIC LEAF4
...
snmp-server user SNMPManager network-admin v3 localized c87c4adf6eda6c3d570ac68496086598fce36401 auth sha <removed> priv aes <removed>
