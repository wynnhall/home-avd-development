...
| ------- | -------- | ---------- | ----- |
| - | DC1_FABRIC [DC1/MDF] SPINE1 | All | Enabled |

#### SNMP EngineID Configuration

| Type | EngineID (Hex) | IP | Port |
| ---- | -------------- | -- | ---- |
| local | 262d92645009e0be381fafaf9d42b44111ce8f6b | - | - |
...
| ---- | ----- | ------- | -------------- | ------- | -------------- | ----------- | --------- |
| SNMPManager | network-admin | v3 | sha | aes | - | - | 262d92645009e0be381fafaf9d42b44111ce8f6b |

#### SNMP Device Configuration

```eos
!
snmp-server engineID local 262d92645009e0be381fafaf9d42b44111ce8f6b
snmp-server location DC1_FABRIC [DC1/MDF] SPINE1
...
snmp-server user SNMPManager network-admin v3 localized 262d92645009e0be381fafaf9d42b44111ce8f6b auth sha <removed> priv aes <removed>
...
| Ethernet47 | MLAG_PEER_SPINE2_Ethernet47 | *trunk | *- | *- | *['LEAF_PEER_L3', 'MLAG'] | 47 |
| Ethernet48 | MLAG_PEER_SPINE2_Ethernet48 | *trunk | *- | *- | *['LEAF_PEER_L3', 'MLAG'] | 47 |
...
| Port-Channel47 | MLAG_PEER_SPINE2_Po47 | switched | trunk | - | - | ['LEAF_PEER_L3', 'MLAG'] | - | - | - | - |
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | Router_ID | default | 192.168.128.1/32 |
