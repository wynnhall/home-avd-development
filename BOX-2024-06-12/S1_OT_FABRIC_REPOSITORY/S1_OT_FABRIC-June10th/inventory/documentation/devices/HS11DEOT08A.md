...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | mgmt | 10.211.240.225/22 | 10.211.240.1 |
...
| ------- | -------- | ---------- | ----- |
| - | S1_OT_FABRIC hs11deot08a | All | Enabled |

#### SNMP EngineID Configuration

| Type | EngineID (Hex) | IP | Port |
| ---- | -------------- | -- | ---- |
| local | 80b28daff0986fb60fe71c272a0afec205f8af2e | - | - |
...
| ---- | ----- | ------- | -------------- | ------- | -------------- | ----------- | --------- |
| SNMPManager | network-admin | v3 | sha | aes | - | - | 80b28daff0986fb60fe71c272a0afec205f8af2e |

#### SNMP Device Configuration

```eos
!
snmp-server engineID local 80b28daff0986fb60fe71c272a0afec205f8af2e
snmp-server location S1_OT_FABRIC hs11deot08a
...
snmp-server user SNMPManager network-admin v3 localized 80b28daff0986fb60fe71c272a0afec205f8af2e auth sha <removed> priv aes <removed>
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet49 | [L]_IS11DEOTAGG01AA_Ethernet8 | *trunk | *349 | *- | *- | 49 |
| Ethernet50 | [L]_IS11DEOTAGG01BA_Ethernet8 | *trunk | *349 | *- | *- | 49 |
...
interface Ethernet49
   description [L]_IS11DEOTAGG01AA_Ethernet8
   no shutdown
   channel-group 49 mode active
!
interface Ethernet50
   description [L]_IS11DEOTAGG01BA_Ethernet8
   no shutdown
   channel-group 49 mode active
```
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel49 | [L]_S1_VTEP_1DEOT_01_Po8 | switched | trunk | 349 | - | - | - | - | - | - |
...
interface Port-Channel49
   description [L]_S1_VTEP_1DEOT_01_Po8
   no shutdown
   switchport
