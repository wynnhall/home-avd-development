...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | mgmt | 10.211.240.196/22 | 10.211.240.1 |
...
| ------- | -------- | ---------- | ----- |
| - | S1_OT_FABRIC hs11cwot09a | All | Enabled |

#### SNMP EngineID Configuration

| Type | EngineID (Hex) | IP | Port |
| ---- | -------------- | -- | ---- |
| local | a0503eb61616e0fc34b270a9789cdac7c824aded | - | - |
...
| ---- | ----- | ------- | -------------- | ------- | -------------- | ----------- | --------- |
| SNMPManager | network-admin | v3 | sha | aes | - | - | a0503eb61616e0fc34b270a9789cdac7c824aded |

#### SNMP Device Configuration

```eos
!
snmp-server engineID local a0503eb61616e0fc34b270a9789cdac7c824aded
snmp-server location S1_OT_FABRIC hs11cwot09a
...
snmp-server user SNMPManager network-admin v3 localized a0503eb61616e0fc34b270a9789cdac7c824aded auth sha <removed> priv aes <removed>
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet49 | [L]_IS11CWOTAGG01AA_Ethernet9 | *trunk | *349 | *- | *- | 49 |
| Ethernet50 | [L]_IS11CWOTAGG01BA_Ethernet9 | *trunk | *349 | *- | *- | 49 |
...
interface Ethernet49
   description [L]_IS11CWOTAGG01AA_Ethernet9
   no shutdown
   channel-group 49 mode active
!
interface Ethernet50
   description [L]_IS11CWOTAGG01BA_Ethernet9
   no shutdown
   channel-group 49 mode active
```
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel49 | [L]_S1_VTEP_1CWOT_01_Po9 | switched | trunk | 349 | - | - | - | - | - | - |
...
interface Port-Channel49
   description [L]_S1_VTEP_1CWOT_01_Po9
   no shutdown
   switchport
