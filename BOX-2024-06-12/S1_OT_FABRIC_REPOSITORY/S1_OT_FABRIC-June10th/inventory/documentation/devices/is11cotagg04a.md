...
| ------- | -------- | ---------- | ----- |
| - | S1_OT_FABRIC is11cotagg04a | All | Enabled |

#### SNMP EngineID Configuration

| Type | EngineID (Hex) | IP | Port |
| ---- | -------------- | -- | ---- |
| local | 70d33bef1b5088f6c8eb27b2db971a27560ba88f | - | - |
...
| ---- | ----- | ------- | -------------- | ------- | -------------- | ----------- | --------- |
| SNMPManager | network-admin | v3 | sha | aes | - | - | 70d33bef1b5088f6c8eb27b2db971a27560ba88f |

#### SNMP Device Configuration

```eos
!
snmp-server engineID local 70d33bef1b5088f6c8eb27b2db971a27560ba88f
snmp-server location S1_OT_FABRIC is11cotagg04a
...
snmp-server user SNMPManager network-admin v3 localized 70d33bef1b5088f6c8eb27b2db971a27560ba88f auth sha <removed> priv aes <removed>
...
| Ethernet55/1 | [L]_MLAG_PEER_is11cotagg03a_Ethernet55/1 | *trunk | *- | *- | *['MLAG'] | 4094 |
| Ethernet56/1 | [L]_MLAG_PEER_is11cotagg03a_Ethernet56/1 | *trunk | *- | *- | *['MLAG'] | 4094 |
...
interface Ethernet55/1
   description [L]_MLAG_PEER_is11cotagg03a_Ethernet55/1
   no shutdown
   channel-group 4094 mode active
!
interface Ethernet56/1
   description [L]_MLAG_PEER_is11cotagg03a_Ethernet56/1
   no shutdown
   channel-group 4094 mode active
```
...
| Port-Channel4094 | [L]_MLAG_PEER_is11cotagg03a_Po551 | switched | trunk | - | - | ['MLAG'] | - | - | - | - |
...
interface Port-Channel4094
   description [L]_MLAG_PEER_is11cotagg03a_Po551
   no shutdown
   switchport
   switchport mode trunk
...
!
interface Vxlan1
   description is11cotagg04a_VTEP
...
router bgp 65120.21206
   ...
   neighbor MLAG-IPv4-UNDERLAY-PEER description is11cotagg03a
