...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | mgmt | 10.215.242.25/23 | 10.215.242.1 |
...
| ------- | -------- | ---------- | ----- |
| - | S1_OT_FABRIC ism3xnotagg01aa | All | Enabled |

#### SNMP EngineID Configuration

| Type | EngineID (Hex) | IP | Port |
| ---- | -------------- | -- | ---- |
| local | dfc49849bce569d949e17ffdc3b8feb006404e80 | - | - |
...
| ---- | ----- | ------- | -------------- | ------- | -------------- | ----------- | --------- |
| SNMPManager | network-admin | v3 | sha | aes | - | - | dfc49849bce569d949e17ffdc3b8feb006404e80 |

#### SNMP Device Configuration

```eos
!
snmp-server engineID local dfc49849bce569d949e17ffdc3b8feb006404e80
snmp-server location S1_OT_FABRIC ism3xnotagg01aa
...
snmp-server user SNMPManager network-admin v3 localized dfc49849bce569d949e17ffdc3b8feb006404e80 auth sha <removed> priv aes <removed>
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet1 | [L]_HSM3XNOT01A_Ethernet49 | *trunk | *349 | *- | *- | 1 |
| Ethernet2 | [L]_HSM3XNOT02A_Ethernet49 | *trunk | *349 | *- | *- | 2 |
| Ethernet3 | [L]_HSM3XNOT03A_Ethernet49 | *trunk | *349 | *- | *- | 3 |
| Ethernet4 | [L]_HSM3XNOT04A_Ethernet49 | *trunk | *349 | *- | *- | 4 |
| Ethernet5 | [L]_HSM3XNOT05A_Ethernet49 | *trunk | *349 | *- | *- | 5 |
| Ethernet6 | [L]_HSM3XNOT06A_Ethernet49 | *trunk | *349 | *- | *- | 6 |
| Ethernet7 | [L]_HSM3XNOT07A_Ethernet49 | *trunk | *349 | *- | *- | 7 |
| Ethernet8 | [L]_HSM3XNOT08A_Ethernet49 | *trunk | *349 | *- | *- | 8 |
| Ethernet9 | [L]_HSM3XNOT09A_Ethernet49 | *trunk | *349 | *- | *- | 9 |
| Ethernet10 | [L]_HSM3XNOT10A_Ethernet49 | *trunk | *349 | *- | *- | 10 |
| Ethernet55/1 | [L]_MLAG_PEER_ism3xnotagg01ba_Ethernet55/1 | *trunk | *- | *- | *['MLAG'] | 4094 |
| Ethernet56/1 | [L]_MLAG_PEER_ism3xnotagg01ba_Ethernet56/1 | *trunk | *- | *- | *['MLAG'] | 4094 |
...
| --------- | ----------- | ---- | --------------| ------------ | --- | --- | -------- | -------------- | -------------------| ----------- | ------------ |
| Ethernet49/1 | [L]_P2P_LINK_TO_ISMS1OTSP01A_Ethernet4/5/1 | routed | - | - | default | 9214 | False | - | - | - | - |
| Ethernet50/1 | [L]_P2P_LINK_TO_ISMS1OTSP02A_Ethernet4/5/1 | routed | - | - | default | 9214 | False | - | - | - | - |
| Ethernet51/1 | [L]_P2P_LINK_TO_ISMS1OTSP03A_Ethernet4/5/1 | routed | - | - | default | 9214 | False | - | - | - | - |
...
!
interface Ethernet1
   description [L]_HSM3XNOT01A_Ethernet49
   no shutdown
   channel-group 1 mode active
!
interface Ethernet2
   description [L]_HSM3XNOT02A_Ethernet49
   no shutdown
   channel-group 2 mode active
!
interface Ethernet3
   description [L]_HSM3XNOT03A_Ethernet49
   no shutdown
   channel-group 3 mode active
!
interface Ethernet4
   description [L]_HSM3XNOT04A_Ethernet49
   no shutdown
   channel-group 4 mode active
!
interface Ethernet5
   description [L]_HSM3XNOT05A_Ethernet49
   no shutdown
   channel-group 5 mode active
!
interface Ethernet6
   description [L]_HSM3XNOT06A_Ethernet49
   no shutdown
   channel-group 6 mode active
!
interface Ethernet7
   description [L]_HSM3XNOT07A_Ethernet49
   no shutdown
   channel-group 7 mode active
!
interface Ethernet8
   description [L]_HSM3XNOT08A_Ethernet49
   no shutdown
   channel-group 8 mode active
!
interface Ethernet9
   description [L]_HSM3XNOT09A_Ethernet49
   no shutdown
   channel-group 9 mode active
!
interface Ethernet10
   description [L]_HSM3XNOT10A_Ethernet49
   no shutdown
   channel-group 10 mode active
!
interface Ethernet49/1
   description [L]_P2P_LINK_TO_ISMS1OTSP01A_Ethernet4/5/1
   no shutdown
   mtu 9214
   no switchport
   ipv6 enable
...
interface Ethernet50/1
   description [L]_P2P_LINK_TO_ISMS1OTSP02A_Ethernet4/5/1
   no shutdown
   mtu 9214
   no switchport
   ipv6 enable
...
interface Ethernet51/1
   description [L]_P2P_LINK_TO_ISMS1OTSP03A_Ethernet4/5/1
   no shutdown
   mtu 9214
   no switchport
   ipv6 enable
...
interface Ethernet55/1
   description [L]_MLAG_PEER_ism3xnotagg01ba_Ethernet55/1
   no shutdown
   channel-group 4094 mode active
!
interface Ethernet56/1
   description [L]_MLAG_PEER_ism3xnotagg01ba_Ethernet56/1
   no shutdown
   channel-group 4094 mode active
```
...
| Port-Channel4094 | [L]_MLAG_PEER_ism3xnotagg01ba_Po551 | switched | trunk | - | - | ['MLAG'] | - | - | - | - |
...
interface Port-Channel4094
   description [L]_MLAG_PEER_ism3xnotagg01ba_Po551
   no shutdown
   switchport
   switchport mode trunk
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | EVPN_Overlay_Peering | default | 172.21.3.36/32 |
...
!
interface Vxlan1
   description ism3xnotagg01aa_VTEP
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 349 | 172.21.3.36:10349 | 10349:10349 | - | - | learned |

#### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute |
| --- | ------------------- | ------------ |
| OT | 172.21.3.36:5001 | connected |
...
router bgp 65120.21217
   ...
   neighbor MLAG-IPv4-UNDERLAY-PEER description ism3xnotagg01ba
