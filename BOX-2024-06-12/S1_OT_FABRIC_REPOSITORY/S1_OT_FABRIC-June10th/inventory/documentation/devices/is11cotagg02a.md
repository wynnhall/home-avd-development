...
| ------- | -------- | ---------- | ----- |
| - | S1_OT_FABRIC is11cotagg02a | All | Enabled |

#### SNMP EngineID Configuration

| Type | EngineID (Hex) | IP | Port |
| ---- | -------------- | -- | ---- |
| local | b6ac2afa96d2670a7d07d4540a0b1863e9f93efc | - | - |
...
| ---- | ----- | ------- | -------------- | ------- | -------------- | ----------- | --------- |
| SNMPManager | network-admin | v3 | sha | aes | - | - | b6ac2afa96d2670a7d07d4540a0b1863e9f93efc |

#### SNMP Device Configuration

```eos
!
snmp-server engineID local b6ac2afa96d2670a7d07d4540a0b1863e9f93efc
snmp-server location S1_OT_FABRIC is11cotagg02a
...
snmp-server user SNMPManager network-admin v3 localized b6ac2afa96d2670a7d07d4540a0b1863e9f93efc auth sha <removed> priv aes <removed>
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet1 | [L]_HS11COT01A_Ethernet50 | *trunk | *349 | *- | *- | 1 |
| Ethernet2 | [L]_HS11COT02A_Ethernet50 | *trunk | *349 | *- | *- | 2 |
| Ethernet3 | [L]_HS11COT03A_Ethernet50 | *trunk | *349 | *- | *- | 3 |
| Ethernet4 | [L]_HS11COT04A_Ethernet50 | *trunk | *349 | *- | *- | 4 |
| Ethernet5 | [L]_HS11COT05A_Ethernet50 | *trunk | *349 | *- | *- | 5 |
| Ethernet6 | [L]_HS11COT06A_Ethernet50 | *trunk | *349 | *- | *- | 6 |
| Ethernet7 | [L]_HS11COT07A_Ethernet50 | *trunk | *349 | *- | *- | 7 |
| Ethernet8 | [L]_HS11COT08A_Ethernet50 | *trunk | *349 | *- | *- | 8 |
| Ethernet9 | [L]_HS11COT09A_Ethernet50 | *trunk | *349 | *- | *- | 9 |
| Ethernet10 | [L]_HS11COT10A_Ethernet50 | *trunk | *349 | *- | *- | 10 |
| Ethernet11 | [L]_HS11COT11A_Ethernet50 | *trunk | *349 | *- | *- | 11 |
| Ethernet12 | [L]_HS11COT12A_Ethernet50 | *trunk | *349 | *- | *- | 12 |
| Ethernet13 | [L]_HS11COT13A_Ethernet50 | *trunk | *349 | *- | *- | 13 |
| Ethernet55/1 | [L]_MLAG_PEER_is11cotagg01a_Ethernet55/1 | *trunk | *- | *- | *['MLAG'] | 4094 |
| Ethernet56/1 | [L]_MLAG_PEER_is11cotagg01a_Ethernet56/1 | *trunk | *- | *- | *['MLAG'] | 4094 |
...
interface Ethernet55/1
   description [L]_MLAG_PEER_is11cotagg01a_Ethernet55/1
   no shutdown
   channel-group 4094 mode active
!
interface Ethernet56/1
   description [L]_MLAG_PEER_is11cotagg01a_Ethernet56/1
   no shutdown
   channel-group 4094 mode active
```
...
| Port-Channel4094 | [L]_MLAG_PEER_is11cotagg01a_Po551 | switched | trunk | - | - | ['MLAG'] | - | - | - | - |
...
interface Port-Channel4094
   description [L]_MLAG_PEER_is11cotagg01a_Po551
   no shutdown
   switchport
   switchport mode trunk
...
!
interface Vxlan1
   description is11cotagg02a_VTEP
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 349 | 172.21.3.13:10349 | 10349:10349 | - | - | learned |
...
router bgp 65120.21205
   ...
   neighbor MLAG-IPv4-UNDERLAY-PEER description is11cotagg01a
