...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | mgmt | 10.211.240.171/22 | 10.211.240.1 |
...
| ------- | -------- | ---------- | ----- |
| - | S1_OT_FABRIC hs11gwot04a | All | Enabled |

#### SNMP EngineID Configuration

| Type | EngineID (Hex) | IP | Port |
| ---- | -------------- | -- | ---- |
| local | 8ca5553e5c213683c58d6ba5f033b1596b0be726 | - | - |
...
| ---- | ----- | ------- | -------------- | ------- | -------------- | ----------- | --------- |
| SNMPManager | network-admin | v3 | sha | aes | - | - | 8ca5553e5c213683c58d6ba5f033b1596b0be726 |

#### SNMP Device Configuration

```eos
!
snmp-server engineID local 8ca5553e5c213683c58d6ba5f033b1596b0be726
snmp-server location S1_OT_FABRIC hs11gwot04a
...
snmp-server user SNMPManager network-admin v3 localized 8ca5553e5c213683c58d6ba5f033b1596b0be726 auth sha <removed> priv aes <removed>
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet49 | [L]_IS11GWOTAGG01AA_Ethernet4 | *trunk | *349 | *- | *- | 49 |
| Ethernet50 | [L]_IS11GWOTAGG01BA_Ethernet4 | *trunk | *349 | *- | *- | 49 |
...
interface Ethernet49
   description [L]_IS11GWOTAGG01AA_Ethernet4
   no shutdown
   channel-group 49 mode active
!
interface Ethernet50
   description [L]_IS11GWOTAGG01BA_Ethernet4
   no shutdown
   channel-group 49 mode active
```
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel49 | [L]_S1_VTEP_1GWOT_01_Po4 | switched | trunk | 349 | - | - | - | - | - | - |
...
interface Port-Channel49
   description [L]_S1_VTEP_1GWOT_01_Po4
   no shutdown
   switchport
