...
| ------- | -------- | ---------- | ----- |
| - | S1_OT_FABRIC hs11cotagg03a | All | Enabled |

#### SNMP EngineID Configuration

| Type | EngineID (Hex) | IP | Port |
| ---- | -------------- | -- | ---- |
| local | 1542e444ea35459012ae790fd2096ae025aa39de | - | - |
...
| ---- | ----- | ------- | -------------- | ------- | -------------- | ----------- | --------- |
| SNMPManager | network-admin | v3 | sha | aes | - | - | 1542e444ea35459012ae790fd2096ae025aa39de |

#### SNMP Device Configuration

```eos
!
snmp-server engineID local 1542e444ea35459012ae790fd2096ae025aa39de
snmp-server location S1_OT_FABRIC hs11cotagg03a
...
snmp-server user SNMPManager network-admin v3 localized 1542e444ea35459012ae790fd2096ae025aa39de auth sha <removed> priv aes <removed>
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet1 | [L]_HS11COT14A_Ethernet49 | *trunk | *none | *- | *- | 1 |
| Ethernet2 | [L]_HS11COT15A_Ethernet49 | *trunk | *none | *- | *- | 2 |
| Ethernet3 | [L]_HS11COT16A_Ethernet49 | *trunk | *none | *- | *- | 3 |
| Ethernet4 | [L]_HS11COT17A_Ethernet49 | *trunk | *none | *- | *- | 4 |
| Ethernet5 | [L]_HS11COT18A_Ethernet49 | *trunk | *none | *- | *- | 5 |
| Ethernet6 | [L]_HS11COT19A_Ethernet49 | *trunk | *none | *- | *- | 6 |
| Ethernet7 | [L]_HS11COT20A_Ethernet49 | *trunk | *none | *- | *- | 7 |
| Ethernet8 | [L]_HS11COT21A_Ethernet49 | *trunk | *none | *- | *- | 8 |
| Ethernet9 | [L]_HS11COT22A_Ethernet49 | *trunk | *none | *- | *- | 9 |
| Ethernet10 | [L]_HS11COT23A_Ethernet49 | *trunk | *none | *- | *- | 10 |
| Ethernet11 | [L]_HS11COT24A_Ethernet49 | *trunk | *none | *- | *- | 11 |
| Ethernet12 | [L]_HS11COT25A_Ethernet49 | *trunk | *none | *- | *- | 12 |
| Ethernet55/1 | [L]_MLAG_PEER_hs11cotagg04a_Ethernet55/1 | *trunk | *- | *- | *['MLAG'] | 4094 |
| Ethernet56/1 | [L]_MLAG_PEER_hs11cotagg04a_Ethernet56/1 | *trunk | *- | *- | *['MLAG'] | 4094 |
...
interface Ethernet55/1
   description [L]_MLAG_PEER_hs11cotagg04a_Ethernet55/1
   no shutdown
   channel-group 4094 mode active
!
interface Ethernet56/1
   description [L]_MLAG_PEER_hs11cotagg04a_Ethernet56/1
   no shutdown
   channel-group 4094 mode active
```
...
| Port-Channel4094 | [L]_MLAG_PEER_hs11cotagg04a_Po551 | switched | trunk | - | - | ['MLAG'] | - | - | - | - |
...
interface Port-Channel4094
   description [L]_MLAG_PEER_hs11cotagg04a_Po551
   no shutdown
   switchport
   switchport mode trunk
...
!
interface Vxlan1
   description hs11cotagg03a_VTEP
...
router bgp 65120.21206
   ...
   neighbor MLAG-IPv4-UNDERLAY-PEER description hs11cotagg04a
