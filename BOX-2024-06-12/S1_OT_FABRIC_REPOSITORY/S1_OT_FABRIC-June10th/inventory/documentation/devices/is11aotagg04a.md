...
| ------- | -------- | ---------- | ----- |
| - | S1_OT_FABRIC is11aotagg04a | All | Enabled |

#### SNMP EngineID Configuration

| Type | EngineID (Hex) | IP | Port |
| ---- | -------------- | -- | ---- |
| local | 8258d7fbf8fa0bb5e6aa444edbe87533e1d6c384 | - | - |
...
| ---- | ----- | ------- | -------------- | ------- | -------------- | ----------- | --------- |
| SNMPManager | network-admin | v3 | sha | aes | - | - | 8258d7fbf8fa0bb5e6aa444edbe87533e1d6c384 |

#### SNMP Device Configuration

```eos
!
snmp-server engineID local 8258d7fbf8fa0bb5e6aa444edbe87533e1d6c384
snmp-server location S1_OT_FABRIC is11aotagg04a
...
snmp-server user SNMPManager network-admin v3 localized 8258d7fbf8fa0bb5e6aa444edbe87533e1d6c384 auth sha <removed> priv aes <removed>
...
| Ethernet55/1 | [L]_MLAG_PEER_is11aotagg03a_Ethernet55/1 | *trunk | *- | *- | *['MLAG'] | 4094 |
| Ethernet56/1 | [L]_MLAG_PEER_is11aotagg03a_Ethernet56/1 | *trunk | *- | *- | *['MLAG'] | 4094 |
...
interface Ethernet55/1
   description [L]_MLAG_PEER_is11aotagg03a_Ethernet55/1
   no shutdown
   channel-group 4094 mode active
!
interface Ethernet56/1
   description [L]_MLAG_PEER_is11aotagg03a_Ethernet56/1
   no shutdown
   channel-group 4094 mode active
```
...
| Port-Channel4094 | [L]_MLAG_PEER_is11aotagg03a_Po551 | switched | trunk | - | - | ['MLAG'] | - | - | - | - |
...
interface Port-Channel4094
   description [L]_MLAG_PEER_is11aotagg03a_Po551
   no shutdown
   switchport
   switchport mode trunk
...
!
interface Vxlan1
   description is11aotagg04a_VTEP
...
router bgp 65120.21208
   ...
   neighbor MLAG-IPv4-UNDERLAY-PEER description is11aotagg03a
