...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | mgmt | 10.211.240.238/22 | 10.211.240.238 |
...
| ------- | -------- | ---------- | ----- |
| - | S1-OT_FABRIC HS13XSOT01A | All | Enabled |
...
snmp-server location S1-OT_FABRIC HS13XSOT01A
...
| --- | ------------------ | ----------- | -------------- | ----------------------- | --- | ---------- | ------ |
| mgmt | 0.0.0.0/0 | 10.211.240.238 | - | 1 | - | - | - |

#### Static Routes Device Configuration

```eos
!
ip route vrf mgmt 0.0.0.0/0 10.211.240.238
```
