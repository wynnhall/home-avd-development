...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | mgmt | 10.211.240.230/22 | 10.211.240.230 |
...
| ------- | -------- | ---------- | ----- |
| - | S1-OT_FABRIC HS11BEOT03A | All | Enabled |

#### SNMP EngineID Configuration

| Type | EngineID (Hex) | IP | Port |
| ---- | -------------- | -- | ---- |
| local | be9b4f1fd462b291b9c0953caeeb29a93d590cbd | - | - |
...
| ---- | ----- | ------- | -------------- | ------- | -------------- | ----------- | --------- |
| SNMPManager | network-admin | v3 | sha | aes | - | - | be9b4f1fd462b291b9c0953caeeb29a93d590cbd |

#### SNMP Device Configuration

```eos
!
snmp-server engineID local be9b4f1fd462b291b9c0953caeeb29a93d590cbd
snmp-server location S1-OT_FABRIC HS11BEOT03A
...
snmp-server user SNMPManager network-admin v3 localized be9b4f1fd462b291b9c0953caeeb29a93d590cbd auth sha <removed> priv aes <removed>
...
| --- | ------------------ | ----------- | -------------- | ----------------------- | --- | ---------- | ------ |
| mgmt | 0.0.0.0/0 | 10.211.240.230 | - | 1 | - | - | - |

#### Static Routes Device Configuration

```eos
!
ip route vrf mgmt 0.0.0.0/0 10.211.240.230
```
