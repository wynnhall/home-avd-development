...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | mgmt | 10.210.241.21/21 | 10.210.241.1 |
...
| ------- | -------- | ---------- | ----- |
| - | SM_CORE_MISC_FABRIC [SM_CORE_MISC_FABRIC] hs00bot02a | All | Enabled |

#### SNMP EngineID Configuration

| Type | EngineID (Hex) | IP | Port |
| ---- | -------------- | -- | ---- |
| local | 115853ef34fee55ceb97f37835db1c91eb4c7cc7 | - | - |
...
| ---- | ----- | ------- | -------------- | ------- | -------------- | ----------- | --------- |
| SNMPManager | network-admin | v3 | sha | aes | - | - | 115853ef34fee55ceb97f37835db1c91eb4c7cc7 |

#### SNMP Device Configuration

```eos
!
snmp-server engineID local 115853ef34fee55ceb97f37835db1c91eb4c7cc7
snmp-server location SM_CORE_MISC_FABRIC [SM_CORE_MISC_FABRIC] hs00bot02a
...
snmp-server user SNMPManager network-admin v3 localized 115853ef34fee55ceb97f37835db1c91eb4c7cc7 auth sha <removed> priv aes <removed>
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet49 |  [L]_ismtmgpan48_Eth1/13 | trunk | - | - | - | - |
| Ethernet50 |  [L]_ismtmgpan49_Eth1/13 | trunk | - | - | - | - |
...
interface Ethernet49
   description [L]_ismtmgpan48_Eth1/13
   no shutdown
   switchport mode trunk
   switchport
!
interface Ethernet50
   description [L]_ismtmgpan49_Eth1/13
   no shutdown
   switchport mode trunk
   switchport
```
...
| --- | ------------------ | ----------- | -------------- | ----------------------- | --- | ---------- | ------ |
| mgmt | 0.0.0.0/0 | 10.210.241.1 | - | 1 | - | - | - |

#### Static Routes Device Configuration

```eos
!
ip route vrf mgmt 0.0.0.0/0 10.210.241.1
```
