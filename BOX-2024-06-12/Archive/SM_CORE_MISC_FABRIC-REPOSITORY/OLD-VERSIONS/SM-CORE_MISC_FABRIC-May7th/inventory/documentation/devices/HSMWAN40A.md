...
| Ethernet5 |  [L]_ISMMGTPAN01_Eth1/13 | access | 440 | - | - | - |
| Ethernet6 |  [L]_ISMMGTPAN02_Eth1/13 | access | 440 | - | - | - |
| Ethernet7 |  [L]_ISMPAN98_Eth1/21 | access | 440 | - | - | - |
| Ethernet8 |  [L]_ISMPAN99_Eth1/21 | access | 440 | - | - | - |
...
!
interface Ethernet7
   description [L]_ISMPAN98_Eth1/21
   no shutdown
   switchport access vlan 440
   switchport mode access
   switchport
!
interface Ethernet8
   description [L]_ISMPAN99_Eth1/21
   no shutdown
   switchport access vlan 440
   switchport mode access
   switchport
