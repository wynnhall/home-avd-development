...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | mgmt | 10.210.80.78/21 | 10.210.80.1 |
...
| ------- | -------- | ---------- | ----- |
| - | SM-CORE_MISC_FABRIC HSMDMZ100A | All | Disabled |

#### SNMP EngineID Configuration

| Type | EngineID (Hex) | IP | Port |
| ---- | -------------- | -- | ---- |
| local | 1ad383c71e1be179b33d525bd6a9861323556db2 | - | - |
...
| ---- | ----- | ------- | -------------- | ------- | -------------- | ----------- | --------- |
| SNMPManager | network-admin | v3 | sha | aes | - | - | 1ad383c71e1be179b33d525bd6a9861323556db2 |

#### SNMP Device Configuration

```eos
!
snmp-server engineID local 1ad383c71e1be179b33d525bd6a9861323556db2
snmp-server location SM-CORE_MISC_FABRIC HSMDMZ100A
...
snmp-server user SNMPManager network-admin v3 localized 1ad383c71e1be179b33d525bd6a9861323556db2 auth sha <removed> priv aes <removed>
...
| --------- | --------------- | ------------ | --------- |
| DMZ_SEGMENT | Vlan4094 | 192.168.0.1 | Port-Channel55 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet49 |  DMZ-Router1_Eth0 | trunk | 100 | - | - | - |
| Ethernet50 |  DMZ-Router2_Eth0 | trunk | 100 | - | - | - |
| Ethernet51 |  ISMPAN98_Eth13 | trunk | 100 | - | - | - |
| Ethernet52 |  ISMPAN99_Eth13 | trunk | 100 | - | - | - |
| Ethernet55 | MLAG_PEER_HSMDMZ101A_Ethernet55 | *trunk | *- | *- | *['MLAG'] | 55 |
| Ethernet56 | MLAG_PEER_HSMDMZ101A_Ethernet56 | *trunk | *- | *- | *['MLAG'] | 55 |
...
interface Ethernet55
   description MLAG_PEER_HSMDMZ101A_Ethernet55
   no shutdown
   speed 25g
   channel-group 55 mode active
!
interface Ethernet56
   description MLAG_PEER_HSMDMZ101A_Ethernet56
   no shutdown
   speed 25g
   channel-group 55 mode active
```
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel55 | MLAG_PEER_HSMDMZ101A_Po55 | switched | trunk | - | - | ['MLAG'] | - | - | - | - |
...
interface Port-Channel55
   description MLAG_PEER_HSMDMZ101A_Po55
   no shutdown
   switchport
   switchport mode trunk
