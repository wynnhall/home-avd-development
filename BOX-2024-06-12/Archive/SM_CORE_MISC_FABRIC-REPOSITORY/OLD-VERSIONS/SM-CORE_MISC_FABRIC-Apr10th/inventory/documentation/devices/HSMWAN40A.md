...
| ------- | -------- | ---------- | ----- |
| - | SM-CORE_MISC_FABRIC HSMWAN40A | All | Enabled |

#### SNMP EngineID Configuration

| Type | EngineID (Hex) | IP | Port |
| ---- | -------------- | -- | ---- |
| local | 93e7b9aa84e6bfbc861b6cd004fe430ec2a53aea | - | - |
...
| ---- | ----- | ------- | -------------- | ------- | -------------- | ----------- | --------- |
| SNMPManager | network-admin | v3 | sha | aes | - | - | 93e7b9aa84e6bfbc861b6cd004fe430ec2a53aea |

#### SNMP Device Configuration

```eos
!
snmp-server engineID local 93e7b9aa84e6bfbc861b6cd004fe430ec2a53aea
snmp-server location SM-CORE_MISC_FABRIC HSMWAN40A
...
snmp-server user SNMPManager network-admin v3 localized 93e7b9aa84e6bfbc861b6cd004fe430ec2a53aea auth sha <removed> priv aes <removed>
...
| ------- | ---- | ------------ |
| 100 | WANRTR-DMZFW-TRANSIT | - |
| 565 | WANRTR-WANFW-TRANSIT | - |
| 573 | WANRTR-MGMTFW-TRANSIT | - |
| 4094 | MLAG_PEER | MLAG |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet1 |  [L]_ISMTMGPAN40_Eth1/21 | access | - | - | - | - |
| Ethernet2 |  [L]_ISMTMGPAN41_Eth1/21 | access | - | - | - | - |
| Ethernet5 |  [L]_ISMMGTPAN01_Eth1/13 | access | - | - | - | - |
| Ethernet6 |  [L]_ISMMGTPAN02_Eth1/13 | access | - | - | - | - |
| Ethernet11 |  [L]_WAN-Router1_Eth0 | access | - | - | - | - |
| Ethernet12 |  [L]_WAN-Router2_Eth0 | access | - | - | - | - |
| Ethernet55/1 | [L]_MLAG_PEER_HSMWAN41A_Ethernet55/1 | *trunk | *- | *- | *['MLAG'] | 4094 |
| Ethernet56/1 | [L]_MLAG_PEER_HSMWAN41A_Ethernet56/1 | *trunk | *- | *- | *['MLAG'] | 4094 |
...
!
interface Ethernet1
   description [L]_ISMTMGPAN40_Eth1/21
   no shutdown
   switchport
!
interface Ethernet2
   description [L]_ISMTMGPAN41_Eth1/21
   no shutdown
   switchport
!
interface Ethernet5
   description [L]_ISMMGTPAN01_Eth1/13
   no shutdown
   switchport
!
interface Ethernet6
   description [L]_ISMMGTPAN02_Eth1/13
   no shutdown
   switchport
!
interface Ethernet11
   description [L]_WAN-Router1_Eth0
   no shutdown
   switchport
!
interface Ethernet12
   description [L]_WAN-Router2_Eth0
   no shutdown
   switchport
!
interface Ethernet55/1
   description [L]_MLAG_PEER_HSMWAN41A_Ethernet55/1
   no shutdown
   speed 100g
   channel-group 4094 mode active
!
interface Ethernet56/1
   description [L]_MLAG_PEER_HSMWAN41A_Ethernet56/1
   no shutdown
   speed 100g
   channel-group 4094 mode active
```
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel4094 | [L]_MLAG_PEER_HSMWAN41A_Po4094 | switched | trunk | - | - | ['MLAG'] | - | - | - | - |
...
interface Port-Channel4094
   description [L]_MLAG_PEER_HSMWAN41A_Po4094
   no shutdown
   switchport
