...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | mgmt | 10.210.241.21/21 | - |
...
| ------- | -------- | ---------- | ----- |
| - | SM-CORE_MISC_FABRIC [SM-CORE_MISC_FABRIC] HS00BOT02A | All | Enabled |
...
snmp-server location SM-CORE_MISC_FABRIC [SM-CORE_MISC_FABRIC] HS00BOT02A
