...
| ------- | -------- | ---------- | ----- |
| - | SM_DC1-DC2_FABRIC SM_DC2_FABRIC ismdc2bl01ba | All | Enabled |

#### SNMP EngineID Configuration

| Type | EngineID (Hex) | IP | Port |
| ---- | -------------- | -- | ---- |
| local | 467954cc85ff194ee6bd66abcafd229253519734 | - | - |
...
| ---- | ----- | ------- | -------------- | ------- | -------------- | ----------- | --------- |
| SNMPManager | network-admin | v3 | sha | aes | - | - | 467954cc85ff194ee6bd66abcafd229253519734 |

#### SNMP Device Configuration

```eos
!
snmp-server engineID local 467954cc85ff194ee6bd66abcafd229253519734
snmp-server location SM_DC1-DC2_FABRIC SM_DC2_FABRIC ismdc2bl01ba
...
snmp-server user SNMPManager network-admin v3 localized 467954cc85ff194ee6bd66abcafd229253519734 auth sha <removed> priv aes <removed>
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet31/1 | [L]_MLAG_PEER_ismdc2bl01aaa_Ethernet31/1 | *trunk | *- | *- | *['MLAG'] | 4094 |
| Ethernet32/1 | [L]_MLAG_PEER_ismdc2bl01aaa_Ethernet32/1 | *trunk | *- | *- | *['MLAG'] | 4094 |
...
| --------- | ----------- | -----| ------- | -------------- |
| Ethernet1/1.510 | [L]_ismcr01a-Eth4/2/1-IT-DCVRF | l3dot1q | - | 510 |
| Ethernet1/1.533 | [L]_ismcr01a-Eth4/2/1-OTVRF | l3dot1q | - | 533 |
| Ethernet2/1.510 | [L]_ismcr02a-Eth4/2/1-IT-DCVRF | l3dot1q | - | 510 |
| Ethernet2/1.533 | [L]_ismcr02a-Eth4/2/1-OTVRF | l3dot1q | - | 533 |
| Ethernet5/1.533 | [L]_isms1otbl01aa-Eth4/1-OTVRF | l3dot1q | - | 533 |
| Ethernet6/1.533 | [L]_isms1otbl01ba-Eth4/1-OTVRF | l3dot1q | - | 533 |

##### IPv4

| Interface | Description | Type | Channel Group | IP Address | VRF |  MTU | Shutdown | ACL In | ACL Out |
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1/1.510 | [L]_ismcr01a-Eth4/2/1-IT-DCVRF | l3dot1q | - | 10.210.234.21/31 | IT-DC | - | False | - | - |
| Ethernet1/1.533 | [L]_ismcr01a-Eth4/2/1-OTVRF | l3dot1q | - | 10.210.234.5/31 | OT | - | False | - | - |
| Ethernet2/1.510 | [L]_ismcr02a-Eth4/2/1-IT-DCVRF | l3dot1q | - | 10.210.234.23/31 | IT-DC | - | False | - | - |
| Ethernet2/1.533 | [L]_ismcr02a-Eth4/2/1-OTVRF | l3dot1q | - | 10.210.234.7/31 | OT | - | False | - | - |
| Ethernet3/1 | P2P_LINK_TO_ismdc1bl01aa_Ethernet4/1 | routed | - | 10.210.226.11/31 | default | 9214 | False | - | - |
| Ethernet4/1 | P2P_LINK_TO_ismdc1bl01ba_Ethernet4/1 | routed | - | 10.210.226.15/31 | default | 9214 | False | - | - |
| Ethernet5/1.533 | [L]_isms1otbl01aa-Eth4/1-OTVRF | l3dot1q | - | 10.210.234.13/31 | OT | - | False | - | - |
| Ethernet6/1.533 | [L]_isms1otbl01ba-Eth4/1-OTVRF | l3dot1q | - | 10.210.234.15/31 | OT | - | False | - | - |
...
interface Ethernet1/1.510
   description [L]_ismcr01a-Eth4/2/1-IT-DCVRF
   no shutdown
...
interface Ethernet1/1.533
   description [L]_ismcr01a-Eth4/2/1-OTVRF
   no shutdown
...
interface Ethernet2/1.510
   description [L]_ismcr02a-Eth4/2/1-IT-DCVRF
   no shutdown
   encapsulation dot1q vlan 510
   vrf IT-DC
...
interface Ethernet2/1.533
   description [L]_ismcr02a-Eth4/2/1-OTVRF
   no shutdown
   encapsulation dot1q vlan 533
   vrf OT
...
interface Ethernet3/1
   description P2P_LINK_TO_ismdc1bl01aa_Ethernet4/1
   no shutdown
   mtu 9214
   no switchport
...
interface Ethernet4/1
   description P2P_LINK_TO_ismdc1bl01ba_Ethernet4/1
   no shutdown
   mtu 9214
   no switchport
...
interface Ethernet5/1.533
   description [L]_isms1otbl01aa-Eth4/1-OTVRF
   no shutdown
   encapsulation dot1q vlan 533
   vrf OT
...
interface Ethernet6/1.533
   description [L]_isms1otbl01ba-Eth4/1-OTVRF
   no shutdown
   encapsulation dot1q vlan 533
   vrf OT
...
interface Ethernet31/1
   description [L]_MLAG_PEER_ismdc2bl01aaa_Ethernet31/1
   no shutdown
   channel-group 4094 mode active
!
interface Ethernet32/1
   description [L]_MLAG_PEER_ismdc2bl01aaa_Ethernet32/1
   no shutdown
   channel-group 4094 mode active
```
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel4094 | [L]_MLAG_PEER_ismdc2bl01aaa_Po311 | switched | trunk | - | - | ['MLAG'] | - | - | - | - |
...
interface Port-Channel4094
   description [L]_MLAG_PEER_ismdc2bl01aaa_Po311
   no shutdown
   switchport
...
| Vlan1019 | 10.210.108.0/23-VCF-WD-VMOTION | OT | - | False |
...
| 10.210.234.20 | Inherited from peer group CORES-EBGP-PEERS-IT-DCVRF | IT-DC | - | - | Inherited from peer group CORES-EBGP-PEERS-IT-DCVRF | - | - | - | - | - | - |
| 10.210.234.22 | Inherited from peer group CORES-EBGP-PEERS-IT-DCVRF | IT-DC | - | - | Inherited from peer group CORES-EBGP-PEERS-IT-DCVRF | - | - | - | - | - | - |
...
| 10.210.234.12 | Inherited from peer group S1-OT-BL-EBGP-PEERS-OTVRF | OT | - | - | Inherited from peer group S1-OT-BL-EBGP-PEERS-OTVRF | - | - | - | - | - | - |
| 10.210.234.14 | Inherited from peer group S1-OT-BL-EBGP-PEERS-OTVRF | OT | - | - | Inherited from peer group S1-OT-BL-EBGP-PEERS-OTVRF | - | - | - | - | - | - |
...
router bgp 65120.12200
   ...
   neighbor MLAG-IPv4-UNDERLAY-PEER description ismdc2bl01aaa
   ...
   vrf IT-DC
      ...
      router-id 172.21.1.25
      update wait-install
      neighbor 10.210.234.20 peer group CORES-EBGP-PEERS-IT-DCVRF
      neighbor 10.210.234.20 description ismcr01a-Eth4/2/1-IT-DCVRF
      neighbor 10.210.234.22 peer group CORES-EBGP-PEERS-IT-DCVRF
      neighbor 10.210.234.22 description ismcr02a-Eth4/2/1-IT-DCVRF
   ...
   vrf OT
      ...
      neighbor 10.210.234.4 description ismcr01a-Eth4/2/1-OTVRF
      neighbor 10.210.234.6 peer group CORES-EBGP-PEERS-OTVRF
      neighbor 10.210.234.6 description ismcr02a-Eth4/2/1-OTVRF
      neighbor 10.210.234.12 peer group S1-OT-BL-EBGP-PEERS-OTVRF
      neighbor 10.210.234.12 description isms1otbl01aa-Eth4/1-OTVRF
      neighbor 10.210.234.14 peer group S1-OT-BL-EBGP-PEERS-OTVRF
      neighbor 10.210.234.14 description isms1otbl01ba-Eth4/1-OTVRF
      redistribute connected route-map RM-LOCAL-NETWORKS
      !
      address-family ipv4
         neighbor 10.210.234.4 activate
         neighbor 10.210.234.6 activate
         neighbor 10.210.234.12 activate
         neighbor 10.210.234.14 activate
```
