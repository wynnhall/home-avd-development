...
| ------- | -------- | ---------- | ----- |
| - | SM_DC1-DC2_FABRIC SM_DC2_FABRIC hsmdc2g702a | All | Enabled |

#### SNMP EngineID Configuration

| Type | EngineID (Hex) | IP | Port |
| ---- | -------------- | -- | ---- |
| local | 6ad870a58ac272773428f790001ea1751ff8690b | - | - |
...
| ---- | ----- | ------- | -------------- | ------- | -------------- | ----------- | --------- |
| SNMPManager | network-admin | v3 | sha | aes | - | - | 6ad870a58ac272773428f790001ea1751ff8690b |

#### SNMP Device Configuration

```eos
!
snmp-server engineID local 6ad870a58ac272773428f790001ea1751ff8690b
snmp-server location SM_DC1-DC2_FABRIC SM_DC2_FABRIC hsmdc2g702a
...
snmp-server user SNMPManager network-admin v3 localized 6ad870a58ac272773428f790001ea1751ff8690b auth sha <removed> priv aes <removed>
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet55/1 | [L]_MLAG_PEER_hsmdc2g701a_Ethernet55/1 | *trunk | *- | *- | *['MLAG'] | 4094 |
| Ethernet56/1 | [L]_MLAG_PEER_hsmdc2g701a_Ethernet56/1 | *trunk | *- | *- | *['MLAG'] | 4094 |
...
interface Ethernet55/1
   description [L]_MLAG_PEER_hsmdc2g701a_Ethernet55/1
   no shutdown
   channel-group 4094 mode active
!
interface Ethernet56/1
   description [L]_MLAG_PEER_hsmdc2g701a_Ethernet56/1
   no shutdown
   channel-group 4094 mode active
```
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel4094 | [L]_MLAG_PEER_hsmdc2g701a_Po551 | switched | trunk | - | - | ['MLAG'] | - | - | - | - |
...
interface Port-Channel4094
   description [L]_MLAG_PEER_hsmdc2g701a_Po551
   no shutdown
   switchport
...
router bgp 65120.12206
   ...
   neighbor MLAG-IPv4-UNDERLAY-PEER description hsmdc2g701a
