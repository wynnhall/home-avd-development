...
| --------- | --------------- | ------------ | --------- |
| DC2_BL1_2 | Vlan4094 | 172.16.0.9 | Port-Channel3 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet3 | MLAG_PEER_DC2-BL2_Ethernet3 | *trunk | *- | *- | *['LEAF_PEER_L3', 'MLAG'] | 3 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_LINK_TO_DC2-SP1_Ethernet5 | routed | - | 192.168.2.17/31 | default | 1500 | False | - | - |
| Ethernet2 | P2P_LINK_TO_DC2-SP2_Ethernet5 | routed | - | 192.168.2.19/31 | default | 1500 | False | - | - |
| Ethernet4 | P2P_LINK_TO_DC1-BL1_Ethernet4 | routed | - | 192.168.3.1/31 | default | 1500 | False | - | - |
...
!
interface Ethernet3
   description MLAG_PEER_DC2-BL2_Ethernet3
   no shutdown
   speed 100g
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel3 | MLAG_PEER_DC2-BL2_Po3 | switched | trunk | - | - | ['LEAF_PEER_L3', 'MLAG'] | - | - | - | - |
...
interface Port-Channel3
   description MLAG_PEER_DC2-BL2_Po3
   no shutdown
   switchport
...
| Loopback1 | VTEP_VXLAN_Tunnel_Source | default | 192.168.201.5/32 |
| Loopback100 | RED_VTEP_DIAGNOSTICS | RED | 10.100.100.5/32 |
| Loopback101 | BLUE_VTEP_DIAGNOSTICS | BLUE | 10.100.101.5/32 |
...
interface Loopback100
   ...
   no shutdown
   vrf RED
   ip address 10.100.100.5/32
!
interface Loopback101
   description BLUE_VTEP_DIAGNOSTICS
   no shutdown
   vrf BLUE
   ip address 10.100.101.5/32
```
...
| Vlan4000 |  RED  |  172.16.1.8/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan4001 |  BLUE  |  172.16.1.8/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan4093 |  default  |  172.16.1.8/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan4094 |  default  |  172.16.0.8/31  |  -  |  -  |  -  |  -  |  -  |
...
| -------- | --------- | --- | -------- | -------------- | -------------- | ---------- | --- | --------------------- | ---------------------- | ------- |
| 172.16.1.9 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | default | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - |
| 192.168.2.16 | 65001.0 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
| 192.168.2.18 | 65001.0 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
| 192.168.3.0 | 65000.7 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
| 192.168.100.7 | 65000.7 | default | - | Inherited from peer group EVPN-OVERLAY-CORE | Inherited from peer group EVPN-OVERLAY-CORE | - | Inherited from peer group EVPN-OVERLAY-CORE | - | - | - |
| 192.168.100.8 | 65000.7 | default | - | Inherited from peer group EVPN-OVERLAY-CORE | Inherited from peer group EVPN-OVERLAY-CORE | - | Inherited from peer group EVPN-OVERLAY-CORE | - | - | - |
...
| 172.16.1.9 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | BLUE | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - |
| 172.16.1.9 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | RED | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 10 | 192.168.101.5:10010 | 10010:10010<br>remote 10010:10010 | - | - | learned |
| 20 | 192.168.101.5:10020 | 10020:10020<br>remote 10020:10020 | - | - | learned |

#### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute |
| --- | ------------------- | ------------ |
| BLUE | 192.168.101.5:1002 | connected |
| RED | 192.168.101.5:1001 | connected |
...
router bgp 65001.5
   ...
   neighbor MLAG-IPv4-UNDERLAY-PEER remote-as 65001.5
   ...
   neighbor 172.16.1.9 peer group MLAG-IPv4-UNDERLAY-PEER
   neighbor 172.16.1.9 description DC2-BL2
   neighbor 192.168.2.16 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.2.16 remote-as 65001.0
   neighbor 192.168.2.16 description DC2-SP1_Ethernet5
   neighbor 192.168.2.18 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.2.18 remote-as 65001.0
   neighbor 192.168.2.18 description DC2-SP2_Ethernet5
   neighbor 192.168.3.0 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.3.0 remote-as 65000.7
   neighbor 192.168.3.0 description DC1-BL1
   ...
   vlan 10
      ...
      rd evpn domain remote 192.168.101.5:10010
   ...
   vlan 20
      ...
      rd evpn domain remote 192.168.101.5:10020
...
```eos
!
ip address virtual source-nat vrf BLUE address 10.100.101.5
ip address virtual source-nat vrf RED address 10.100.100.5
```
