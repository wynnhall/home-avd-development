...
| ------- | -------- | ---------- | ----- |
| - | SM_DC1-DC2_FABRIC SM_DC1_FABRIC ismdc1bl01aaa | All | Enabled |

#### SNMP EngineID Configuration

| Type | EngineID (Hex) | IP | Port |
| ---- | -------------- | -- | ---- |
| local | 8697e5d4059cd200e5c049a0b758a723c8245e44 | - | - |
...
| ---- | ----- | ------- | -------------- | ------- | -------------- | ----------- | --------- |
| SNMPManager | network-admin | v3 | sha | aes | - | - | 8697e5d4059cd200e5c049a0b758a723c8245e44 |

#### SNMP Device Configuration

```eos
!
snmp-server engineID local 8697e5d4059cd200e5c049a0b758a723c8245e44
snmp-server location SM_DC1-DC2_FABRIC SM_DC1_FABRIC ismdc1bl01aaa
...
snmp-server user SNMPManager network-admin v3 localized 8697e5d4059cd200e5c049a0b758a723c8245e44 auth sha <removed> priv aes <removed>
...
!
interface Vxlan1
   description ismdc1bl01aaa_VTEP
