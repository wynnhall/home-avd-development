...
| ------- | -------- | ---------- | ----- |
| - | SM_DC1-DC2_FABRIC SM_DC2_FABRIC hsmdc2g401a | All | Enabled |

#### SNMP EngineID Configuration

| Type | EngineID (Hex) | IP | Port |
| ---- | -------------- | -- | ---- |
| local | 62a0282230f2ebe8ccbc066c9e53f93abb8a7a60 | - | - |
...
| ---- | ----- | ------- | -------------- | ------- | -------------- | ----------- | --------- |
| SNMPManager | network-admin | v3 | sha | aes | - | - | 62a0282230f2ebe8ccbc066c9e53f93abb8a7a60 |

#### SNMP Device Configuration

```eos
!
snmp-server engineID local 62a0282230f2ebe8ccbc066c9e53f93abb8a7a60
snmp-server location SM_DC1-DC2_FABRIC SM_DC2_FABRIC hsmdc2g401a
...
snmp-server user SNMPManager network-admin v3 localized 62a0282230f2ebe8ccbc066c9e53f93abb8a7a60 auth sha <removed> priv aes <removed>
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet55/1 | [L]_MLAG_PEER_hsmdc2g402a_Ethernet55/1 | *trunk | *- | *- | *['MLAG'] | 4094 |
| Ethernet56/1 | [L]_MLAG_PEER_hsmdc2g402a_Ethernet56/1 | *trunk | *- | *- | *['MLAG'] | 4094 |
...
interface Ethernet55/1
   description [L]_MLAG_PEER_hsmdc2g402a_Ethernet55/1
   no shutdown
   channel-group 4094 mode active
!
interface Ethernet56/1
   description [L]_MLAG_PEER_hsmdc2g402a_Ethernet56/1
   no shutdown
   channel-group 4094 mode active
```
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel4094 | [L]_MLAG_PEER_hsmdc2g402a_Po551 | switched | trunk | - | - | ['MLAG'] | - | - | - | - |
...
interface Port-Channel4094
   description [L]_MLAG_PEER_hsmdc2g402a_Po551
   no shutdown
   switchport
...
router bgp 65120.12204
   ...
   neighbor MLAG-IPv4-UNDERLAY-PEER description hsmdc2g402a
