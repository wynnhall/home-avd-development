...
| --------- | --------------- | ------------ | --------- |
| DC1_SRVLEAF1_2 | Vlan4094 | 172.16.0.8 | Port-Channel3 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet3 | MLAG_PEER_DC1-SL1_Ethernet3 | *trunk | *- | *- | *['LEAF_PEER_L3', 'MLAG'] | 3 |
| Ethernet4 | fw1_Ethernet2 | *trunk | *50,60 | *- | *- | 4 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_LINK_TO_DC1-SP1_Ethernet6 | routed | - | 192.168.1.21/31 | default | 1500 | False | - | - |
| Ethernet2 | P2P_LINK_TO_DC1-SP2_Ethernet6 | routed | - | 192.168.1.23/31 | default | 1500 | False | - | - |
...
!
interface Ethernet3
   description MLAG_PEER_DC1-SL1_Ethernet3
   no shutdown
   speed 100g
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel3 | MLAG_PEER_DC1-SL1_Po3 | switched | trunk | - | - | ['LEAF_PEER_L3', 'MLAG'] | - | - | - | - |
| Port-Channel4 | fw1_PortChannel10 | switched | trunk | 50,60 | - | - | - | - | 4 | - |
...
interface Port-Channel3
   description MLAG_PEER_DC1-SL1_Po3
   no shutdown
   switchport
...
| Vlan50 | V50-T-A-VRF-RED | RED | - | False |
| Vlan60 | V60-T-A-VRF-BLUE | BLUE | - | False |
...
| Vlan50 |  RED  |  -  |  10.10.50.254/24  |  -  |  -  |  -  |  -  |
| Vlan60 |  BLUE  |  -  |  10.10.60.254/24  |  -  |  -  |  -  |  -  |
...
interface Vlan50
   ...
   no shutdown
   vrf RED
   ip address virtual 10.10.50.254/24
!
interface Vlan60
   description V60-T-A-VRF-BLUE
   no shutdown
   vrf BLUE
   ip address virtual 10.10.60.254/24
!
interface Vlan4000
...
| --- | ------------------ | ----------------------- | ------------------- | ----------------------------- | ----------------- | ----------------------------- | -------------- |
| RED | 0.0.0.0/0 | 10.10.50.10 | - | 1 | - | - | - |
| BLUE | 0.0.0.0/0 | 10.10.60.10 | - | 1 | - | - | - |

#### Static Routes Device Configuration

```eos
!
ip route vrf RED 0.0.0.0/0 10.10.50.10
ip route vrf BLUE 0.0.0.0/0 10.10.60.10
```
...
| 192.168.1.20 | 65000.0 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
| 192.168.1.22 | 65000.0 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 10 | 192.168.100.6:10010 | 10010:10010 | - | - | learned |
| 20 | 192.168.100.6:10020 | 10020:10020 | - | - | learned |
| 30 | 192.168.100.6:10030 | 10030:10030 | - | - | learned |
| 40 | 192.168.100.6:10040 | 10040:10040 | - | - | learned |

#### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute |
| --- | ------------------- | ------------ |
| BLUE | 192.168.100.6:1002 | connected<br>static |
| RED | 192.168.100.6:1001 | connected<br>static |
...
router bgp 65000.5
   ...
   neighbor MLAG-IPv4-UNDERLAY-PEER remote-as 65000.5
   neighbor MLAG-IPv4-UNDERLAY-PEER next-hop-self
   neighbor MLAG-IPv4-UNDERLAY-PEER description DC1-SL1
   neighbor MLAG-IPv4-UNDERLAY-PEER password 7 <removed>
   neighbor MLAG-IPv4-UNDERLAY-PEER send-community
   neighbor MLAG-IPv4-UNDERLAY-PEER maximum-routes 12000
   neighbor MLAG-IPv4-UNDERLAY-PEER route-map RM-MLAG-PEER-IN in
   neighbor 172.16.1.8 peer group MLAG-IPv4-UNDERLAY-PEER
   neighbor 172.16.1.8 description DC1-SL1
   neighbor 192.168.1.20 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.1.20 remote-as 65000.0
   neighbor 192.168.1.20 description DC1-SP1_Ethernet6
   neighbor 192.168.1.22 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.1.22 remote-as 65000.0
   neighbor 192.168.1.22 description DC1-SP2_Ethernet6
   ...
   !
   vlan 10
      rd 192.168.100.6:10010
      route-target both 10010:10010
      redistribute learned
   !
   vlan 20
      rd 192.168.100.6:10020
      route-target both 10020:10020
      redistribute learned
   !
   vlan 30
      rd 192.168.100.6:10030
      route-target both 10030:10030
      redistribute learned
   !
   vlan 40
      rd 192.168.100.6:10040
