...
| --------- | --------------- | ------------ | --------- |
| DC1_SRVLEAF1_2 | Vlan4094 | 172.16.0.9 | Port-Channel3 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet3 | MLAG_PEER_DC1-SL2_Ethernet3 | *trunk | *- | *- | *['LEAF_PEER_L3', 'MLAG'] | 3 |
| Ethernet4 | fw1_Ethernet1 | *trunk | *50,60 | *- | *- | 4 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_LINK_TO_DC1-SP1_Ethernet5 | routed | - | 192.168.1.17/31 | default | 1500 | False | - | - |
| Ethernet2 | P2P_LINK_TO_DC1-SP2_Ethernet5 | routed | - | 192.168.1.19/31 | default | 1500 | False | - | - |
...
!
interface Ethernet3
   description MLAG_PEER_DC1-SL2_Ethernet3
   no shutdown
   speed 100g
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel3 | MLAG_PEER_DC1-SL2_Po3 | switched | trunk | - | - | ['LEAF_PEER_L3', 'MLAG'] | - | - | - | - |
...
interface Port-Channel3
   description MLAG_PEER_DC1-SL2_Po3
   no shutdown
   switchport
...
| 192.168.1.16 | 65000.0 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
| 192.168.1.18 | 65000.0 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
...
| 20 | 192.168.100.5:10020 | 10020:10020 | - | - | learned |
| 30 | 192.168.100.5:10030 | 10030:10030 | - | - | learned |
| 40 | 192.168.100.5:10040 | 10040:10040 | - | - | learned |

#### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute |
| --- | ------------------- | ------------ |
| BLUE | 192.168.100.5:1002 | connected<br>static |
| RED | 192.168.100.5:1001 | connected<br>static |
...
router bgp 65000.5
   ...
   neighbor MLAG-IPv4-UNDERLAY-PEER description DC1-SL2
   neighbor MLAG-IPv4-UNDERLAY-PEER password 7 <removed>
   neighbor MLAG-IPv4-UNDERLAY-PEER send-community
   neighbor MLAG-IPv4-UNDERLAY-PEER maximum-routes 12000
   neighbor MLAG-IPv4-UNDERLAY-PEER route-map RM-MLAG-PEER-IN in
   neighbor 172.16.1.9 peer group MLAG-IPv4-UNDERLAY-PEER
   neighbor 172.16.1.9 description DC1-SL2
   neighbor 192.168.1.16 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.1.16 remote-as 65000.0
   neighbor 192.168.1.16 description DC1-SP1_Ethernet5
   neighbor 192.168.1.18 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.1.18 remote-as 65000.0
   neighbor 192.168.1.18 description DC1-SP2_Ethernet5
   ...
   !
   vlan 20
      rd 192.168.100.5:10020
      route-target both 10020:10020
      redistribute learned
   !
   vlan 30
      rd 192.168.100.5:10030
      route-target both 10030:10030
      redistribute learned
   !
   vlan 40
      rd 192.168.100.5:10040
