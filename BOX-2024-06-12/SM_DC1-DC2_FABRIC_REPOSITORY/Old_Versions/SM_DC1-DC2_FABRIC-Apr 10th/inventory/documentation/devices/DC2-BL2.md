...
| --------- | --------------- | ------------ | --------- |
| DC2_BL1_2 | Vlan4094 | 172.16.0.8 | Port-Channel3 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet3 | MLAG_PEER_DC2-BL1_Ethernet3 | *trunk | *- | *- | *['LEAF_PEER_L3', 'MLAG'] | 3 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_LINK_TO_DC2-SP1_Ethernet6 | routed | - | 192.168.2.21/31 | default | 1500 | False | - | - |
| Ethernet2 | P2P_LINK_TO_DC2-SP2_Ethernet6 | routed | - | 192.168.2.23/31 | default | 1500 | False | - | - |
| Ethernet4 | P2P_LINK_TO_DC1-BL2_Ethernet4 | routed | - | 192.168.3.3/31 | default | 1500 | False | - | - |
...
!
interface Ethernet3
   description MLAG_PEER_DC2-BL1_Ethernet3
   no shutdown
   speed 100g
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel3 | MLAG_PEER_DC2-BL1_Po3 | switched | trunk | - | - | ['LEAF_PEER_L3', 'MLAG'] | - | - | - | - |
...
interface Port-Channel3
   description MLAG_PEER_DC2-BL1_Po3
   no shutdown
   switchport
...
| Loopback100 | RED_VTEP_DIAGNOSTICS | RED | 10.100.100.6/32 |
| Loopback101 | BLUE_VTEP_DIAGNOSTICS | BLUE | 10.100.101.6/32 |
...
| Vlan4000 |  RED  |  172.16.1.9/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan4001 |  BLUE  |  172.16.1.9/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan4093 |  default  |  172.16.1.9/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan4094 |  default  |  172.16.0.9/31  |  -  |  -  |  -  |  -  |  -  |
...
| -------- | --------- | --- | -------- | -------------- | -------------- | ---------- | --- | --------------------- | ---------------------- | ------- |
| 172.16.1.8 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | default | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - |
| 192.168.2.20 | 65001.0 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
| 192.168.2.22 | 65001.0 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
| 192.168.3.2 | 65000.7 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
...
| 172.16.1.8 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | BLUE | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - |
| 172.16.1.8 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | RED | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 10 | 192.168.101.6:10010 | 10010:10010<br>remote 10010:10010 | - | - | learned |
| 20 | 192.168.101.6:10020 | 10020:10020<br>remote 10020:10020 | - | - | learned |

#### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute |
| --- | ------------------- | ------------ |
| BLUE | 192.168.101.6:1002 | connected |
| RED | 192.168.101.6:1001 | connected |
...
router bgp 65001.5
   ...
   neighbor 172.16.1.8 peer group MLAG-IPv4-UNDERLAY-PEER
   neighbor 172.16.1.8 description DC2-BL1
   neighbor 192.168.2.20 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.2.20 remote-as 65001.0
   neighbor 192.168.2.20 description DC2-SP1_Ethernet6
   neighbor 192.168.2.22 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.2.22 remote-as 65001.0
   neighbor 192.168.2.22 description DC2-SP2_Ethernet6
   neighbor 192.168.3.2 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.3.2 remote-as 65000.7
   neighbor 192.168.3.2 description DC1-BL2
   ...
   vlan 10
      ...
      rd evpn domain remote 192.168.101.6:10010
   ...
   vlan 20
      ...
      rd evpn domain remote 192.168.101.6:10020
...
```eos
!
ip address virtual source-nat vrf BLUE address 10.100.101.6
ip address virtual source-nat vrf RED address 10.100.100.6
```
