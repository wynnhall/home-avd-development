...
| ---- | -------------- | -- | ---- |
| local | 5576ef73cce6fb006426ca19f333f432e40116dd | - | - |
...
| ---- | ----- | ------- | -------------- | ------- | -------------- | ----------- | --------- |
| SNMPManager | network-admin | v3 | sha | aes | - | - | 5576ef73cce6fb006426ca19f333f432e40116dd |

#### SNMP Device Configuration

```eos
!
snmp-server engineID local 5576ef73cce6fb006426ca19f333f432e40116dd
...
snmp-server user SNMPManager network-admin v3 localized 5576ef73cce6fb006426ca19f333f432e40116dd auth sha <removed> priv aes <removed>
