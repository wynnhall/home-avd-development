...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | mgmt | 10.211.240.23/22 | 10.211.240.1 |
...
| ------- | -------- | ---------- | ----- |
| - | SM_IT_FABRIC HS1LLKK02A | All | Enabled |

#### SNMP EngineID Configuration

| Type | EngineID (Hex) | IP | Port |
| ---- | -------------- | -- | ---- |
| local | fc01aff974b829c03562f508358d3d2145223733 | - | - |
...
| ---- | ----- | ------- | -------------- | ------- | -------------- | ----------- | --------- |
| SNMPManager | network-admin | v3 | sha | aes | - | - | fc01aff974b829c03562f508358d3d2145223733 |

#### SNMP Device Configuration

```eos
!
snmp-server engineID local fc01aff974b829c03562f508358d3d2145223733
snmp-server location SM_IT_FABRIC HS1LLKK02A
...
snmp-server user SNMPManager network-admin v3 localized fc01aff974b829c03562f508358d3d2145223733 auth sha <removed> priv aes <removed>
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet49 | [L]_ISMITAGG01A_Ethernet7 | *trunk | *221,224-225,227,237,243,245,247,250,305,307,309,337,951 | *- | *- | 49 |
| Ethernet50 | [L]_ISMITAGG02A_Ethernet7 | *trunk | *221,224-225,227,237,243,245,247,250,305,307,309,337,951 | *- | *- | 49 |
...
interface Ethernet49
   description [L]_ISMITAGG01A_Ethernet7
   no shutdown
   channel-group 49 mode active
!
interface Ethernet50
   description [L]_ISMITAGG02A_Ethernet7
   no shutdown
   channel-group 49 mode active
```
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel49 | [L]_IT_AGG_LEAFS_Po7 | switched | trunk | 221,224-225,227,237,243,245,247,250,305,307,309,337,951 | - | - | - | - | - | - |
...
interface Port-Channel49
   description [L]_IT_AGG_LEAFS_Po7
   no shutdown
   switchport
