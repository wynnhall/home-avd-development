...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | mgmt | 10.215.242.20/23 | 10.215.242.1 |
...
| ------- | -------- | ---------- | ----- |
| - | SM_IT_FABRIC HSM2VIT01A | All | Enabled |

#### SNMP EngineID Configuration

| Type | EngineID (Hex) | IP | Port |
| ---- | -------------- | -- | ---- |
| local | 02f8f35a4587b583b824684268274a862b32ec1b | - | - |
...
| ---- | ----- | ------- | -------------- | ------- | -------------- | ----------- | --------- |
| SNMPManager | network-admin | v3 | sha | aes | - | - | 02f8f35a4587b583b824684268274a862b32ec1b |

#### SNMP Device Configuration

```eos
!
snmp-server engineID local 02f8f35a4587b583b824684268274a862b32ec1b
snmp-server location SM_IT_FABRIC HSM2VIT01A
...
snmp-server user SNMPManager network-admin v3 localized 02f8f35a4587b583b824684268274a862b32ec1b auth sha <removed> priv aes <removed>
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet49 | [L]_ISMITAGG01A_Ethernet1 | *trunk | *221,224-225,227,237,243,245,247,250,305,307,309,337,951 | *- | *- | 49 |
| Ethernet50 | [L]_ISMITAGG02A_Ethernet1 | *trunk | *221,224-225,227,237,243,245,247,250,305,307,309,337,951 | *- | *- | 49 |
...
interface Ethernet49
   description [L]_ISMITAGG01A_Ethernet1
   no shutdown
   channel-group 49 mode active
!
interface Ethernet50
   description [L]_ISMITAGG02A_Ethernet1
   no shutdown
   channel-group 49 mode active
```
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel49 | [L]_IT_AGG_LEAFS_Po1 | switched | trunk | 221,224-225,227,237,243,245,247,250,305,307,309,337,951 | - | - | - | - | - | - |
...
interface Port-Channel49
   description [L]_IT_AGG_LEAFS_Po1
   no shutdown
   switchport
