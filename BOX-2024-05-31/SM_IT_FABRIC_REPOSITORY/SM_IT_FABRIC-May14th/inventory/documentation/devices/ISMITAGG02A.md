...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | mgmt | 10.210.80.66/21 | 10.210.80.1 |
...
| ------- | -------- | ---------- | ----- |
| - | SM_IT_FABRIC ISMITAGG02A | All | Enabled |

#### SNMP EngineID Configuration

| Type | EngineID (Hex) | IP | Port |
| ---- | -------------- | -- | ---- |
| local | 53ed7263df6cdeaea3eb16a1dc38b3184b64b693 | - | - |
...
| ---- | ----- | ------- | -------------- | ------- | -------------- | ----------- | --------- |
| SNMPManager | network-admin | v3 | sha | aes | - | - | 53ed7263df6cdeaea3eb16a1dc38b3184b64b693 |

#### SNMP Device Configuration

```eos
!
snmp-server engineID local 53ed7263df6cdeaea3eb16a1dc38b3184b64b693
snmp-server location SM_IT_FABRIC ISMITAGG02A
...
snmp-server user SNMPManager network-admin v3 localized 53ed7263df6cdeaea3eb16a1dc38b3184b64b693 auth sha <removed> priv aes <removed>
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet1 | [L]_HSM2VIT01A_Ethernet50 | *trunk | *221,224-225,227,237,243,245,247,250,305,307,309,337,951 | *- | *- | 1 |
| Ethernet2 | [L]_HSM2VIT02A_Ethernet50 | *trunk | *221,224-225,227,237,243,245,247,250,305,307,309,337,951 | *- | *- | 2 |
| Ethernet3 | [L]_HSMPGIT01A_Ethernet50 | *trunk | *221,224-225,227,237,243,245,247,250,305,307,309,337,951 | *- | *- | 3 |
| Ethernet4 | [L]_HSM3VIT01A_Ethernet50 | *trunk | *221,224-225,227,237,243,245,247,250,305,307,309,337,951 | *- | *- | 4 |
| Ethernet5 | [L]_HSM3VIT02A_Ethernet50 | *trunk | *221,224-225,227,237,243,245,247,250,305,307,309,337,951 | *- | *- | 5 |
| Ethernet6 | [L]_HS1LLKK01A_Ethernet50 | *trunk | *221,224-225,227,237,243,245,247,250,305,307,309,337,951 | *- | *- | 6 |
| Ethernet7 | [L]_HS1LLKK02A_Ethernet50 | *trunk | *221,224-225,227,237,243,245,247,250,305,307,309,337,951 | *- | *- | 7 |
| Ethernet8 | [L]_HS1CUPIT01A_Ethernet50 | *trunk | *221,224-225,227,237,243,245,247,250,305,307,309,337,951 | *- | *- | 8 |
| Ethernet9 | [L]_HS1CUPIT02A_Ethernet50 | *trunk | *221,224-225,227,237,243,245,247,250,305,307,309,337,951 | *- | *- | 9 |
| Ethernet55/1 | [L]_MLAG_PEER_ISMITAGG01A_Ethernet55/1 | *trunk | *- | *- | *['MLAG'] | 4094 |
| Ethernet56/1 | [L]_MLAG_PEER_ISMITAGG01A_Ethernet56/1 | *trunk | *- | *- | *['MLAG'] | 4094 |
...
interface Ethernet50/1
   description [L]_P2P_LINK_TO_ISMS1ITSP02A_Ethernet6/1/1
   no shutdown
   mtu 9214
   no switchport
   ipv6 enable
...
interface Ethernet51/1
   description [L]_P2P_LINK_TO_ISMS1ITSP03A_Ethernet6/1/1
   no shutdown
   mtu 9214
   no switchport
   ipv6 enable
...
interface Ethernet55/1
   description [L]_MLAG_PEER_ISMITAGG01A_Ethernet55/1
   no shutdown
   channel-group 4094 mode active
!
interface Ethernet56/1
   description [L]_MLAG_PEER_ISMITAGG01A_Ethernet56/1
   no shutdown
   channel-group 4094 mode active
```
...
| Port-Channel4094 | [L]_MLAG_PEER_ISMITAGG01A_Po551 | switched | trunk | - | - | ['MLAG'] | - | - | - | - |
