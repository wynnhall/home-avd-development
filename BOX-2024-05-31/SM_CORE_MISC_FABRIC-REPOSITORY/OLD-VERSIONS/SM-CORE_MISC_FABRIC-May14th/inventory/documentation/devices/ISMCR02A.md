...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet3/5/1 | [L]_ISMTMGPAN40 | *trunk | *525,510,533 | *- | *- | 351 |
| Ethernet3/48/1 | [L]_MLAG_PEER_ISMCR01A_Ethernet3/48/1 | *trunk | *- | *- | *['MLAG'] | 4094 |
| Ethernet4/5/1 | [L]_ISMTMGPAN41 | *trunk | *525,510,533 | *- | *- | 451 |
| Ethernet4/48/1 | [L]_MLAG_PEER_ISMCR01A_Ethernet4/48/1 | *trunk | *- | *- | *['MLAG'] | 4094 |
| Ethernet5/1 | [L]_ISMPAN98 | *trunk | *581,589,633 | *- | *- | 51 |
| Ethernet5/2 | [L]_ISMPAN60 | *access | *541 | *- | *- | 52 |
| Ethernet5/3 | [L]_ISMTMGPAN48 | *access | *542 | *- | *- | 53 |
| Ethernet6/1 | [L]_ISMPAN99 | *trunk | *581,589,633 | *- | *- | 61 |
| Ethernet6/2 | [L]_ISMPAN61 | *access | *541 | *- | *- | 62 |
| Ethernet6/3 | [L]_ISMTMGPAN49 | *access | *542 | *- | *- | 63 |
...
interface Ethernet5/1
   description [L]_ISMPAN98
   no shutdown
   speed 10g
   channel-group 51 mode active
!
interface Ethernet5/2
   description [L]_ISMPAN60
   no shutdown
   speed 25g
   channel-group 52 mode active
!
interface Ethernet5/3
   description [L]_ISMTMGPAN48
   no shutdown
   speed 25g
   channel-group 53 mode active
!
interface Ethernet6/1
   description [L]_ISMPAN99
   no shutdown
   speed 10g
   channel-group 61 mode active
!
interface Ethernet6/2
   description [L]_ISMPAN61
   no shutdown
   speed 25g
   channel-group 62 mode active
!
interface Ethernet6/3
   description [L]_ISMTMGPAN49
   no shutdown
   speed 25g
...
| 192.168.0.4 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | ehs | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - | - |
...
| 10.210.241.126 | Inherited from peer group DMZFW-EBGP-PEERS-ehsVRF | ehs | - | - | Inherited from peer group DMZFW-EBGP-PEERS-ehsVRF | - | - | - | - | - | - |
| 192.168.0.4 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Gnet | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - | - |
...
| 10.210.241.134 | Inherited from peer group DMZFW-EBGP-PEERS-GnetVRF | Gnet | - | - | Inherited from peer group DMZFW-EBGP-PEERS-GnetVRF | - | - | - | - | - | - |
...
| 10.210.241.11 | - | IoT | - | - | - | - | - | - | - | - | - |
| 10.210.241.15 | - | IoT | - | - | - | - | - | - | - | - | - |
| 10.210.241.78 | Inherited from peer group DMZFW-EBGP-PEERS-IoTVRF | IoT | - | - | Inherited from peer group DMZFW-EBGP-PEERS-IoTVRF | - | - | - | - | - | - |
...
| 10.210.241.3 | Inherited from peer group IT-BLLF-EBGP-PEERS-ITVRF | IT | - | - | Inherited from peer group IT-BLLF-EBGP-PEERS-ITVRF | - | - | - | - | - | - |
| 10.210.241.7 | Inherited from peer group IT-BLLF-EBGP-PEERS-ITVRF | IT | - | - | Inherited from peer group IT-BLLF-EBGP-PEERS-ITVRF | - | - | - | - | - | - |
