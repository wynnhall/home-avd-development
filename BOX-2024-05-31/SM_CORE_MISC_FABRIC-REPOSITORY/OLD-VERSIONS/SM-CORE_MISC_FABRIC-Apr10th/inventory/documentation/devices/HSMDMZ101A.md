...
| ------- | -------- | ---------- | ----- |
| - | SM-CORE_MISC_FABRIC HSMDMZ101A | All | Enabled |

#### SNMP EngineID Configuration

| Type | EngineID (Hex) | IP | Port |
| ---- | -------------- | -- | ---- |
| local | 4aa4590baaa015f30ab978395fb0f6e001ad9f11 | - | - |
...
| ---- | ----- | ------- | -------------- | ------- | -------------- | ----------- | --------- |
| SNMPManager | network-admin | v3 | sha | aes | - | - | 4aa4590baaa015f30ab978395fb0f6e001ad9f11 |

#### SNMP Device Configuration

```eos
!
snmp-server engineID local 4aa4590baaa015f30ab978395fb0f6e001ad9f11
snmp-server location SM-CORE_MISC_FABRIC HSMDMZ101A
...
snmp-server user SNMPManager network-admin v3 localized 4aa4590baaa015f30ab978395fb0f6e001ad9f11 auth sha <removed> priv aes <removed>
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet49 |  [L]_DMZ-Router1_Eth1 | trunk | 100 | - | - | - |
| Ethernet50 |  [L]_DMZ-Router2_Eth1 | trunk | 100 | - | - | - |
| Ethernet51 |  [L]_ISMPAN98_Eth14 | trunk | 100 | - | - | - |
| Ethernet52 |  [L]_ISMPAN99_Eth14 | trunk | 100 | - | - | - |
| Ethernet55 | [L]_MLAG_PEER_HSMDMZ100A_Ethernet55 | *trunk | *- | *- | *['MLAG'] | 4094 |
| Ethernet56 | [L]_MLAG_PEER_HSMDMZ100A_Ethernet56 | *trunk | *- | *- | *['MLAG'] | 4094 |
...
interface Ethernet49
   description [L]_DMZ-Router1_Eth1
   no shutdown
   speed 10g
...
interface Ethernet50
   description [L]_DMZ-Router2_Eth1
   no shutdown
   speed 10g
   switchport trunk allowed vlan 100
   switchport mode trunk
...
interface Ethernet55
   description [L]_MLAG_PEER_HSMDMZ100A_Ethernet55
   no shutdown
   speed 25g
   channel-group 4094 mode active
!
interface Ethernet56
   description [L]_MLAG_PEER_HSMDMZ100A_Ethernet56
   no shutdown
   speed 25g
   channel-group 4094 mode active
```
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel4094 | [L]_MLAG_PEER_HSMDMZ100A_Po4094 | switched | trunk | - | - | ['MLAG'] | - | - | - | - |
...
interface Port-Channel4094
   description [L]_MLAG_PEER_HSMDMZ100A_Po4094
   no shutdown
   switchport
   switchport mode trunk
