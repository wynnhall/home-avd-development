...
| ------- | -------- | ---------- | ----- |
| - | SM-CORE_MISC_FABRIC HSMVND01A | All | Disabled |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet1/1 |  ISMTMGPAN48_Eth1/25 | trunk | - | - | - | - |
| Ethernet2/1 |  ISMTMGPAN49_Eth1/25 | trunk | - | - | - | - |
...
interface Ethernet1/1
   description ISMTMGPAN48_Eth1/25
   no shutdown
   speed 10g
...
interface Ethernet2/1
   description ISMTMGPAN49_Eth1/25
   no shutdown
   speed 10g
   switchport mode trunk
   switchport
