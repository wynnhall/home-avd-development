...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | mgmt | 10.210.241.20/21 | - |
...
| ------- | -------- | ---------- | ----- |
| - | SM-CORE_MISC_FABRIC [SM-CORE_MISC_FABRIC] HS00BOT01A | All | Enabled |
...
snmp-server location SM-CORE_MISC_FABRIC [SM-CORE_MISC_FABRIC] HS00BOT01A
