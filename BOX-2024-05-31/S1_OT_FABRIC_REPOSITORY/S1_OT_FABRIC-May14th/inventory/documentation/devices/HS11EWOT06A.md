...
| ---- | -------------- | -- | ---- |
| local | c1a49c8577347f26ebe61a3eb08fd1a148c6ad79 | - | - |
...
| ---- | ----- | ------- | -------------- | ------- | -------------- | ----------- | --------- |
| SNMPManager | network-admin | v3 | sha | aes | - | - | c1a49c8577347f26ebe61a3eb08fd1a148c6ad79 |

#### SNMP Device Configuration

```eos
!
snmp-server engineID local c1a49c8577347f26ebe61a3eb08fd1a148c6ad79
...
snmp-server user SNMPManager network-admin v3 localized c1a49c8577347f26ebe61a3eb08fd1a148c6ad79 auth sha <removed> priv aes <removed>
