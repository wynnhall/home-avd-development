...
| ---- | -------------- | -- | ---- |
| local | 02b86b6c571ef442613c6a753775313a777d6876 | - | - |
...
| ---- | ----- | ------- | -------------- | ------- | -------------- | ----------- | --------- |
| SNMPManager | network-admin | v3 | sha | aes | - | - | 02b86b6c571ef442613c6a753775313a777d6876 |

#### SNMP Device Configuration

```eos
!
snmp-server engineID local 02b86b6c571ef442613c6a753775313a777d6876
...
snmp-server user SNMPManager network-admin v3 localized 02b86b6c571ef442613c6a753775313a777d6876 auth sha <removed> priv aes <removed>
