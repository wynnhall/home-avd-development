...
| ---- | -------------- | -- | ---- |
| local | 9dd76224f0f4aeb6a8202756df5a9bb76de206d4 | - | - |
...
| ---- | ----- | ------- | -------------- | ------- | -------------- | ----------- | --------- |
| SNMPManager | network-admin | v3 | sha | aes | - | - | 9dd76224f0f4aeb6a8202756df5a9bb76de206d4 |

#### SNMP Device Configuration

```eos
!
snmp-server engineID local 9dd76224f0f4aeb6a8202756df5a9bb76de206d4
...
snmp-server user SNMPManager network-admin v3 localized 9dd76224f0f4aeb6a8202756df5a9bb76de206d4 auth sha <removed> priv aes <removed>
