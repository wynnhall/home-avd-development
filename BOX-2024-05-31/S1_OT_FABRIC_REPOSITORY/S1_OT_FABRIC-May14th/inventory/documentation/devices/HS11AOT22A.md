...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | mgmt | 10.211.240.154/22 | 10.211.240.1 |
...
| ------- | -------- | ---------- | ----- |
| - | S1_OT_FABRIC HS11AOT22A | All | Enabled |

#### SNMP EngineID Configuration

| Type | EngineID (Hex) | IP | Port |
| ---- | -------------- | -- | ---- |
| local | 6f229c930fed5144792b3322e1a3996b381f4ad5 | - | - |
...
| ---- | ----- | ------- | -------------- | ------- | -------------- | ----------- | --------- |
| SNMPManager | network-admin | v3 | sha | aes | - | - | 6f229c930fed5144792b3322e1a3996b381f4ad5 |

#### SNMP Device Configuration

```eos
!
snmp-server engineID local 6f229c930fed5144792b3322e1a3996b381f4ad5
snmp-server location S1_OT_FABRIC HS11AOT22A
...
snmp-server user SNMPManager network-admin v3 localized 6f229c930fed5144792b3322e1a3996b381f4ad5 auth sha <removed> priv aes <removed>
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet49 | [L]_HS11AOTAGG03A_Ethernet9 | *trunk | *none | *- | *- | 49 |
| Ethernet50 | [L]_HS11AOTAGG04A_Ethernet9 | *trunk | *none | *- | *- | 49 |
...
interface Ethernet49
   description [L]_HS11AOTAGG03A_Ethernet9
   no shutdown
   channel-group 49 mode active
!
interface Ethernet50
   description [L]_HS11AOTAGG04A_Ethernet9
   no shutdown
   channel-group 49 mode active
```
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel49 | [L]_S1_OT_AGG_LF15_16_Po9 | switched | trunk | none | - | - | - | - | - | - |
...
interface Port-Channel49
   description [L]_S1_OT_AGG_LF15_16_Po9
   no shutdown
   switchport
