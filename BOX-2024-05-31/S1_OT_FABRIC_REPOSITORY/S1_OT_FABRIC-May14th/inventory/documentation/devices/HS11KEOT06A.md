...
| ---- | -------------- | -- | ---- |
| local | 55585954fc20152f516792c7956db5ca8ce447ac | - | - |
...
| ---- | ----- | ------- | -------------- | ------- | -------------- | ----------- | --------- |
| SNMPManager | network-admin | v3 | sha | aes | - | - | 55585954fc20152f516792c7956db5ca8ce447ac |

#### SNMP Device Configuration

```eos
!
snmp-server engineID local 55585954fc20152f516792c7956db5ca8ce447ac
...
snmp-server user SNMPManager network-admin v3 localized 55585954fc20152f516792c7956db5ca8ce447ac auth sha <removed> priv aes <removed>
