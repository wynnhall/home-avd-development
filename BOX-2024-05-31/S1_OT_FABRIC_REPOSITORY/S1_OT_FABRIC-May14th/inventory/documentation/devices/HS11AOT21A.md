...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | mgmt | 10.211.240.153/22 | 10.211.240.1 |
...
| ------- | -------- | ---------- | ----- |
| - | S1_OT_FABRIC HS11AOT21A | All | Enabled |

#### SNMP EngineID Configuration

| Type | EngineID (Hex) | IP | Port |
| ---- | -------------- | -- | ---- |
| local | d67ec7d36af5a3a427eac7f51eaf62924dbc651a | - | - |
...
| ---- | ----- | ------- | -------------- | ------- | -------------- | ----------- | --------- |
| SNMPManager | network-admin | v3 | sha | aes | - | - | d67ec7d36af5a3a427eac7f51eaf62924dbc651a |

#### SNMP Device Configuration

```eos
!
snmp-server engineID local d67ec7d36af5a3a427eac7f51eaf62924dbc651a
snmp-server location S1_OT_FABRIC HS11AOT21A
...
snmp-server user SNMPManager network-admin v3 localized d67ec7d36af5a3a427eac7f51eaf62924dbc651a auth sha <removed> priv aes <removed>
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet49 | [L]_HS11AOTAGG03A_Ethernet8 | *trunk | *none | *- | *- | 49 |
| Ethernet50 | [L]_HS11AOTAGG04A_Ethernet8 | *trunk | *none | *- | *- | 49 |
...
interface Ethernet49
   description [L]_HS11AOTAGG03A_Ethernet8
   no shutdown
   channel-group 49 mode active
!
interface Ethernet50
   description [L]_HS11AOTAGG04A_Ethernet8
   no shutdown
   channel-group 49 mode active
```
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel49 | [L]_S1_OT_AGG_LF15_16_Po8 | switched | trunk | none | - | - | - | - | - | - |
...
interface Port-Channel49
   description [L]_S1_OT_AGG_LF15_16_Po8
   no shutdown
   switchport
