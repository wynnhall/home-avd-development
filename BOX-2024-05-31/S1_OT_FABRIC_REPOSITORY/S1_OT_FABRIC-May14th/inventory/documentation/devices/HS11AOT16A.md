...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | mgmt | 10.211.240.148/22 | 10.211.240.1 |
...
| ------- | -------- | ---------- | ----- |
| - | S1_OT_FABRIC HS11AOT16A | All | Enabled |

#### SNMP EngineID Configuration

| Type | EngineID (Hex) | IP | Port |
| ---- | -------------- | -- | ---- |
| local | 527139af3364dc286dd5f1024ac316806bbb0a6e | - | - |
...
| ---- | ----- | ------- | -------------- | ------- | -------------- | ----------- | --------- |
| SNMPManager | network-admin | v3 | sha | aes | - | - | 527139af3364dc286dd5f1024ac316806bbb0a6e |

#### SNMP Device Configuration

```eos
!
snmp-server engineID local 527139af3364dc286dd5f1024ac316806bbb0a6e
snmp-server location S1_OT_FABRIC HS11AOT16A
...
snmp-server user SNMPManager network-admin v3 localized 527139af3364dc286dd5f1024ac316806bbb0a6e auth sha <removed> priv aes <removed>
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet49 | [L]_HS11AOTAGG03A_Ethernet3 | *trunk | *none | *- | *- | 49 |
| Ethernet50 | [L]_HS11AOTAGG04A_Ethernet3 | *trunk | *none | *- | *- | 49 |
...
interface Ethernet49
   description [L]_HS11AOTAGG03A_Ethernet3
   no shutdown
   channel-group 49 mode active
!
interface Ethernet50
   description [L]_HS11AOTAGG04A_Ethernet3
   no shutdown
   channel-group 49 mode active
```
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel49 | [L]_S1_OT_AGG_LF15_16_Po3 | switched | trunk | none | - | - | - | - | - | - |
...
interface Port-Channel49
   description [L]_S1_OT_AGG_LF15_16_Po3
   no shutdown
   switchport
