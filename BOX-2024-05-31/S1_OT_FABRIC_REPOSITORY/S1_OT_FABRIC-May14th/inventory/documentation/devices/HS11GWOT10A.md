...
| ---- | -------------- | -- | ---- |
| local | 8068de3d3e760bbdc0518ba76792bd32a767d0b1 | - | - |
...
| ---- | ----- | ------- | -------------- | ------- | -------------- | ----------- | --------- |
| SNMPManager | network-admin | v3 | sha | aes | - | - | 8068de3d3e760bbdc0518ba76792bd32a767d0b1 |

#### SNMP Device Configuration

```eos
!
snmp-server engineID local 8068de3d3e760bbdc0518ba76792bd32a767d0b1
...
snmp-server user SNMPManager network-admin v3 localized 8068de3d3e760bbdc0518ba76792bd32a767d0b1 auth sha <removed> priv aes <removed>
