...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | mgmt | 10.211.240.155/22 | 10.211.240.1 |
...
| ------- | -------- | ---------- | ----- |
| - | S1_OT_FABRIC HS11AOT23A | All | Enabled |

#### SNMP EngineID Configuration

| Type | EngineID (Hex) | IP | Port |
| ---- | -------------- | -- | ---- |
| local | c61a604c8edafa39f079ebf574ac945f0005fc76 | - | - |
...
| ---- | ----- | ------- | -------------- | ------- | -------------- | ----------- | --------- |
| SNMPManager | network-admin | v3 | sha | aes | - | - | c61a604c8edafa39f079ebf574ac945f0005fc76 |

#### SNMP Device Configuration

```eos
!
snmp-server engineID local c61a604c8edafa39f079ebf574ac945f0005fc76
snmp-server location S1_OT_FABRIC HS11AOT23A
...
snmp-server user SNMPManager network-admin v3 localized c61a604c8edafa39f079ebf574ac945f0005fc76 auth sha <removed> priv aes <removed>
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet49 | [L]_HS11AOTAGG03A_Ethernet10 | *trunk | *none | *- | *- | 49 |
| Ethernet50 | [L]_HS11AOTAGG04A_Ethernet10 | *trunk | *none | *- | *- | 49 |
...
interface Ethernet49
   description [L]_HS11AOTAGG03A_Ethernet10
   no shutdown
   channel-group 49 mode active
!
interface Ethernet50
   description [L]_HS11AOTAGG04A_Ethernet10
   no shutdown
   channel-group 49 mode active
```
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel49 | [L]_S1_OT_AGG_LF15_16_Po10 | switched | trunk | none | - | - | - | - | - | - |
...
interface Port-Channel49
   description [L]_S1_OT_AGG_LF15_16_Po10
   no shutdown
   switchport
