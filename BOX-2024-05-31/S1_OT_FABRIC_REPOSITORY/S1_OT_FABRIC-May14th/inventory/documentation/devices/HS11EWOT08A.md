...
| ---- | -------------- | -- | ---- |
| local | af3d2131dac6af6b2a766ccc099d433bc0fa40c2 | - | - |
...
| ---- | ----- | ------- | -------------- | ------- | -------------- | ----------- | --------- |
| SNMPManager | network-admin | v3 | sha | aes | - | - | af3d2131dac6af6b2a766ccc099d433bc0fa40c2 |

#### SNMP Device Configuration

```eos
!
snmp-server engineID local af3d2131dac6af6b2a766ccc099d433bc0fa40c2
...
snmp-server user SNMPManager network-admin v3 localized af3d2131dac6af6b2a766ccc099d433bc0fa40c2 auth sha <removed> priv aes <removed>
