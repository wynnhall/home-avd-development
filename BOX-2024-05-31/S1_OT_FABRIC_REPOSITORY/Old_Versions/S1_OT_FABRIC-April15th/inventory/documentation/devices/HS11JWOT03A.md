...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | mgmt | 10.211.240.160/22 | 10.211.240.160 |
...
| ------- | -------- | ---------- | ----- |
| - | S1-OT_FABRIC HS11JWOT03A | All | Enabled |

#### SNMP EngineID Configuration

| Type | EngineID (Hex) | IP | Port |
| ---- | -------------- | -- | ---- |
| local | c5875229a8eaba7e8fbb494556bd57a1fbc318b7 | - | - |
...
| ---- | ----- | ------- | -------------- | ------- | -------------- | ----------- | --------- |
| SNMPManager | network-admin | v3 | sha | aes | - | - | c5875229a8eaba7e8fbb494556bd57a1fbc318b7 |

#### SNMP Device Configuration

```eos
!
snmp-server engineID local c5875229a8eaba7e8fbb494556bd57a1fbc318b7
snmp-server location S1-OT_FABRIC HS11JWOT03A
...
snmp-server user SNMPManager network-admin v3 localized c5875229a8eaba7e8fbb494556bd57a1fbc318b7 auth sha <removed> priv aes <removed>
...
| --- | ------------------ | ----------- | -------------- | ----------------------- | --- | ---------- | ------ |
| mgmt | 0.0.0.0/0 | 10.211.240.160 | - | 1 | - | - | - |

#### Static Routes Device Configuration

```eos
!
ip route vrf mgmt 0.0.0.0/0 10.211.240.160
```
