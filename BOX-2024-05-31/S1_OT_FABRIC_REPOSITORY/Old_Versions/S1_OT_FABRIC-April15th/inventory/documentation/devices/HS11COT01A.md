...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | mgmt | 10.211.240.108/22 | 10.211.240.108 |
...
| ------- | -------- | ---------- | ----- |
| - | S1-OT_FABRIC HS11COT01A | All | Enabled |

#### SNMP EngineID Configuration

| Type | EngineID (Hex) | IP | Port |
| ---- | -------------- | -- | ---- |
| local | ecf7e12c5a1c64d75a06521479da1b0ed43712dc | - | - |
...
| ---- | ----- | ------- | -------------- | ------- | -------------- | ----------- | --------- |
| SNMPManager | network-admin | v3 | sha | aes | - | - | ecf7e12c5a1c64d75a06521479da1b0ed43712dc |

#### SNMP Device Configuration

```eos
!
snmp-server engineID local ecf7e12c5a1c64d75a06521479da1b0ed43712dc
snmp-server location S1-OT_FABRIC HS11COT01A
...
snmp-server user SNMPManager network-admin v3 localized ecf7e12c5a1c64d75a06521479da1b0ed43712dc auth sha <removed> priv aes <removed>
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet49 | [L]_HS11COTAGG01A_Ethernet1 | *trunk | *253,261,269,273,277,281,285,289,293,297,301,313,327,329,4020 | *- | *- | 49 |
| Ethernet50 | [L]_HS11COTAGG02A_Ethernet1 | *trunk | *253,261,269,273,277,281,285,289,293,297,301,313,327,329,4020 | *- | *- | 49 |
...
interface Ethernet49
   description [L]_HS11COTAGG01A_Ethernet1
   no shutdown
   channel-group 49 mode active
!
interface Ethernet50
   description [L]_HS11COTAGG02A_Ethernet1
   no shutdown
   channel-group 49 mode active
```
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel49 | [L]_S1-OT_AGG_LF9_10_Po1 | switched | trunk | 253,261,269,273,277,281,285,289,293,297,301,313,327,329,4020 | - | - | - | - | - | - |
...
interface Port-Channel49
   description [L]_S1-OT_AGG_LF9_10_Po1
   no shutdown
   switchport
...
| --- | ------------------ | ----------- | -------------- | ----------------------- | --- | ---------- | ------ |
| mgmt | 0.0.0.0/0 | 10.211.240.108 | - | 1 | - | - | - |

#### Static Routes Device Configuration

```eos
!
ip route vrf mgmt 0.0.0.0/0 10.211.240.108
```
