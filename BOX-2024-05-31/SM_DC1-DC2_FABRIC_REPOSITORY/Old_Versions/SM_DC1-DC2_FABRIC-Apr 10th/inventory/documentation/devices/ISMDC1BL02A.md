...
| ------- | -------- | ---------- | ----- |
| - | SHERMAN_FABRIC SM-DC1_FABRIC ISMDC1BL02A | All | Enabled |

#### SNMP EngineID Configuration

| Type | EngineID (Hex) | IP | Port |
| ---- | -------------- | -- | ---- |
| local | f6933f2ef389ea7de7ea24c4ead761ea85d4d67d | - | - |
...
| ---- | ----- | ------- | -------------- | ------- | -------------- | ----------- | --------- |
| SNMPManager | network-admin | v3 | sha | aes | - | - | f6933f2ef389ea7de7ea24c4ead761ea85d4d67d |

#### SNMP Device Configuration

```eos
!
snmp-server engineID local f6933f2ef389ea7de7ea24c4ead761ea85d4d67d
snmp-server location SHERMAN_FABRIC SM-DC1_FABRIC ISMDC1BL02A
...
snmp-server user SNMPManager network-admin v3 localized f6933f2ef389ea7de7ea24c4ead761ea85d4d67d auth sha <removed> priv aes <removed>
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet31/1 | [L]_MLAG_PEER_ISMDC1BL01A_Ethernet31/1 | *trunk | *- | *- | *['LEAF_PEER_L3', 'MLAG'] | 4094 |
| Ethernet32/1 | [L]_MLAG_PEER_ISMDC1BL01A_Ethernet32/1 | *trunk | *- | *- | *['LEAF_PEER_L3', 'MLAG'] | 4094 |
...
| --------- | ----------- | -----| ------- | -------------- |
| Ethernet1/1.510 | [L]_ISMCR01A-Eth4/1/1-IT-DC-VRF | l3dot1q | - | 510 |
| Ethernet1/1.533 | [L]_ISMCR01A-Eth4/1/1-OT-VRF | l3dot1q | - | 533 |
| Ethernet2/1.510 | [L]_ISMCR02A-Eth4/1/1-IT-DC-VRF | l3dot1q | - | 510 |
| Ethernet2/1.533 | [L]_ISMCR02A-Eth4/1/1-OT-VRF | l3dot1q | - | 533 |
| Ethernet5/1.533 | [L]_ISMS1OTBL01A-Eth2/1-OT-VRF | l3dot1q | - | 533 |
| Ethernet6/1.533 | [L]_ISMS1OTBL02A-Eth2/1-OT-VRF | l3dot1q | - | 533 |

##### IPv4

| Interface | Description | Type | Channel Group | IP Address | VRF |  MTU | Shutdown | ACL In | ACL Out |
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1/1.510 | [L]_ISMCR01A-Eth4/1/1-IT-DC-VRF | l3dot1q | - | 10.210.226.29/31 | IT-DC | - | False | - | - |
| Ethernet1/1.533 | [L]_ISMCR01A-Eth4/1/1-OT-VRF | l3dot1q | - | 10.210.226.5/31 | OT | - | False | - | - |
| Ethernet2/1.510 | [L]_ISMCR02A-Eth4/1/1-IT-DC-VRF | l3dot1q | - | 10.210.226.31/31 | IT-DC | - | False | - | - |
| Ethernet2/1.533 | [L]_ISMCR02A-Eth4/1/1-OT-VRF | l3dot1q | - | 10.210.226.7/31 | OT | - | False | - | - |
| Ethernet3/1 | P2P_LINK_TO_ISMDC2BL01A_Ethernet4/1 | routed | - | 10.210.226.12/31 | default | 9214 | False | - | - |
| Ethernet4/1 | P2P_LINK_TO_ISMDC2BL02A_Ethernet4/1 | routed | - | 10.210.226.14/31 | default | 9214 | False | - | - |
| Ethernet5/1.533 | [L]_ISMS1OTBL01A-Eth2/1-OT-VRF | l3dot1q | - | 10.210.226.21/31 | OT | - | False | - | - |
| Ethernet6/1.533 | [L]_ISMS1OTBL02A-Eth2/1-OT-VRF | l3dot1q | - | 10.210.226.23/31 | OT | - | False | - | - |
...
interface Ethernet1/1.510
   description [L]_ISMCR01A-Eth4/1/1-IT-DC-VRF
   no shutdown
...
interface Ethernet1/1.533
   description [L]_ISMCR01A-Eth4/1/1-OT-VRF
   no shutdown
...
interface Ethernet2/1.510
   description [L]_ISMCR02A-Eth4/1/1-IT-DC-VRF
   no shutdown
   encapsulation dot1q vlan 510
   vrf IT-DC
...
interface Ethernet2/1.533
   description [L]_ISMCR02A-Eth4/1/1-OT-VRF
   no shutdown
   encapsulation dot1q vlan 533
   vrf OT
...
interface Ethernet3/1
   description P2P_LINK_TO_ISMDC2BL01A_Ethernet4/1
   no shutdown
   mtu 9214
   speed 100g
   no switchport
...
interface Ethernet4/1
   description P2P_LINK_TO_ISMDC2BL02A_Ethernet4/1
   no shutdown
   mtu 9214
   speed 100g
   no switchport
...
interface Ethernet5/1.533
   description [L]_ISMS1OTBL01A-Eth2/1-OT-VRF
   no shutdown
   encapsulation dot1q vlan 533
   vrf OT
...
interface Ethernet6/1.533
   description [L]_ISMS1OTBL02A-Eth2/1-OT-VRF
   no shutdown
   encapsulation dot1q vlan 533
   vrf OT
...
interface Ethernet31/1
   description [L]_MLAG_PEER_ISMDC1BL01A_Ethernet31/1
   no shutdown
   channel-group 4094 mode active
!
interface Ethernet32/1
   description [L]_MLAG_PEER_ISMDC1BL01A_Ethernet32/1
   no shutdown
   channel-group 4094 mode active
```
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel4094 | [L]_MLAG_PEER_ISMDC1BL01A_Po311 | switched | trunk | - | - | ['LEAF_PEER_L3', 'MLAG'] | - | - | - | - |
...
interface Port-Channel4094
   description [L]_MLAG_PEER_ISMDC1BL01A_Po311
   no shutdown
   switchport
...
| 10.210.226.28 | Inherited from peer group CORES-EBGP-PEERS-IT-DC-VRF | IT-DC | - | - | Inherited from peer group CORES-EBGP-PEERS-IT-DC-VRF | - | - | - | - | - |
| 10.210.226.30 | Inherited from peer group CORES-EBGP-PEERS-IT-DC-VRF | IT-DC | - | - | Inherited from peer group CORES-EBGP-PEERS-IT-DC-VRF | - | - | - | - | - |
...
| 316 | 172.21.0.25:10316 | 10316:10316<br>remote 10316:10316 | - | - | learned |
...
| 1022 | 172.21.0.25:11022 | 11022:11022<br>remote 11022:11022 | - | - | learned |
...
router bgp 65120.11200
   ...
   neighbor MLAG-IPv4-UNDERLAY-PEER description ISMDC1BL01A
   ...
   !
   vlan 1022
      rd 172.21.0.25:11022
      rd evpn domain remote 172.21.0.25:11022
   ...
   !
   vlan 316
      rd 172.21.0.25:10316
      rd evpn domain remote 172.21.0.25:10316
   ...
   vrf IT-DC
      ...
      router-id 172.21.0.25
      update wait-install
      neighbor 10.210.226.28 peer group CORES-EBGP-PEERS-IT-DC-VRF
      neighbor 10.210.226.28 description ISMCR01A-Eth4/1/1-IT-DC-VRF
      neighbor 10.210.226.30 peer group CORES-EBGP-PEERS-IT-DC-VRF
      neighbor 10.210.226.30 description ISMCR02A-Eth4/1/1-IT-DC-VRF
   ...
   vrf OT
      ...
      neighbor 10.210.226.4 description ISMCR01A-Eth4/1/1-OT-VRF
      neighbor 10.210.226.6 peer group CORES-EBGP-PEERS-OTVRF
      neighbor 10.210.226.6 description ISMCR02A-Eth4/1/1-OT-VRF
      neighbor 10.210.226.20 peer group S1-OT-BL-EBGP-PEERS-OTVRF
      neighbor 10.210.226.20 description ISMS1OTBL01A-Eth2/1-OT-VRF
      neighbor 10.210.226.22 peer group S1-OT-BL-EBGP-PEERS-OTVRF
      neighbor 10.210.226.22 description ISMS1OTBL02A-Eth2/1-OT-VRF
      redistribute connected
      !
      address-family ipv4
