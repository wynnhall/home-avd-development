...
| ------- | -------- | ---------- | ----- |
| - | SM_DC1-DC2_FABRIC SM_DC2_FABRIC DC2-CL8 | All | Enabled |

#### SNMP EngineID Configuration

| Type | EngineID (Hex) | IP | Port |
| ---- | -------------- | -- | ---- |
| local | c9179089c5f88def0e31b525930085f2fb42139c | - | - |
...
| ---- | ----- | ------- | -------------- | ------- | -------------- | ----------- | --------- |
| SNMPManager | network-admin | v3 | sha | aes | - | - | c9179089c5f88def0e31b525930085f2fb42139c |

#### SNMP Device Configuration

```eos
!
snmp-server engineID local c9179089c5f88def0e31b525930085f2fb42139c
snmp-server location SM_DC1-DC2_FABRIC SM_DC2_FABRIC DC2-CL8
...
snmp-server user SNMPManager network-admin v3 localized c9179089c5f88def0e31b525930085f2fb42139c auth sha <removed> priv aes <removed>
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet55/1 | [L]_MLAG_PEER_DC2-CL7_Ethernet55/1 | *trunk | *- | *- | *['MLAG'] | 4094 |
| Ethernet56/1 | [L]_MLAG_PEER_DC2-CL7_Ethernet56/1 | *trunk | *- | *- | *['MLAG'] | 4094 |
...
interface Ethernet55/1
   description [L]_MLAG_PEER_DC2-CL7_Ethernet55/1
   no shutdown
   channel-group 4094 mode active
!
interface Ethernet56/1
   description [L]_MLAG_PEER_DC2-CL7_Ethernet56/1
   no shutdown
   channel-group 4094 mode active
```
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel4094 | [L]_MLAG_PEER_DC2-CL7_Po551 | switched | trunk | - | - | ['MLAG'] | - | - | - | - |
...
interface Port-Channel4094
   description [L]_MLAG_PEER_DC2-CL7_Po551
   no shutdown
   switchport
...
| 316 | 172.21.1.11:10316 | 10316:10316 | - | - | learned |
...
router bgp 65120.12204
   ...
   neighbor MLAG-IPv4-UNDERLAY-PEER description DC2-CL7
