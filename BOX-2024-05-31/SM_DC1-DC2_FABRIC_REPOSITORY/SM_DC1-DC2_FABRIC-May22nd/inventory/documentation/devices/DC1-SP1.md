...
| Ethernet5 | P2P_LINK_TO_DC1-SL1_Ethernet1 | routed | - | 192.168.1.16/31 | default | 1500 | False | - | - |
| Ethernet6 | P2P_LINK_TO_DC1-SL2_Ethernet1 | routed | - | 192.168.1.20/31 | default | 1500 | False | - | - |
| Ethernet7 | P2P_LINK_TO_DC1-BL1_Ethernet1 | routed | - | 192.168.1.24/31 | default | 1500 | False | - | - |
| Ethernet8 | P2P_LINK_TO_DC1-BL2_Ethernet1 | routed | - | 192.168.1.28/31 | default | 1500 | False | - | - |
...
!
interface Ethernet5
   description P2P_LINK_TO_DC1-SL1_Ethernet1
   no shutdown
   mtu 1500
   speed forced 100g
   no switchport
...
!
interface Ethernet6
   description P2P_LINK_TO_DC1-SL2_Ethernet1
   no shutdown
   mtu 1500
   speed forced 100g
   no switchport
...
| 192.168.1.17 | 65000.5 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
| 192.168.1.21 | 65000.5 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
| 192.168.1.25 | 65000.7 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
| 192.168.1.29 | 65000.7 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
...
router bgp 65000.0
   ...
   neighbor 192.168.1.17 remote-as 65000.5
   neighbor 192.168.1.17 description DC1-SL1_Ethernet1
   neighbor 192.168.1.21 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.1.21 remote-as 65000.5
   neighbor 192.168.1.21 description DC1-SL2_Ethernet1
   neighbor 192.168.1.25 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.1.25 remote-as 65000.7
   neighbor 192.168.1.25 description DC1-BL1_Ethernet1
   neighbor 192.168.1.29 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.1.29 remote-as 65000.7
   neighbor 192.168.1.29 description DC1-BL2_Ethernet1
