...
| --------- | --------------- | ------------ | --------- |
| DC2_SRVLEAF1_2 | Vlan4094 | 172.16.0.5 | Port-Channel3 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet3 | MLAG_PEER_DC2-SL2_Ethernet3 | *trunk | *- | *- | *['LEAF_PEER_L3', 'MLAG'] | 3 |
| Ethernet4 | fw2_Ethernet1 | *trunk | *70,80 | *- | *- | 4 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_LINK_TO_DC2-SP1_Ethernet3 | routed | - | 192.168.2.9/31 | default | 1500 | False | - | - |
| Ethernet2 | P2P_LINK_TO_DC2-SP2_Ethernet3 | routed | - | 192.168.2.11/31 | default | 1500 | False | - | - |
...
!
interface Ethernet3
   description MLAG_PEER_DC2-SL2_Ethernet3
   no shutdown
   speed 100g
   channel-group 3 mode active
!
interface Ethernet4
   description fw2_Ethernet1
   no shutdown
   speed 10g
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel3 | MLAG_PEER_DC2-SL2_Po3 | switched | trunk | - | - | ['LEAF_PEER_L3', 'MLAG'] | - | - | - | - |
...
interface Port-Channel3
   description MLAG_PEER_DC2-SL2_Po3
   no shutdown
   switchport
...
| 192.168.2.8 | 65001.0 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
| 192.168.2.10 | 65001.0 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
...
| --- | ------------------- | ------------ |
| BLUE | 192.168.101.3:1002 | connected<br>static |
| RED | 192.168.101.3:1001 | connected<br>static |
...
router bgp 65001.3
   ...
   neighbor MLAG-IPv4-UNDERLAY-PEER description DC2-SL2
   neighbor MLAG-IPv4-UNDERLAY-PEER password 7 <removed>
   neighbor MLAG-IPv4-UNDERLAY-PEER send-community
   neighbor MLAG-IPv4-UNDERLAY-PEER maximum-routes 12000
   neighbor MLAG-IPv4-UNDERLAY-PEER route-map RM-MLAG-PEER-IN in
   neighbor 172.16.1.5 peer group MLAG-IPv4-UNDERLAY-PEER
   neighbor 172.16.1.5 description DC2-SL2
   neighbor 192.168.2.8 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.2.8 remote-as 65001.0
   neighbor 192.168.2.8 description DC2-SP1_Ethernet3
   neighbor 192.168.2.10 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.2.10 remote-as 65001.0
   neighbor 192.168.2.10 description DC2-SP2_Ethernet3
