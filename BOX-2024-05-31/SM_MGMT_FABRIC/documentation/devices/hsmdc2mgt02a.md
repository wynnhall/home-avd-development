...
| ------- | -------- | ---------- | ----- |
| - | SM_MGMT_FABRIC hsmdc2mgt02a | All | Enabled |

#### SNMP EngineID Configuration

| Type | EngineID (Hex) | IP | Port |
| ---- | -------------- | -- | ---- |
| local | decaecd20374d2af65d47203c3e61a477a57797a | - | - |
...
| ---- | ----- | ------- | -------------- | ------- | -------------- | ----------- | --------- |
| SNMPManager | network-admin | v3 | sha | aes | - | - | decaecd20374d2af65d47203c3e61a477a57797a |

#### SNMP Device Configuration

```eos
!
snmp-server engineID local decaecd20374d2af65d47203c3e61a477a57797a
snmp-server location SM_MGMT_FABRIC hsmdc2mgt02a
...
snmp-server user SNMPManager network-admin v3 localized decaecd20374d2af65d47203c3e61a477a57797a auth sha <removed> priv aes <removed>
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet49 | [L]_HSMDC2MGTAGG01A_Ethernet2 | *trunk | *300 | *- | *- | 49 |
| Ethernet50 | [L]_HSMDC2MGTAGG02A_Ethernet2 | *trunk | *300 | *- | *- | 49 |
...
interface Ethernet49
   description [L]_HSMDC2MGTAGG01A_Ethernet2
   no shutdown
   channel-group 49 mode active
!
interface Ethernet50
   description [L]_HSMDC2MGTAGG02A_Ethernet2
   no shutdown
   channel-group 49 mode active
!
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel49 | [L]_DC2_MGMT_AGG_LEAFS_Po2 | switched | trunk | 300 | - | - | - | - | - | - |
...
interface Port-Channel49
   description [L]_DC2_MGMT_AGG_LEAFS_Po2
   no shutdown
   switchport
...
| --------- | --- | ---------- | ------------------ | ------------------------- | ---- | ------ | ------- |
| vlan300 |  default  |  10.210.80.116/21  |  -  |  -  |  -  |  -  |  -  |
