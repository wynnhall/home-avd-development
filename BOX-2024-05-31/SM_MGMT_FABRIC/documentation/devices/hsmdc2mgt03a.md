...
| ------- | -------- | ---------- | ----- |
| - | SM_MGMT_FABRIC hsmdc2mgt03a | All | Enabled |

#### SNMP EngineID Configuration

| Type | EngineID (Hex) | IP | Port |
| ---- | -------------- | -- | ---- |
| local | de8e5718a16504370c73561c1edab6b0ec4d8253 | - | - |
...
| ---- | ----- | ------- | -------------- | ------- | -------------- | ----------- | --------- |
| SNMPManager | network-admin | v3 | sha | aes | - | - | de8e5718a16504370c73561c1edab6b0ec4d8253 |

#### SNMP Device Configuration

```eos
!
snmp-server engineID local de8e5718a16504370c73561c1edab6b0ec4d8253
snmp-server location SM_MGMT_FABRIC hsmdc2mgt03a
...
snmp-server user SNMPManager network-admin v3 localized de8e5718a16504370c73561c1edab6b0ec4d8253 auth sha <removed> priv aes <removed>
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet49 | [L]_HSMDC2MGTAGG01A_Ethernet3 | *trunk | *300 | *- | *- | 49 |
| Ethernet50 | [L]_HSMDC2MGTAGG02A_Ethernet3 | *trunk | *300 | *- | *- | 49 |
...
interface Ethernet49
   description [L]_HSMDC2MGTAGG01A_Ethernet3
   no shutdown
   channel-group 49 mode active
!
interface Ethernet50
   description [L]_HSMDC2MGTAGG02A_Ethernet3
   no shutdown
   channel-group 49 mode active
!
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel49 | [L]_DC2_MGMT_AGG_LEAFS_Po3 | switched | trunk | 300 | - | - | - | - | - | - |
...
interface Port-Channel49
   description [L]_DC2_MGMT_AGG_LEAFS_Po3
   no shutdown
   switchport
...
| --------- | --- | ---------- | ------------------ | ------------------------- | ---- | ------ | ------- |
| vlan300 |  default  |  10.210.80.117/21  |  -  |  -  |  -  |  -  |  -  |
